...
description: "Interpret or author economics quality evidence beyond the generated Part A record, or produce an explicitly requested quality/inspection report. Ordinary paragraph closure uses paragraph-records.js and the existing independent review through the Part A checklist; record generation alone does not require loading this skill. Use for pedagogical justifications and applicable OP0, OP1, OP2, OP3, SKA or BKA evidence."
