...
Bouw ondersteuning af naar de gevraagde doelhandeling en antwoordvorm; behoud
representaties die de doelopgave zelf aanbiedt. Voor Book 2+ Part A geldt de
[doelgerichte fading-regel](econ-exercise-builder.md#32-dual-coding-fading--target-aligned-rule).
Een vaste route naar alleen tekst of extra grafiekproductie is geen zelfstandig
didactisch doel.
