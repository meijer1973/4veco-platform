...
- **Language level.** VWO level. Economic terminology matches syllabus exactly — see `references/authored/economie-terminologie.md` for canonical terms and abbreviations.
