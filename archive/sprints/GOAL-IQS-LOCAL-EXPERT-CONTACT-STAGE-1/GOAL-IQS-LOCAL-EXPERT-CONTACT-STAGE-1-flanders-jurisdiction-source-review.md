# GOAL-IQS-LOCAL-EXPERT-CONTACT-STAGE-1 Flanders Jurisdiction-Source Review
...
|---|---|---|---|---|
| Flanders jurisdiction-source subagent returned PASS: the Flanders record remains Flanders-only, reuses the accepted source/question allowlist and approved contact text, and refuses all-Belgium or all-school-network overclaims. | `core_requirement_met` | Nothing for this Flanders Jurisdiction-Source Review review. | Human review of the complete contact-stage packet. | Stage checker PASS, focused Jest PASS, final lead PASS, exact-head readiness, green CI, branch protection ok:true, and owner authorization. |
