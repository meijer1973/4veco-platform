# GOAL-IQS-OWNER-CONTROLLED-DISPATCH-1 Subagent Quality Gate Record
...
|---|---|---|---|---|
| Lead, legal/privacy, England, Flanders, teacher/economics, accessibility, and final lead reviews are required before PR readiness. | `core_requirement_met` | Nothing after review files, checker, and CI pass. | Exact-head PR readiness. | All review records present, checker PASS, focused Jest PASS, green CI. |
