# GOAL-IQS-OWNER-CONTROLLED-DISPATCH-1 England Jurisdiction-Source Review
...
England source/authority review approves England-only bounds and no whole-UK or all-awarding-bodies overclaim.

## Findings

| finding | classification | blocks | does_not_block | proof_required_to_close |
|---|---|---|---|---|
| England Jurisdiction-Source Review returned PASS. | `core_requirement_met` | Nothing for human review once exact-head readiness and CI pass. | Owner review of this internal packet. | Exact-head readiness, branch protection ok:true, green CI, and owner authorization. |
