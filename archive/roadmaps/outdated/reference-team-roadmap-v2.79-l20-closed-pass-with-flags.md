...
Roadmap version: `v2.79-l20-closed-pass-with-flags`
...
for `GAME-UX-2` is now present, but GAME-UX-2 remains inactive until GATE-EX5
status is resolved or a human waiver explicitly permits the platform support
lane. GATE-L1.7B and Scale Gate 1 remain blocked until a source-controlled,
generated, non-summative exit-ticket checkpoint surface exists and passes
review.
...
- `LESSON-SCALE-1` tracks the lesson-side pre-scale dependency: L1.7A rejected
  ...
  GATE-L1.7B, minimal curriculum-versioning readiness, GATE-EX5 status, and
  Scale Gate 1.
