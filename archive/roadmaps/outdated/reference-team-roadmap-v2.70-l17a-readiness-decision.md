...
Roadmap version: `v2.70-l17a-readiness-decision`
...
| Product Gate | Re-Evaluate R10-R13 Product Surfaces | no | Blocked. Diagnostics, adaptive routing, student-facing AI, teacher cockpit deployment, automatic sequencing, mastery, and summative uses remain out of scope until data-quality gates justify them. Lesson L1.7A explicitly rejected broad companion scaling; broad lesson-companion scaling remains blocked until L1.7B, L1.7C-0, L1.7C, L1.7D, and L2.0 establish the companion-set contract, shared skill-map architecture, game-row quality rubric, and landing-page information architecture. |
...
- `LESSON-SCALE-1` and `GAME-UX-1` track the lesson-side pre-scale dependency:
  ...
  still wait for lesson L1.7B, L1.7C-0, L1.7C, L1.7D, L2.0, and a shared
...
LESSON-SCALE-1 lesson companion pre-scale gates tracked: L1.7A closed with broad scaling rejected; L1.7B, L1.7C-0, L1.7C, L1.7D, and L2.0 remain before broad companion/product scaling
