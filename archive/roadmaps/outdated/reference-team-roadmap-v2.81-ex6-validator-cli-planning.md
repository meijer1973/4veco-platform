...
Roadmap version: `v2.81-ex6-validator-cli-planning`
...
- `GATE-EX6` active next: human review of the EX-6 validator/CLI planning
  bundle before any later bounded implementation sprint.
- `LESSON-SCALE-1` tracks the lesson-side pre-scale dependency: L1.7A rejected
  ...
  GATE-L1.7B, minimal curriculum-versioning readiness, GATE-EX6 or an explicit
...
| GATE-EX6-validator-cli-planning | before EX-6 validator/CLI planning is treated as implementation-ready | yes | yes | bounded validator and dry-run CLI implementation planning only |
