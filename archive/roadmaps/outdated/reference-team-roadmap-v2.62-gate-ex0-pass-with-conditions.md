...
Last strategic update: 2026-05-21
Roadmap ID: `references-team-roadmap`
Roadmap version: `v2.62-gate-ex0-pass-with-conditions`
...
|--------|------|-----------|---------------|
| EX-1 | Exam Source Annex And Answer Model Pilot | no | **ACTIVE / PILOT AUTHORIZED WITH CONDITIONS.** GATE-EX0 closed as `pass_with_conditions` and authorizes EX-1 to create three non-mutating `references/data/` pilot exam-ingestion overlays: one calculation-heavy, one graph/source-heavy, and one reasoning/answer-model-heavy. EX-1 must add a pilot-overlay validator, keep graph/source reconstruction gaps blocking and visible, preserve prompt/source/correction-model traceability, and repeat all no-mutation/no-product boundaries. No protected mutation, external-source mutation, unit minting, target-exercise promotion, CP-6 closure, Year-1 closure, lesson-output mutation, or student/product authorization. |
...
- `EX-1` active next: three-question source-annex and answer-model extraction
  pilot under the GATE-EX0 conditions.
...
EX-1 Exam source annex and answer model pilot active under GATE-EX0 conditions
