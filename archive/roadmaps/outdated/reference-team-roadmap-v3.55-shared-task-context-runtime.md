...
Roadmap version: `v3.55-shared-task-context-runtime`
...
source-context ingestion until `GATE-SHARED-TASK-INGEST-REPAIR-1` closes after
renewed direct review of `SHARED-TASK-INGEST-PLAYABLE-REPAIR-4` evidence, or a
human waiver explicitly records consequences. `REV-STD-1` remains required
before Scale Gate 1. The approved
