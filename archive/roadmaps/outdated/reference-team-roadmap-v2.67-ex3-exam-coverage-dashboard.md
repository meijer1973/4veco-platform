...
Roadmap version: `v2.67-ex3-exam-coverage-dashboard`
...
|--------|------|-----------|---------------|
| EX-4 | CLI-Backed MTU / Operation / Answer-Skill Mutation | no | **ACTIVE / GOVERNED MUTATION-PLANNING PREP ONLY.** EX-3 generated coverage evidence and kept q3/q15 answer-skill needs plus q19 source/graph blockers visible. EX-4 may now draft the governed mutation-planning packet and human-authorization questions for any MTU, operation, answer-skill, or PV/graph route. It must not execute mutation until explicit human authorization and CLI-backed validators exist. |
