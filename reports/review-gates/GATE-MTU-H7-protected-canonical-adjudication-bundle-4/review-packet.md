...
- proof_required_to_close: H7-B4-FINDING-REMOTE-PR-PROOF-PENDING; Exact remote PR head, PR Readiness Reviewer output, branch-protection ok:true output, CI, and owner authorization are required before ready/merge.
