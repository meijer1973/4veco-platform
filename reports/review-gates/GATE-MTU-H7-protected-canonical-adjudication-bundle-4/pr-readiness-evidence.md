...
Throughput packet: `GATE-MTU-H7-protected-canonical-adjudication-bundle-4`

Review autonomy: `L4` / authority `high_authority`

Human decision required: `true`; auto-merge after CI: `false`

Declared changed paths: 22
...
- `node build-scripts/sprints/check-review-throughput-packet.js reports/review-gates/GATE-MTU-H7-protected-canonical-adjudication-bundle-4/pr-readiness-evidence.json`
