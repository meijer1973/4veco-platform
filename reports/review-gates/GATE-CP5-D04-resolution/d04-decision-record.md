...
- target_exercise: `references/authored/course-target-exercises.json` (2.1.3 Income elasticity and cross elasticity) - Owned target exercise groups D04 with income and cross elasticity work rather than as a standalone exercise target.
