...
def probes(commit):
    ...
    eq('T4 other competitor price percentage',pct(8,9),F(25,2),[F(100,9),1])
    eq('T4 correct named cross ratio',F(5)/pct(8,9),F(2,5),[F(5,8),F(25,2),F(5)])
    tq=lambda p,pc,y:12000-400*F(p)+F(1,10)*F(y)+300*F(pc)
    eq('T5 source-D monthly Q, annual Y, fixed both prices',[tq(12,10,40000),tq(12,10,42000)],[14200,14400],[ [tq(12,10,F(40000,12)),tq(12,10,F(42000,12))] ])
    eq('T5 source-D independent income change',tq(12,10,42000)-tq(12,10,40000),200,[20,2000])
