"""HOW TO ADAPT: bounded §224 independent reviewer evidence; immutable attempts, no acceptance.
...
PBASE="b777877deb69a2094b9eff575e16e791744e85f1"
LBASE="994657c8901729fcb138493be4e8c2e9590081bd"
...
def init():
    ...
    instructions=json.loads((ROOT/"reports/sprints/BOOK2-TEXTBOOK-PRODUCTION-1-224-BUILD-baseline.json").read_text(encoding="utf-8"))["instructions"]
    ...
    write_new(path,{"created":now(),"actor":"paragraph_231_specialist_qc","bases":{"platform":PBASE,"lessons":LBASE},
...
def reserve(label):
    ...
    for worktree in sorted(registered):
        candidate=Path(worktree)/"reports"
    ...
    write_new(path,{"created":now(),"actor":"paragraph_231_specialist_qc","label":label,"revision":revision,
...
def custody():
    ...
    allowed={(b.LESSON_REL/"2.2.4-review.md").as_posix()}
