...
Status: evidence-only sprint diff; no platform UI repair and no generated
lesson-output change.

## Platform Changes

Added sprint proof tooling:

- `build-scripts/sprints/capture-reason-play1-screenshots.js`
- `build-scripts/sprints/check-reason-play1-usability.js`

Added sprint artifacts:
...
No generated lesson-output files changed in this sprint.

The screenshot proof reads the generated Book 1 reasoning pages through a local
static server, but it does not write lesson output.
...
The diff does not authorize target-equivalent claims, completion language,
diagnostics, adaptive routing, mastery, sequencing, student-facing AI,
summative use, PV projection or promotion, Scale Gate 1, or product use.
