"""Distinct specialist R7 diagnostics, adapted from the paragraph checker; freshly executed. No visual acceptance is inferred here."""
import hashlib
import json
import re
import subprocess
...
def main():
    ...
    for name in ('2.2.1-textbook-plan.md',
    ...
    check(folder/'2.2.1-review.md', baseline='73e552fb83bc3a79b9bec1f15bd3919af2a5ea0b', repo=LESSONS)
    proof = []
    ...
    write('QC-r7-diagnostic-manifest.json', mapped)
    write('QC-r7-probes.json', {'status':'PASS', 'reviewer':'paragraph_221_r7_specialist_qc',
