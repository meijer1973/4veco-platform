...
- run `26953928228` showed that workflow reset alone was not sufficient for
  `reports/url-index.md`; `.gitattributes` and explicit checkout-index
  normalization now force LF for that generated byte-checked file.
