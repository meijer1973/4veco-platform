...
## Meer maken: duurder of goedkoper?

Een klein atelier maakt sleutelhangers voor schoolfeesten. Bij meer sleutelhangers gebruikt het meer kunststof. De huur verandert niet. Toch kan iedere sleutelhanger gemiddeld goedkoper worden. Hoe kan het totale kostenbedrag stijgen terwijl de kosten per sleutelhanger dalen?
...
## Welke kosten veranderen mee?

We bekijken steeds **één producent**, gedurende **één afgesproken periode**. De productiecapaciteit blijft gelijk. Dat betekent bijvoorbeeld dat dezelfde ruimte en machines beschikbaar blijven. Q is de geproduceerde hoeveelheid in die periode. Binnen een genoemde productiegrens bekijken we wat er gebeurt als alleen Q verandert.

> **Definitie: constante kosten**
> Constante kosten veranderen niet met Q binnen de afgesproken periode en bij gelijkblijvende productiecapaciteit.

Het atelier betaalt per week € 100 voor de ruimte en € 20 voor een softwareabonnement. Bij 100 of 200 sleutelhangers blijven deze weekbedragen gelijk. Ook een abonnement kan later duurder worden. Dat maakt het niet variabel: het gaat om de reactie op Q binnen het gekozen model.

> **Definitie: variabele kosten**
> Variabele kosten veranderen met Q binnen de afgesproken periode.

Per sleutelhanger gebruikt het atelier voor € 0,40 aan kunststof en voor € 0,10 aan verpakking. Meer sleutelhangers betekenen meer kunststof en verpakking. Hier blijven deze bedragen **per sleutelhanger** gelijk. Dat is een aanname; bijvoorbeeld een andere inkoopprijs kan de kosten per sleutelhanger veranderen.

> **Let op: de naam op de rekening beslist niet.**
> Een energierekening kan een vast abonnement én verbruikskosten bevatten. Het abonnement kan constant zijn, terwijl het totale verbruiksbedrag meegroeit met Q. Classificeer ieder onderdeel op zijn gedrag.

## Van losse bedragen naar totale kosten

> **Definitie: totale constante kosten (TCK)**
> TCK is de som van alle constante kosten in de gekozen periode.

Voor het atelier is TCK = 100 + 20 = 120 euro per week.

> **Definitie: totale variabele kosten (TVK)**
> TVK is de som van alle variabele kosten in de gekozen periode.

Bij een constant variabel bedrag per product vermenigvuldig je dat bedrag met Q. Voor het atelier is dat (0,40 + 0,10) × Q = 0,50Q euro per week.

> **Definitie: totale kosten (TK)**
> TK is de som van de totale constante en totale variabele kosten.

> **Formules voor dit atelier**
>
> TCK = 120\
> TVK = 0,50Q\
> TK = TCK + TVK = 120 + 0,50Q
>
> Q is in sleutelhangers per week; alle totale kosten zijn in euro per week. Het model geldt voor 100–200 sleutelhangers per week, bij dezelfde capaciteit en dezelfde tarieven.

## Wat kost één product gemiddeld?

Een totaal bedrag vertelt wat de hele productie kost. Voor een gemiddelde verdeel je dat bedrag over alle producten. Je deelt dus door Q uit **dezelfde periode**. Delen door nul kan niet: gemiddelde kosten zijn alleen gedefinieerd bij Q > 0.

> **Definitie: gemiddelde constante kosten (GCK)**
> GCK zijn de totale constante kosten gedeeld door het aantal producten.

Het totale bedrag kan gelijk blijven terwijl het bedrag per product daalt. Dezelfde huur wordt dan over meer sleutelhangers verdeeld.

> **Definitie: gemiddelde variabele kosten (GVK)**
> GVK zijn de totale variabele kosten gedeeld door het aantal producten.

In dit model kost elke sleutelhanger € 0,50 aan kunststof en verpakking. Daarom blijven de GVK € 0,50 per sleutelhanger. Zonder die aanname mogen we geen constante GVK beloven.

> **Definitie: gemiddelde totale kosten (GTK)**
> GTK zijn de totale kosten gedeeld door het aantal producten.

> **Formules voor gemiddelde kosten, bij Q > 0**
>
> GCK = TCK / Q\
> GVK = TVK / Q\
> GTK = TK / Q = GCK + GVK
>
> Deel euro per week door sleutelhangers per week: de uitkomst is euro per sleutelhanger. Gemiddelde kosten zijn geen totale weekbedragen.

Figuur 1 brengt de begrippen samen. Tel binnen een rij op; deel in iedere kolom door dezelfde positieve Q.

![Figuur 1. Van totale kosten per periode naar gemiddelde kosten per product: constant plus variabel is totaal.](_assets/2.1.1_fig_1.png)

> **Let op: alleen het constante deel wordt uitgesmeerd.**
> Als Q verdubbelt, halveert GCK bij gelijkblijvende TCK. GVK halveert in dit model niet. Daarom halveert GTK ook niet. “De kosten dalen” is onvolledig: benoem welke kosten en welke eenheid.
