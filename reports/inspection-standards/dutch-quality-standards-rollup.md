# GOAL-DQS-CLOSURE-1A Dutch Quality Standards Roll-Up

Status: internal_multiscope_rollup_generated
Date: 2026-06-20
...
| Chapter 1.1 historical bounded control included | `met` | multi_scope_categories.chapter_1_1_historical_bounded_control |
| Chapter 1.2 internal diagnostic scope included with active blockers | `met` | multi_scope_categories.chapter_1_2_internal_diagnostic_scope |
| Chapter 1.3 internal diagnostic scope included with route-local evidence and downstream blockers | `met` | multi_scope_categories.chapter_1_3_internal_diagnostic_scope |
| System layer included | `met` | multi_scope_categories.system_layer |

## Roll-Up Summary

Recommended closure decision: `CLOSE_INTERNAL_SYSTEM`
...
Product end-state trace: The product end-state asks each paragraph to expose a visible route from current readiness to target-exercise readiness. The roll-up shows route-local product evidence for Chapter 1.2 and Chapter 1.3, but not school-owned implementation evidence.

Original spec trace: The original quality-standards roadmap distinguishes internal product evidence from school-owned evidence and competent-authority judgement.

## Multi-Scope Categories

### Chapter 1.1: historical bounded control only
...
### Chapter 1.2: internal diagnostic scope with active blockers
...
### Chapter 1.3: internal diagnostic scope with route-local evidence and downstream blockers
...
### System layer: manual internal Dutch evidence-support system
...
|---|---|---|---|---|
| The Dutch roll-up supports closing the current internal/report-only system only. | `closure_decision_support` | School-pack trial, teacher/school-facing output, public/external output, product-route adoption, Scale Gate, diagnostics/mastery/PV, student/product-use, international work, and compliance/approval claims. | Owner review of CLOSE_INTERNAL_SYSTEM as the final decision. | DQS checker confirms all roll-up categories include required fields and all authority flags remain false. |
