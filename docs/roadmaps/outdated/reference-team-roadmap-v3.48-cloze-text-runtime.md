...
Roadmap version: `v3.48-cloze-text-runtime`
...
Next action: proceed to `TASK-FAMILY-MULTI-1` as the next structured
...
`TASK-FAMILY-SENTENCE-1`, `TASK-FAMILY-FORMULA-1`, and
`TASK-FAMILY-CLOZE-1` runtimes may not be adopted in generated lesson routes
before a later adoption sprint supplies product-route rendered proof.
...
`TASK-FAMILY-SENTENCE-1`, or `TASK-FAMILY-FORMULA-1`.
