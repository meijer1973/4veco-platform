...
Roadmap version: `v3.49-multi-select-runtime`
...
Next action: proceed to `TASK-FAMILY-ORDER-1` as the next structured
choice implementation sprint, or to `GAME-ROUTE-AFFORDANCE-1` if
...
and `TASK-FAMILY-MULTI-1` runtimes may not be adopted in generated lesson
...
`TASK-FAMILY-SENTENCE-1`, `TASK-FAMILY-FORMULA-1`, or `TASK-FAMILY-MULTI-1`.
