...
- `LESSON-SCALE-1` tracks the lesson-side pre-scale dependency: L1.7A has
  ...
  Broad companion/product scaling must still wait for L1.7D, L2.0, a resumed
