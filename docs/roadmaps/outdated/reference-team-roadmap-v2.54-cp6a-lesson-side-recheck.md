...
|--------|------|-----------|---------------|
| CP.6b | Year-1 Target-Exercise Review | no | **ACTIVE / REMEDIATION LANE 2 AFTER CP.6a RECHECK.** Lesson-side L-CP6A fixed the `1.3.2`/`1.3.3` source/lesson mismatch with carried conditions, but target-exercise evidence is still open. Review the nine migrated Book 1 target exercises and design/review the three gemengde-opgaven integration target exercises before any `reviewed_final` or final-coverage claim. No protected mutation, target-exercise promotion, placeholder finalization, CP-6 closure, or Year-1 closure in this planning/review lane. |
