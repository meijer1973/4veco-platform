...
Roadmap version: `v3.47-formula-builder-runtime`
...
Next action: proceed to `TASK-FAMILY-CLOZE-1` as the next structured
choice/construction implementation sprint, or to `GAME-ROUTE-AFFORDANCE-1` if
route affordance is the priority. The closed `TASK-FAMILY-CLOZE-TILE-1`,
`TASK-FAMILY-SENTENCE-1`, and `TASK-FAMILY-FORMULA-1` runtimes may not be
adopted in generated lesson routes before a later adoption sprint supplies
product-route rendered proof.
