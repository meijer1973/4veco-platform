...
Roadmap version: `v2.56-cp6b-target-exercise-review`
...
|--------|------|-----------|---------------|
| CP.6c | Year-1 MTU Backfill Classification | no | **ACTIVE / REMEDIATION LANE 3 AFTER CP.6b.** CP.6b recorded the non-final target-exercise review/design packet: nine migrated records remain non-final, three gemengde-opgaven draft designs need later teacher-learning-quality review, and no registry mutation or placeholder finalization occurred. Classify the nine Year-1 backfill candidates as true missing unit, existing-unit mapping, merge candidate, or defer candidate before any CLI-backed mutation sprint. |
...
- `CP.6c` active next: Year-1 MTU backfill classification before mutation.
...
Next action: run `CP.6c Year-1 MTU Backfill Classification`. CP.6a plus lesson-team L-CP6A cleared the `1.3.2`/`1.3.3` source/lesson mismatch with carried conditions, and CP.6b recorded the non-final target-exercise review/design packet. CP.6b does not close CP-6 or Year 1: nine migrated Book 1 target exercises still need explicit v5 review artifacts, three gemengde-opgaven draft designs still need later teacher-learning-quality review and governed registry-update procedure, and no target exercise was promoted or finalized. CP.6c must classify the nine Year-1 backfill candidates before any CLI-backed mutation sprint. The remaining CP-6 lanes after CP.6c are CP.6d graph-heavy evidence upgrade and CP.6e focused `1.1.3` Part A re-review. After CP.6e, the next inserted strategic lane is EX-0 through EX-2: design and pilot official exam-question ingestion with source-annex and answer-model traceability before Year-2 skeleton work depends on exam-operation claims. The remaining blocks on diagnostics, adaptive routing, mastery, sequencing, student-facing AI, summative use, PV projection, and PV machine promotion remain in force.
