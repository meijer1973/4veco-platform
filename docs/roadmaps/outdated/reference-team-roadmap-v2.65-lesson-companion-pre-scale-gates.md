...
Roadmap version: `v2.65-lesson-companion-pre-scale-gates`
...
| Product Gate | Re-Evaluate R10-R13 Product Surfaces | no | Blocked. Diagnostics, adaptive routing, student-facing AI, teacher cockpit deployment, automatic sequencing, mastery, and summative uses remain out of scope until data-quality gates justify them. Broad lesson-companion scaling also remains blocked until lesson L1.7A-D and L2.0 establish the companion-set contract, game-row quality rubric, and landing-page information architecture. |
...
LESSON-SCALE-1 lesson companion pre-scale gates tracked: L1.7A-D and L2.0 before broad companion/product scaling
