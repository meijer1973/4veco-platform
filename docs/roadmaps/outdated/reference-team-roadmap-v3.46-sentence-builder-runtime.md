...
Roadmap version: `v3.46-sentence-builder-runtime`
...
| TASK-FAMILY-FORMULA-1 | Formula Builder Task-Family Implementation | no | Add `formula_builder` so students construct formulas from symbols/terms before calculation work. Use for percentage change, index numbers, elasticity, revenue, profit, and later MO/MK/GTK procedures. |
...
| TASK-FAMILY-CLOZE-TILE-1 | Cloze Tile-Select Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, and lead-review records. No generated lesson output or product-route adoption. Flags: unrelated zip remains out of scope and product-route screenshots are deferred to adoption. |
| TASK-FAMILY-SENTENCE-1 | Sentence Builder Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, and lead-review records. No generated lesson output or product-route adoption. Flags: unrelated zip remains out of scope; product-route screenshots and dynamic rendered interaction proof are deferred to adoption. |
| TASK-FAMILY-FORMULA-1 | Formula Builder Task-Family Implementation | no | Implement formula construction from formula blocks/symbols for percentage change, index number, elasticity, revenue, profit, and later marginal/average procedures. |
...
structured-choice/construction contract sprints, or `TASK-FAMILY-CLOZE-TILE-1`.
