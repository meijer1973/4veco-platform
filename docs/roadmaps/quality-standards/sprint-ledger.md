...
approves a new packet. INSPECT-8 is closed as the Dutch readiness audit, and
INSPECT-9 is closed as the gap-closure plan. The
...
| --- | --- | --- |
| `INSPECT-9A` | Chapter 1.2 Target And Exam-Linkage Remediation. Close or explicitly defer Chapter 1.2 target-finality, `1.2.4` integration-target, exam-code linkage, and Chapter 1.1 control-scope remediation decisions before INSPECT-10. | recommended next planning sprint; not authorised until fresh plan and review |
| `INSPECT-10` | Dutch Report-Only Generator First Implementation. Implement a reusable Dutch report-only generator only after readiness/gap evidence supports it and review gates pass. | not authorised |
