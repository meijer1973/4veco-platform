...
| `INSPECT-6` | in progress / planning-only | Report-only generator planning. Defines future generator architecture, source contract, teacher-facing output shape, validation/dispatch plan, safe-claim and semantic-overclaiming requirements, and INSPECT-7 readiness criteria. | `archive/sprints/INSPECT-6/INSPECT-6-sprint-plan.md`; `docs/inspection-standards/report-only-generator-plan.md`; `docs/inspection-standards/evidence-pack-source-contract.md`; `docs/inspection-standards/evidence-pack-validation-and-dispatch.md`; `archive/sprints/INSPECT-6/INSPECT-6-generator-planning-packet.md` | pending closure commit | Planning only. No generator implementation, evidence pack, dashboard gate, quality-ref integration, Scale Gate work, lesson-output mutation, personal-data processing, or compliance/approval claim. |
