...
Branch in use: `codex/inspect-9a-chapter-12-target-exam-remediation-20260611`
...
INSPECT-9 is closed as the gap-closure plan, and INSPECT-9A is closed as the
Chapter 1.2 source-registry remediation sprint. The
...
| --- | --- | --- |
| `INSPECT-9B` | Chapter 1.2 Target-Equivalent And Accessibility/Support Evidence Review. Decide whether target-equivalent, accessibility, and support evidence is enough for a tightly scoped INSPECT-10 report-only implementation or remains a blocker. | recommended next planning sprint; not authorised until fresh plan and review |
| `INSPECT-10` | Dutch Report-Only Generator First Implementation. Implement a reusable Dutch report-only generator only after readiness/gap evidence supports it and review gates pass. | not authorised; do not start while INSPECT-9B blockers remain unresolved |
