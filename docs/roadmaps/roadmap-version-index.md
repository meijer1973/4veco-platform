...
|---|---|---|---|
| References Team Roadmap | `v3.04-gate-mtu-h3-pass-with-conditions` | `references/reference-team-roadmap.md` | Current operating roadmap after GATE-MTU-H3 closed pass with conditions and MTU-H3A became the active incidence/pass-through CLI-mutation planning lane. |
