...
Roadmap version: `v1.8-b2-2.2.1-closed`
...
`B2-2.2-READY-1` is closed as readiness only. It did not write paragraphs or regenerate lesson output. Human instruction opened `B2-2.2.1-HARDEN` on 2026-06-17; that sprint is now closed PASS WITH FLAGS. The next planned sprint is `B2-2.2.2-HARDEN`, but it must not start without explicit human opening. Do not start 2.2.3, 2.2.4, Chapter 2.3, or Book 3.
...
Prepare, but do not start, `B2-2.2.2-HARDEN` unless a human explicitly opens it. It should cite `reports/sprints/B2-2.2-READY-1-readiness-brief.md`, `references/authored/textbook-rendered-page-acceptance-standard.md`, `references/authored/textbook-figure-standard.md`, and the closed `B2-2.2.1-HARDEN` result. It must keep 2.2.2 within its own elasticity-and-omzet scope and leave 2.2.3, 2.2.4, Chapter 2.3, Book 3, target promotion, and product gates untouched.
