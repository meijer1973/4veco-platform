...
| Textbook paragraph / Part A | [Part A entry checklist](docs/workflows/part-a-start.md), with the [lane vocabulary](docs/workflows/paragraph-lane-vocabulary.md) and [textbook runbook](docs/workflows/textbook-paragraph-lane.md) for ownership and task-specific contracts. |
