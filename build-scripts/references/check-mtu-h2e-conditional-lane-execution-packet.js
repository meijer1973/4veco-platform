...
if (!/\| (GATE-MTU-H2G|MTU-H2G|MTU-H2F|GATE-MTU-H2E|MTU-H2E) \|/.test(firstRow)) {
  fail('first Sprint Ledger row must be GATE-MTU-H2G, MTU-H2G, MTU-H2F, GATE-MTU-H2E, or MTU-H2E for H2E lifecycle');
}
