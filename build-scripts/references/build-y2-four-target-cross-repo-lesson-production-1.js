...
function renderedProofHtml(bundle) {
  ...
  const screenshotGallery = screenshotProof.status === 'captured'
    ? `<section class="screenshot-grid" aria-label="Rendered screenshot proof">
      ${screenshotProof.cases.map((item) => {
