...
if (!/\| (MTU-H3|MTU-H2J|GATE-MTU-H2I|MTU-H2I|GATE-MTU-H2H|MTU-H2H|GATE-MTU-H2G|MTU-H2G|MTU-H2F|GATE-MTU-H2E|MTU-H2E|GATE-MTU-H2D|MTU-H2D) \|/.test(firstRow)) {
  fail('first Sprint Ledger row must be MTU-H3, MTU-H2J, GATE-MTU-H2I, MTU-H2I, GATE-MTU-H2H, MTU-H2H, GATE-MTU-H2G, MTU-H2G, MTU-H2F, GATE-MTU-H2E, MTU-H2E, GATE-MTU-H2D, or MTU-H2D for H2D lifecycle');
}
