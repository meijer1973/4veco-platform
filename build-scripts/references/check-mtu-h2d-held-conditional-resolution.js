...
if (!/\| (GATE-MTU-H2E|MTU-H2E|GATE-MTU-H2D|MTU-H2D) \|/.test(firstRow)) {
  fail('first Sprint Ledger row must be GATE-MTU-H2E, MTU-H2E, GATE-MTU-H2D, or MTU-H2D for H2D lifecycle');
}
