...
function residualPartialResumeHarness(options = {}) {
  ...
  const setup = harness({
    deps: {
      ...
      refreshBundleAgentIndexes: jest.fn((refreshOptions) => refreshResultFixture({
  ...
  return { ...setup, integrationHead, applyLiveDecision, getPublishedDecision: () => publishedDecision };
}
