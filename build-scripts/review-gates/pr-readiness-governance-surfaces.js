const GOVERNANCE_SURFACE_PATTERNS = Object.freeze([
  ...
  /^build-scripts\/review-gates\/check-human-payload-authorization(?:\.test)?\.js$/i,
  /^build-scripts\/review-gates\/check-integration-lineage(?:\.test)?\.js$/i,
  /^build-scripts\/review-gates\/integrate-authorized-pr(?:\.test)?\.js$/i,
  /^build-scripts\/review-gates\/authorized-pr-integration-workflow\.test\.js$/i,
  ...
  /^docs\/review\/pr-integration-lane-policy\.md$/i,
  /^docs\/review\/human-payload-authorization\.schema\.json$/i,
