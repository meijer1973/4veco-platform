...
async function build() {
  ...
  pres.title = "3.3.1 De rol van de overheid — creatief";
  ...
  // OUTPUT
  // ────────────────────────────────────────────────────────────────────
  const outDir = path.resolve(__dirname, "../../output-331-creative");
  ...
  const outPath = path.join(outDir, "3.3.1 De rol van de overheid – presentatie – creatief.pptx");
