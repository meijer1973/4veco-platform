...
async function build() {
  ...
  pres.title = "3.3.2 Overheidsbeleid — creatief";
  defineMasters(pres);
  ...
  const outDir = path.resolve(__dirname, "../../output-332-creative");
  ...
  const outPath = path.join(outDir, "3.3.2 Overheidsbeleid – presentatie – creatief.pptx");
