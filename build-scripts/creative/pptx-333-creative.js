...
async function build() {
  ...
  pres.title = "3.3.3 Collectieve goederen — creatief";
  defineMasters(pres);
  ...
  const outDir = path.resolve(__dirname, "../../output-333-creative");
  ...
  const outPath = path.join(outDir, "3.3.3 Collectieve goederen – presentatie – creatief.pptx");
