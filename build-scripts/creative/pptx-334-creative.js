...
async function build() {
  ...
  pres.title = "3.3.4 Toepassen — creatief";
  defineMasters(pres);
  ...
  const outDir = path.resolve(__dirname, "../../output-334-creative");
  ...
  const outPath = path.join(outDir, "3.3.4 Toepassen – presentatie – creatief.pptx");
