...
const inputs=[
  ...['assemble_book2_signed.py','book2_native_checks.py','book2_native_theory.py','book2_signed_exports.py',
...
const doc={revision:r.REVISION,baseline_lesson_commit:r.BASE,scope:'43 native theory/reference pages and bounded signed-elasticity wording; existing route overlay preserved. No lifecycle promotion, Book 3/4 or Part B change.',
