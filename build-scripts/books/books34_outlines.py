"""Current outline reading copies; received layout, amended sources.

The immutable received migration document is not rebuilt by a route revision.
"""
...
for filename,name in [('book-3-outline-v3.md','Boek_3_Boekopzet_v3.pdf'),('book-4-outline-v3.md','Boek_4_Boekopzet_v3.pdf')]:
