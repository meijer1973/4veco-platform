...
// research agent with a URL-only fetch workflow at every high-value
...
function buildBody(branch) {
  ...
  lines.push('');
  lines.push(
    'Single-fetch entry point for external research agents whose fetch tools can only follow URLs that have ' +
