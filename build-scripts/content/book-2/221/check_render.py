"""Inspect actual §221 generated text, font sizes, assets and proof freshness.
...
def inspect(lesson_root: Path, manifest_path: Path, rebuild=False):
    ...
    results = {'paragraph': '2.2.1', 'visual_acceptance': 'NOT_SUPPLIED_BY_THIS_SCRIPT',
    ...
    for record in manifest['documents']:
        ...
        # All authored SVG text is >=22px on a720px canvas. Measure actual
        # placement from PDF image transforms, including the85% worked figure.
    ...
    results['checks'] = ['exact frozen goals/context/a-d/3+2+2+2points/short answers',
