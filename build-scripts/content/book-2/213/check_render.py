...
def inspect():
    ...
    record=b.target_record(); docs=b.documents(record); fragments=[]; results=[]; raster_checks=[]
    ...
    return {'paragraph':'2.1.3','automated_result':'PASS','inspection_status':'NOT_SUPPLIED_BY_THIS_SCRIPT',
        'documents':results,'raster_checks':raster_checks,'checks':['frozen native tables, 10/6 blanks, Q0 dashes, 4/3/2/4/2 points, all target text and four goals',
