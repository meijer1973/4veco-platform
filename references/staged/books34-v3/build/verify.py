"""Read-only checks of the delivered v3 edition and its curriculum module."""
...
def main():
 ...
 ck('Non-open designed lessons at most55',all(v['total_minutes'] is None or v['total_minutes']<=55 for v in routes.values()))
 ...
 (ROOT/'checks/verification.json').write_text(json.dumps(report,ensure_ascii=False,indent=2), encoding='utf-8', newline='\n')
