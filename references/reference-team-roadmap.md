...
GRAPH-UX-2 and MATH-UX-2 have since closed; top operational next action is
`REASON-UX-2`.
...
the live math/calculation route. Top operational next action is `REASON-UX-2`.
...
closed as math/task-shell proof. Top operational next action is `REASON-UX-2`;
no Scale Gate 1,
...
Next action: start `REASON-UX-2 Reasoning Game Variant And Feedback Upgrade`. GRAPH-UX-2 has integrated the GAME-UX-3A task shell into the live Book 1 `1.1.3` graph/table route, and MATH-UX-2 has integrated the same shared task shell into the live `1.1.2` calculation/index route. REASON-UX-2 should now improve the reasoning game with richer causal/procedural variants, better replay value, short explanation or structured reasoning tasks, and feedback that explains reasoning errors. It must not claim target-equivalent proof, write target-exercise fields, create candidate storage, authorize diagnostics/adaptive/mastery/sequencing/student-facing AI/summative/PV/product use, or advance Scale Gate 1.
