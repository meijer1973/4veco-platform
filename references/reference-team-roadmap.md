...
Exam ingestion is also a student-facing product concern. For exam-target
paragraphs, official prompt, source annexes, figures/tables/graphs, correction
...
answer-writing requirements must trace into the paragraph plan, explanation,
practice route, skill-map route, shared task-type UI, target-equivalent exit
ticket, answer model, and review gates.
...
|--------|------|-----------|---------------|
| SINGLE-PR-DRY-RUN-REPAIR-1 | Canonical Single-PR Dry Run | yes | Completed in PR #220 at corrected substantive head `7cf18780...`: plain `--dry-run` is the canonical non-mutating pre-merge validation path, reports `validated_dry_run` without invented merge state, proves behind/movement handling plus unchanged live behavior, and classifies only the two mandatory internal-dashboard closure outputs as shared. Exact-head hosted CI, readiness and explicit owner authorization remain required; no workflow, bundle-runner, Lesson, product, Y1, protected-reference, authorization-model, authority, or merge change is included. |
| BUNDLE-LANE-CI-RELIABILITY-1 | Bundle Lane CI Reliability | yes | Governance repair in review on PR #217. Reuses exact automatic Platform-main push CI, adds exact-input absence-only fallback dispatch for coordinated-bundle intermediate/final states, and makes post-merge verification failure explicit. No PR #208 reopening, Lesson/product/engine/source/Y1/protected-reference change, bundle execution, or merge authority is included. |
...
| CHECKSURFACE-113-EXEMPLAR-EXIT-1 | Excellent 1.1.3 Exit Ticket Implementation | yes | Closed implementation/evidence sprint from `knowledge/113-excellent-exit-ticket-v3-package.zip`. Replaced the `1.1.3` exit-ticket source with the v3 independent-work design, extended shared task-shell support for interval-first graph reading, formula building, tolerant percent parsing, two-point table graph construction, and durable exemplar guidance, then regenerated Book 1 output through deploy only. End state remains `hold_for_exemplar_review`; specialist review is tracked separately in `CHECKSURFACE-113-EXEMPLAR-REVIEW-1`. No new completion language, product-route adoption, diagnostics, mastery/sequencing, PV, Scale Gate 1, broad product use, or student/product use is authorized. |
| MTU-GENBLOCK-HARDEN-1 | Generator-Blocked MTU Exposure Hardening | yes | Completed as an exposure-hardening sprint. Source and deploy skill-tree route catalogs now exclude generator-blocked A-domain units while preserving non-A concept route rows; readiness reports/checkers validate explicit block records, zero interactive leaks, zero route leaks, false downstream authority flags, and deterministic negative-fixture rejection. Current proof records 98 active A-domain units, 47 generator-backed interactive units, 51 generator-blocked units, 202 source/deploy route rows, and 0 blocked route leaks. First-three product-route relevance remains blocked for A80/A81/A96-A99 answer-form units until generator implementation plus separate reviewed route/product adoption. No missing-generator implementation, source-data write, generated lesson output, PV projection, diagnostics, adaptive routing, mastery/sequencing, Scale Gate 1, product-route adoption, or student/product authority was authorized. |
| MTU-EVIDENCE-HARDEN-1 | MTU Evidence Layer Freshness | yes | Closed 2026-06-07 as PASS. Added a read-only MTU evidence-layer freshness checker, wired it into platform CI, regenerated stale report/readiness/audit outputs through intended scripts, and refreshed roadmap/index/dashboard artifacts. The canonical MTU projection remains 256 total / 253 live / 3 deprecated units; checked report surfaces now agree, including JSON-first coverage, empty-needs audit, procedure-visual coverage, skilltree readiness, reference health, and generated review-gate packet summaries. No protected reference mutation, source-data write, target-exercise mutation, lesson output, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, Scale Gate 1, product-route adoption, product-wide use, or student/product authority is authorized. |
...
| REVIEW-THROUGHPUT-1 | PR Throughput Policy | yes | Closed 2026-06-14 as PASS governance/checker sprint. Added PR throughput classes, an L0-L4 review-autonomy ladder, machine-readable future packet fields, a review-throughput schema, an autonomous-classification checker with positive/negative fixtures and Jest coverage, and a retrospective for platform PRs #42-#56 plus lesson PRs #4-#13. The policy reduces avoidable review overhead only when CI/checker and lead-review proof exist and no escalation trigger fires. No protected reference mutation, machine/external reference mutation, generated lesson output, product authority, diagnostics, mastery, PV, Scale Gate 1, or student/product use is authorized. |
| REVIEW-THROUGHPUT-2 | Throughput Field Rollout | yes | Closed 2026-06-14 as PASS. Added a shared review-throughput field helper for generated packet builders, wired selected MTU human-gate packet generators to emit L4/high-authority packet fields, validated adopted H2E/H4B packet envelopes, and documented that broad CI enforcement waits for historical packet migration or an active-packet allowlist. No protected reference mutation, machine/external reference mutation, generated lesson output, product authority, diagnostics, mastery, PV, Scale Gate 1, or student/product use is authorized. |
| REVIEW-THROUGHPUT-3 | PR Readiness Router | yes | Closed 2026-06-22 as PASS WITH FLAGS. Added an independent PR Readiness Reviewer, pure draft-to-review routing classifier, decision schema, read-only live PR evidence collector, explicit transition executor, L0/L1/L2 throughput helper constructors, fixtures, tests, and operating-policy updates. Remaining flags are operational: branch-protection approval identity remains an infrastructure decision, and this governance implementation PR requires human review. No protected reference mutation, machine/external reference mutation, generated lesson output, product authority outside review-routing policy, diagnostics, mastery, PV, Scale Gate 1, or student/product use is authorized. |
...
| EXERCISE-WORKFLOW-CHECKER-CLEANUP-1 | Exercise Workflow Checker Cleanup | yes | Completed bounded cleanup to repair live checker, active report JSON, and gate-evidence path references after the exit-ticket source split from legacy unsuffixed files such as `1.1.2.json` to current split files such as `1.1.2-exit-ticket.json` and `1.1.2-korte-check.json`. Scope is validation/evidence hygiene only: no source-data edits, generated lesson output, engine behavior changes, protected reference mutation, target-exercise writes, product-route adoption, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use. |
| EXERCISE-EVIDENCE-CURRENTNESS-HARDENING-1 | Exercise Evidence Currentness Hardening | yes | Closed PASS after implementation and sub-agent lead review. Turned the PR #183 one-off cleanup into durable currentness policy by wiring the exercise currentness checker into npm/CI, adding a compact exercise-surface manifest and generated-lesson path classifier, guarding superseded checkers, marking legacy-path sprint metadata as historical/inactive, and annotating roadmap wording where old pre-split paths could look current. Scope is validation/evidence hygiene only: no source-data edits, generated lesson output, engine behavior changes, protected reference mutation, target-exercise writes, product-route adoption, diagnostics, mastery/sequencing, PV, Scale Gate 1, broad product use, or student/product use. PR still requires readiness routing and human review before merge because governance/CI behavior changed. |
| EXERCISE-AUTHORITY-HYGIENE-BUNDLE-1 | Exercise Authority Hygiene Bundle | yes | Closed PASS after implementation and sub-agent lead review. Added an authority-hygiene manifest and CI-wired checker that canonicalize `references/exemplars/1.1.3-exit-ticket/`, classify the product-excellence copy as historical alias, classify Golden fixture roots as active checker fixtures or frozen report snapshots, and make `knowledge/exit-ticket-game-1.1.1.zip` disposition machine-readable and hash-checked. Scope is manifest/checker/report governance only: no source-data edits, generated lesson output, engine/runtime behavior changes, protected reference mutation, target-exercise writes, ZIP binary edits, product-route adoption, completion-language authorization, diagnostics, mastery/sequencing, PV, Scale Gate 1, broad product use, or student/product use. PR still requires readiness routing and human review before merge because governance/CI behavior changed. |
...
| TASK-FAMILY-CHOICE-1 | Structured Choice Task-Family Contract | yes | Closed no-implementation contract sprint after planning review and lead-review cycle. Defined shared-shell contracts for `cloze_text`, `multi_select`, `matching_pairs`, `step_ordering`, `two_tier_choice`, and `assertion_reason`, including response shapes, validation/evaluation owners, feedback owners, focus/keyboard expectations, use cases, and target-proof limits. No engine implementation, generated output, product authority, or target-equivalent reliance was authorized. |
| TASK-FAMILY-CONSTRUCT-1 | Constrained Construction Task-Family Contract | yes | Closed no-implementation contract sprint after planning review and lead-review cycle. Defined construction contracts for `cloze_tile_select`, `sentence_builder`, `formula_builder`, `source_value_selection`, `source_chain_builder`, and `label_placement`, including token/tile-bank rules, distractor policy, ordering/placement semantics, accessibility expectations, use cases, and operation-chain proof limits. No engine implementation, generated output, product authority, or target-equivalent reliance was authorized. |
| TASK-FAMILY-CLOZE-TILE-1 | Cloze Tile-Select Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint after planning review and lead-review cycle. Added `cloze_tile_select` as a deterministic shared task-shell family with inline blanks, selectable tile bank, no-reuse default, distractor validation, exact `{ blanks }` response matching, shared UI helpers, wrapper collection for exit-ticket/skilltree/graph surfaces, focused tests, rendered report fixture, proof JSON, and checker. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. Route-specific rendered proof required before product-route adoption. |
| TASK-FAMILY-SENTENCE-1 | Sentence Builder Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint after planning review and lead-review cycle. Added `sentence_builder` as a deterministic shared task-shell family with fragment bank, ordered construction zone, clear/remove/reorder controls, no-reuse default, distractor validation, exact `{ tokens }` response matching, accepted sequence validation, shared UI helpers, wrapper collection for exit-ticket/skilltree/graph surfaces, focused tests, rendered report fixture, proof JSON, and checker. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. Route-specific rendered proof required before product-route adoption. |
| TASK-FAMILY-FORMULA-1 | Formula Builder Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint after planning review and lead-review cycle. Added `formula_builder` as a deterministic shared task-shell family with formula-block bank, ordered formula construction zone, formula category metadata, no-reuse default, distractor validation, exact `{ tokens }` response matching including extra-key rejection, accepted sequence validation, shared UI helpers, wrapper collection for exit-ticket/skilltree/graph surfaces, focused tests, rendered report fixture, proof JSON, and checker. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. Route-specific rendered proof required before product-route adoption; formula equivalence beyond exact sequences requires domain-reviewed evaluator work; calculation execution remains a separate calculation-work task. |
| TASK-FAMILY-CLOZE-1 | Cloze Text Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint after planning review and lead-review cycle. Added `cloze_text` as a deterministic shared task-shell family with typed inline blanks, accepted-value matching, bounded `requiredTextGroups`, per-blank `rejectText`, exact `{ blanks }` response matching including raw-map and extra-key rejection, shared UI helper, wrapper collection for exit-ticket/skilltree/graph surfaces, focused tests, rendered report fixture, proof JSON, and checker. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. Route-specific rendered proof required before product-route adoption; `requiredTextGroups` is bounded phrase matching, not broad semantic evaluation. |
| TASK-FAMILY-MULTI-1 | Multi-Select Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint after planning review and lead-review cycle. Added `multi_select` as a deterministic shared task-shell family with exact-set order-insensitive matching, strict string-only `{ values }` response shape, duplicate/unknown/extra-key rejection, required distractor option, practice-only partial feedback for missing required options and selected distractors, distinct `.ts-multi-option` / `data-multi-option-id` UI, wrapper collection for exit-ticket/skilltree/graph surfaces, focused tests, rendered report fixture, proof JSON, and checker. Round 1 returned REVISE for numeric/object response-id coercion; corrections resolved this and round 2 passed with flags. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. Route-specific rendered proof required before product-route adoption; multi-select is complete-set selection only, not a replacement for richer target operations. |
| TASK-FAMILY-ORDER-1 | Step-Ordering Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint after planning review and lead-review cycle. Added `step_ordering` as a deterministic shared task-shell family with answer/distractor step-bank schema, at least two answer steps and one distractor, no neutral/no-distractor loopholes, full `expected.order` answer-step coverage, exact `{ order }` response matching with raw-array, array-with-`order`, non-string, duplicate, unknown, missing, and extra-key rejection, practice-only order feedback, distinct `.ts-step-*` UI, wrapper collection for exit-ticket/skilltree/graph surfaces, focused tests, rendered report fixture, proof JSON, and checker. Round 1 returned REVISE for array-with-`order` response-shape acceptance; corrections resolved this and round 2 passed with flags. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. Route-specific rendered proof required before product-route adoption; `step_ordering` proves procedure control only and cannot replace final calculation, graph/table, source-chain, or constructed-response proof. |
| TASK-FAMILY-SOURCE-1 | Source Value And Chain Builder Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint after planning review and lead-review cycle. Added `source_value_selection` and `source_chain_builder` as deterministic shared task-shell families with multi-value source selection, role assignment, ordered source -> value -> operation -> answer -> conclusion construction, required distractors, required source-chain node roles, exact strict response-shape matching for `{ selections }` and `{ chain }`, array-with-key rejection, practice-only source feedback, distinct `.ts-source-*` UI, wrapper collection for exit-ticket/skilltree/graph surfaces, focused tests, rendered report fixture, proof JSON, and checker. Round 1 returned REVISE for result-report schema; corrections resolved this and round 2 passed with flags. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. Route-specific rendered proof required before product-route adoption; source-chain construction is source/control proof only unless paired with required operation tasks and reviewed later. |
| TASK-FAMILY-LABEL-1 | Label-Placement Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint after planning review and lead-review cycle. Added `label_placement` as a deterministic shared task-shell family with label bank, visual target region, target buttons, placement summary, exact `{ placements: [{ labelId, targetId }] }` matching, strict label/target description and `distractorFor` validation, target-role/coordinate validation, symmetric negative coverage, practice-only label feedback, distinct `.ts-label-*` UI, wrapper collection for exit-ticket/skilltree/graph surfaces, focused tests, rendered report fixture, proof JSON, and checker. Round 1 returned REVISE for missing symmetric negative coverage; corrections resolved this and round 2 passed with flags. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. Route-specific rendered proof required before product-route adoption; `label_placement` is representation-placement support only and not complete graph/table target-equivalent proof. |
| TASK-FAMILY-MATCH-1 | Matching-Pairs Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint after planning review and lead-review cycle. Added `matching_pairs` as a deterministic shared task-shell family with left/right item banks, accessible descriptions, one-to-one-only answer coverage, strict `{ pairs: [[leftId, rightId]] }` response matching, raw-array/array-with-key/object-pair/wrong-length/non-string/unknown/duplicate/omitted/distractor/extra-key rejection, practice-only feedback, matching-specific UI controls, wrapper collection for exit-ticket/skilltree/graph surfaces, focused tests, rendered report fixture, proof JSON, checker, and historical archive read-only evidence. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. Route-specific rendered proof required before product-route adoption; Many-to-one matching unsupported; conditional capability note only; `matching_pairs` cannot replace richer target-operation proof. |
| TASK-FAMILY-TWO-TIER-1 | Two-Tier Choice Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint after planning review and lead-review cycle. Added `two_tier_choice` as a deterministic shared task-shell family with separate answer/reason option banks, accessible descriptions, minimum two options per tier, duplicate-id rejection within and across tiers, exact `{ answer, reason }` response matching, answer-only/reason-only/wrong-combination/raw-string/raw-array/nested/non-string/unknown/cross-tier/extra-key rejection, neutral practice-only feedback, two-tier UI controls, wrapper collection for exit-ticket/skilltree/graph surfaces, focused tests, rendered report fixture, proof JSON, checker, and historical archive read-only evidence. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. Route-specific rendered proof required before product-route adoption; feedback must not become diagnostic or misconception-profile output; `two_tier_choice` cannot replace constructed-response or target-equivalent proof. |
| TASK-FAMILY-ASSERTION-1 | Assertion-Reason Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint after planning review and lead-review cycle. Added `assertion_reason` as a deterministic shared task-shell family for sparse reviewed assertion/reason relation judgement, with required assertion/reason text, labelled relation option bank, minimum four described relation options, duplicate-id rejection, exact `{ value }` response matching, missing/empty/wrong/raw-string/raw-array/array-with-value/nested/non-string/unknown/alternate-key/extra-key rejection, neutral practice-only feedback, assertion-specific UI controls, wrapper collection for exit-ticket/skilltree/graph surfaces, focused tests, rendered report fixture, proof JSON, checker, and historical archive read-only evidence. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. Route-specific rendered proof required before product-route adoption; feedback must not become diagnostic or misconception-profile output; `assertion_reason` cannot become generic quiz variety, default reasoning-game format, constructed-response replacement, or target-equivalent proof. |
| GATE-TASK-FAMILY-1 | Structured Choice And Construction Task-Family Review | yes | Closed PASS WITH FLAGS at reviewed remote commit `e35b7c58eded4d4d4544fbd39f8c5365a58785c9`. Accepted structured choice and constrained construction task families only as planning input for later bounded adoption-preparation. No generated lesson output, source-data mutation, engine implementation from this gate, product-route adoption, target-equivalent completion language, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV, Scale Gate 1, or product use was authorized. Flags: compact repair controls need route-adoption accessibility proof; product-route adoption still needs route-specific rendered proof; target-equivalence remains separate; human-precheck corrections for Tasks 3, 10, 11, and 12 must remain guarded. |
| ROADMAP-FLAG-CLEANUP-1 | Roadmap Flag Semantics Cleanup | yes | Closed bounded roadmap cleanup. Active roadmaps now distinguish hard blockers from non-blocking carried flags: route-specific rendered proof blocks product-route adoption, target-equivalence boundaries block target-equivalent claims, many-to-one matching is a conditional unsupported capability, and historical archive no-change evidence is a read-only invariant. Many-to-one matching unsupported; conditional capability note only. Historical archive remains read-only. No generated output, implementation, source-data mutation, product-route adoption, target-equivalent claim, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product use is authorized. |
...
| REASON-STD-1 | Reasoning Game Unified Exercise Migration | yes | Closed PASS WITH FLAGS as a bounded platform-runtime standard-family migration sprint. Added engine-emitted shared task-shell tasks for reasoning modes 0, 1, 3, and 5; generated fixture/proof JSON from actual `ReasoningEngine` `taskShellTask` objects; strengthened checker/Jest proof so wrong standard-task orders are rejected; kept mode 2 `error_detection` deferred and mode 4 `classification_with_explanation` refactor-scoped. Decision: keep the reasoning engine as a content provider and wrap/refactor around shared families; rebuild only modes that cannot consume shared route/task shell cleanly. No generated lesson output, source-data mutation, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product use was authorized. |
...
| REASON-PLAY-1 | Reasoning Playability And Usability-Agent Test | yes | Closed 2026-06-02 as PASS WITH FLAGS after separate usability-agent evidence, deterministic rendered screenshot proof, and lead-review round 1/round 2. Two counted usability agents returned PASS WITH FLAGS from generated proof/screenshot review; deterministic rendered capture proves modes 0, 1, 3, and 5 are playable with screenshots. No blocking repair was required. Carried flags: dual feedback density, mobile route-panel placement, dark-theme consistency, compact controls, mode 3 bridge-only status, modes 2/4 held, and usability agents reviewed proof/screenshots rather than fresh live-clicking. This is practice-route playability proof only, not target-equivalent reasoning readiness or product authority. |
| REASON-ANSWERFORM-2 | Reasoning Answer-Form And Source-Use Scaffolds | yes | Closed PASS WITH FLAGS after generated-route implementation, rendered screenshot proof, and actual lead-review round 1/round 2. Added local practice answer-form scaffold cues for A97/A98/A99/A81 patterns, kept A81 modifier-only with an underlying answer form, kept A97/A98/A99 distinct, preserved mode 2 as local error repair, and kept mode 4 held for classification-with-explanation redesign. Generated Book 1 reasoning output changed through platform deploy only. Carried flags: late planning review accepted as protocol variance, A99 lacks a live 1.1.1/1.1.2 evidence case, A81 remains future source-use modifier only, mode 2/mode 4 need reviewed adoption, mode 3 remains ordered-chain bridge, mobile route panel can sit below first viewport, and no target-equivalent/product authority is authorized. |
| GATE-REASON-STD-1 | Reasoning Unified Task-Shell Human Evidence Review | yes | Human comments received at reviewed remote commit `60a4fa0c6b3afe07643188499cb77c594a76011d`. Outcome is split: local shared-shell reasoning-practice evidence accepted with flags, but adoption/replacement readiness is `REVISE`. Required repair track opened because the water-scarcity task lacked visible wrong-answer context, mode 3 wording over-suggested visual flow construction, stale evidence text remained, and current tasks cannot replace the reasoning game. No generated output, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product use was authorized. |
...
| TASK-CONTEXT-SPEC-1 | Shared Task Context Contract | yes | Closed 2026-06-03. Added context-contract-only authoring/interchange schema, fixture, and checker in `reports/json/task-context-spec1-contract.json` and `build-scripts/sprints/check-task-context-spec1.js`. Proves `contextBlocks`, task `contextRefs`, markdown/source excerpt/table/SVG/graph/flowchart/formula/info block coverage, source-authority provenance, accessibility/caption requirements, and rejection of missing refs, unreferenced blocks, answer-hint leakage, raw copied images, inconsistent captions, internal-code exposure, and source mismatch. No runtime rendering, source reconstruction, task transformation, generated lesson output, product adoption, PV, Scale Gate, or student use authorized. Next: `TASK-CONTEXT-RUNTIME-1`. |
| TASK-CONTEXT-RUNTIME-1 | Shared Task Context Runtime | yes | Closed 2026-06-04. Added shared task-shell validation and rendering for `contextBlocks` above task lists, stable `ctx-*` IDs, task `contextRefs`, captions/source labels, alt/accessibility text, unsafe-SVG/raw-image/answer-leak/internal-code rejection, and an exit-ticket hint guard. Proof includes review-only playable lab `reports/sprints/TASK-CONTEXT-RUNTIME-1-rendered-lab.html`, desktop/mobile/dark screenshots, `reports/json/task-context-runtime1-proof.json`, and `build-scripts/sprints/check-task-context-runtime1.js`. Proves context placement/runtime behavior only; no exam/textbook ingestion, source reconstruction, generated lesson output, product-route adoption, target-equivalent proof, PV, Scale Gate, or student/product use authorized. Next: `CONTEXT-VISUAL-STD-1`. |
| CONTEXT-VISUAL-STD-1 | Source Context Visual Standard | yes | Closed 2026-06-04 as a standard/checker sprint. Added `reports/sprints/CONTEXT-VISUAL-STD-1-visual-standard.md`, `reports/json/context-visual-std1-contract.json`, and `build-scripts/sprints/check-context-visual-std1.js`. Defines source context visual rules for semantic tables, reconstructed SVG graphs/figures/flowcharts, formula boxes, source cards, captions, labels, color tokens, typography, spacing, mobile behavior, dark mode, axis/legend conventions, SVG sizing, alt text, source-label rules, source-output parity proof, and reviewer evidence. Covers all eight `TASK-CONTEXT-SPEC-1` block types and absorbs the visual-source scope previously implied by `DUAL-CODING-STD-1`. No source reconstruction, exam/textbook ingestion, generated lesson output, runtime CSS/UI implementation, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, PV, diagnostics, mastery/sequencing, Scale Gate, or student/product use authorized. Next: `SOURCE-RECONSTRUCT-2-ACTUAL-EXAM`. |
| SOURCE-RECONSTRUCT-2-ACTUAL-EXAM | Actual Exam Source Reconstruction | yes | Closed 2026-06-04 after planning review, verification, and lead-review round 1/round 2 PASS. Added governed reconstruction for `vw-1022-a-25-1-o:opgave-1:question-3`: normalized source markdown, source map, visual-fidelity notes, reviewer comparison, semantic table/context blocks, reconstruction JSON, rendered review lab, desktop/mobile/dark screenshots, proof JSON, capture harness, and checker tied to the official prompt/correction PDFs. Proves source reconstruction only; no task transformation, generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate, or student/product use authorized. Next: `TASK-INGEST-TRANSFORM-2-ACTUAL-EXAM`. |
| TASK-INGEST-TRANSFORM-2-ACTUAL-EXAM | Actual Exam Source Exercise Transformation | yes | Closed 2026-06-04 after planning review, verification, and lead-review round 1/round 2 PASS. Added review-ready task transformation for `vw-1022-a-25-1-o:opgave-1:question-3`: exact reconstructed context blocks, six shared task-family cards, operation-chain trace, answer-form trace, task-family map, reviewer notes, rendered review lab, desktop/mobile/dark screenshots, proof JSON, capture harness, and checker tied to the official source reconstruction. Preserves source selection, formula conversion, step ordering, visible calculation work, source-chain construction, and threshold-direction formulation while rejecting source-only, choice-only, and final-answer-only reductions. Proves task transformation only; no textbook transformation, human gate closure, generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate, or student/product use authorized. Next: `TASK-INGEST-TRANSFORM-3-TEXTBOOK`. |
| TASK-INGEST-TRANSFORM-3-TEXTBOOK | Textbook Source Exercise Transformation | yes | Closed 2026-06-04 after planning review, verification, and lead-review round 1/round 2 PASS. Added review-ready owned textbook-source transformation for `1.1.3 Grafieken en tabellen`: governed source map, six context blocks, nine shared task-family cards, visual variant map, operation-chain trace, answer-form trace, task-family map, reviewer notes, rendered review lab, desktop/mobile/dark screenshots, proof JSON, capture harness, and checker. Preserves table reading, P-Q axis convention, graph procedure, point placement, interpolation source values, graph reading, visible percent-change calculation work, source-chain reasoning, and claim-answer form. Records the paragraph-taught and also source-valid 50 percent intervals without claiming official exam/external-primary authority. Proves textbook-source task transformation only; no human gate closure, generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate, or student/product use authorized. Next: `GATE-SHARED-TASK-INGEST-REPAIR-1`. |
| CI-REMOTE-1 | GitHub Actions Remote Platform CI | yes | Closed 2026-06-04 as PASS WITH FLAGS, then updated by `CI-REMOTE-1A`. Added GitHub Actions workflow `platform-ci` with job `validate-platform`, sibling checkout for `4veco-platform` and `4veco-lessen`, `npm ci`, platform validators, report/roadmap/URL-index checks, diff hygiene, bounded diagnostic artifact upload, and branch protection requiring context `validate-platform`. Current-head remote run `26954512486` passed on hardened workflow commit `9f6e5cbf645143bcf06de3bd2800e7cb226b6877`; artifact `platform-ci-diagnostics` id `7412612729` uploaded. Carried flag: monitor GitHub `windows-latest` runner-label migration notice if CI later fails without code changes. No generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use authorized. Next: `CI-REMOTE-1A`. |
| CI-REMOTE-1A | Current-Head CI Proof And Admin Enforcement | yes | Closed 2026-06-04 after reviewer follow-up. Recorded current-head `platform-ci / validate-platform` proof for run `26954512486` on commit `9f6e5cbf645143bcf06de3bd2800e7cb226b6877`, job `79528031593`, conclusion success, with diagnostic artifact `platform-ci-diagnostics` id `7412612729`. Enabled branch protection admin enforcement so required context `validate-platform` applies to admins/owners as well as normal contributors; strict checks remain true, force pushes disabled, and branch deletion disabled. Future human gate packets must cite passing CI for the reviewed commit or explicitly record a waiver. No generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use authorized. Next: `GATE-SHARED-TASK-INGEST-REPAIR-1`. |
| CI-LF-HARDEN-1 | Line Ending And Generated Report Stability | yes | Closed 2026-06-06 as PASS WITH FLAGS. Added scoped LF policy for CI/build evidence surfaces, deterministic CRLF checker, Jest coverage, and `platform-ci` checker step. Rejected broad historical `reports/**/*.md/json` normalization after initial scan found 265 CRLF matches; carried flag: historical report-archive CRLF cleanup is separate follow-up only. Local checks pass, and PR run `27065594154` / job `79885793668` passed `platform-ci / validate-platform` on branch head `4ddd5e0fc4527607938146c8838ca4ded77733b8`; artifact `platform-ci-diagnostics` id `7455396312` uploaded. No generated lesson output, protected reference mutation, source-data mutation, target registries, candidate storage, PV outputs, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, Scale Gate 1, or student/product use authorized. Next: `CI-EVIDENCE-1`. |
| CI-EVIDENCE-1 | Cross-Repo Checkout Evidence Artifact | yes | Closed 2026-06-06 as PASS. Added `build-scripts/ci/platform-ci-evidence.js`, tests, workflow write/check step, and diagnostic artifact upload path `ci-artifacts/platform-ci-evidence.json`. PR run `27065594154` uploaded artifact `platform-ci-diagnostics` id `7455396312`, containing `platform-ci-evidence.json` with CI checkout SHA `187a9922bd78a12ed4f71eb0b35bad24929b6405` and lessen SHA `15f823028522663ca62c8d6369af9c6ae0264efb`. No generated lesson output, protected reference mutation, source-data mutation, target registries, candidate storage, PV outputs, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use authorized. Next: `CI-GATE-PROOF-1`. |
| CI-GATE-PROOF-1 | Human-Gate CI Proof Validator | yes | Closed 2026-06-06 as PASS. Added `build-scripts/sprints/check-gate-ci-proof.js`, npm script `check:gate-ci-proof`, positive markdown/JSON fixtures, and negative fixtures for missing run ID, missing commit, non-success conclusion, vague waiver, run without reviewed commit, and local-only command-log proof. Optional `--remote` uses `gh api` without adding secrets. Historical gate packets were not rewritten. PR run `27065594154` / job `79885793668` passed on branch head `4ddd5e0fc4527607938146c8838ca4ded77733b8`. This hardens gate evidence only and authorizes no product readiness, lesson readiness, generated lesson output, protected reference mutation, source-data mutation, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use. Next: `CI-GOVERNANCE-1` if the owner wants the branch-protection drift checker next. |
| CI-GOVERNANCE-1 | Branch Protection Drift Checker | yes | Closed 2026-06-06 as PASS. Added read-only local/manual checker `build-scripts/ci/check-branch-protection.js`, npm wrapper `check:branch-protection`, and mocked-response tests for admin enforcement false, strict false, missing `validate-platform`, force pushes allowed, and deletion allowed. Live checker passes for `meijer1973/4veco-platform` `main`: strict true, required context `validate-platform`, admin enforcement true, force pushes disabled, branch deletion disabled. PR run `27066406846` / job `79887950170` passed `platform-ci / validate-platform` on branch head `aa4e22c0e8e4f61d43e92792bb83e2762b44600b`; artifact `platform-ci-diagnostics` id `7455638356` uploaded. No high-privilege secrets, default CI branch-protection permission, generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use authorized. Next: `AGENT-BRANCH-SAFETY-1` at owner request; `CI-PR-PROOF-1` remains a later optional protected-branch PR-path confidence sprint. |
| AGENT-BRANCH-SAFETY-1 | Explicit Branch-Per-Agent Safety Protocol | yes | Closed 2026-06-07 as PASS. Added explicit branch-per-agent policy to platform and lesson AGENTS files, created read-only local `build-scripts/ci/check-agent-branch-safety.js` with Jest coverage for `main`, detached HEAD, prefix enforcement, divergence, dirty `--require-clean`, and missing Git repository cases, added npm wrapper `check:agent-branch-safety`, and extended the branch-protection checker to report pull-request-review settings without making PR-only protection a hard failure. Live branch-protection observation confirms strict required checks, `validate-platform`, admin enforcement, no force pushes, no deletion, and required PR reviews with one approving review; bypass allowance/no-direct-push details remain not fully verified and deferred. Coordinated branches and PR proof are recorded in closure reporting. No generated lesson output, protected reference mutation, source-data mutation, target-exercise registry mutation, candidate storage, PV output, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, Scale Gate 1, or student/product use authorized. |
| AGENT-WORKTREE-SAFETY-1 | One-Agent-One-Worktree Isolation | yes | Closed 2026-06-07 as PASS WITH FLAGS. Added platform and lesson AGENTS worktree-safety policy, `build-scripts/ci/check-agent-worktree-safety.js`, focused Jest coverage for lock ownership, stale lock, missing lock, wrong task, main, detached HEAD, divergence, invalid prefix, dirty `--require-clean`, warning-only states, anchor guardrails, and Git-dir lock paths, plus npm wrapper `check:agent-worktree-safety`. The sprint used coordinated task worktrees and per-worktree Git-metadata locks. Carried flags: future worktree-creation helper is deferred, default PR CI is not changed, and remote CI proof is reported at closure rather than embedded as a self-referential result hash. No generated lesson output, protected reference mutation, source-data mutation, target-exercise registry mutation, candidate storage, PV output, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, Scale Gate 1, or student/product use authorized. |
| GATE-SHARED-TASK-INGEST-REPAIR-1 | Shared Task Context And Ingestion Repair Human Review | yes | Closed 2026-06-05 as PASS WITH FLAGS at reviewed remote evidence commit `95f0eda5f51eb7868cb947dc3e8f081957b2afb4` after final direct human review accepted Repair 4 and the reviewer correction pass. The closure authorizes controlled downstream adoption-preparation only. It accepted the actual-exam conceptual setup/calculation/conclusion sequence, `649` plus yearly unit variants, accepted `22x12 = 264, 264 + 385 = 649` shortcut work, targeted feedback/progressive support, carried-value conclusion, primary textbook `graph_construction_substitute`, visible grid, table-derived ticks, delayed labels/scale, same-workspace line drawing, simplified 50 percent follow-up with conclusion acceptance/shared `interval_halving_check` focus-plan proof, duplicate-label removal, visual QA/checker hardening, lead-review, verification, and refreshed playable screenshots/proof. Carried flags: later shared-task hardening series, graph substitute is not final graph-engine quality, carried-value chaining, progressive calculation feedback, source/support/prompt separation, delayed reveal policy, and secondary 50 percent follow-up. No generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, broad product use, or student/product use authorized. Next: proceed to `CHECK-SHORT-EXIT-2` planning unless the roadmap owner explicitly reorders. |
| SHARED-TASK-INGEST-PLAYABLE-REPAIR-1 | Shared Task Ingest Playable Lab Repair | yes | Closed 2026-06-04 as PASS WITH FLAGS / review-lab repair only. Replaced generic review-shell controls with real task-family affordances, separated prompt/source/support with support collapsed by default, repaired concrete prompts and source-chain labels, added semantic checking, wrong/retry/corrected/completed/mobile/dark proof, stricter task-affordance and support-policy checkers, verification review, lead-review round 1/round 2, refreshed gate packet evidence, and passing gate packet checker. Carried flag: future checker hardening should assert exact visible source-chain labels and rendered prompt/source parity. No gate closure, generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use authorized. |
| SHARED-TASK-INGEST-PLAYABLE-REPAIR-2 | Target-Task Simplification And Visual QA Repair | yes | Closed 2026-06-05 as PASS WITH FLAGS / review-lab target-economy repair only after renewed human review carried interaction-quality blockers into `SHARED-TASK-INGEST-PLAYABLE-REPAIR-3`. Reduced the actual-exam lab to source values, calculation, and conclusion; reduced the textbook lab to primary `graph_construction_substitute` plus two follow-ups; moved prompts out of source panes; hid completed graph output before graph-construction success; added graph-workspace visual QA proof; added target-task economy reports/checkers; refreshed the human-review packet; and kept `GATE-SHARED-TASK-INGEST-REPAIR-1` open. Carried blockers: actual exam question visibility, compact source-value selection, carry-forward conclusion, click-to-place graph construction, delayed graph labels/scales, and source-pane readability proof. No generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use authorized. |
| SHARED-TASK-INGEST-PLAYABLE-REPAIR-3 | Interaction Quality And Source Pane Repair | yes | Closed 2026-06-05 as narrowed review-lab repair only after fourth direct human `REVISE` kept `GATE-SHARED-TASK-INGEST-REPAIR-1` at `hold_for_playable_repair`. Added visible original actual-exam question in the right task pane, compact source-cell selection, task-3 carry-forward with constrained direction, click-to-place textbook graph construction, delayed graph labels/scales, source-pane readability proof, screenshots, checkers, lead-review artifacts, refreshed packet evidence, and remote publication on `codex/shared-task-ingest-repair3`. Carried blockers: line still appears as a separate completed graph, grid visibility needs tuning, 50 percent follow-up affordance is unclear, exam task 1 is not useful enough, task-2 unit validation and targeted feedback are weak, support after repeated failed attempts is missing, duplicate visible Bron/Tabel labels remain, and visual QA must hard-fail those issues. No generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use authorized. |
...
| Sprint | Name | Completed | Current State |
|--------|------|-----------|---------------|
| BLUEPRINT-BOOK1-EDITION-BOUNDARY-1 | Book 1 Edition Boundary and Part A Compatibility Repair | yes | Local implementation/evidence complete on PR #222 at substantive head `bb21d53e...`: the owned preview policy inherits the Book 2+ Part A target-operation, seven-section, paper-route, and 55-minute contract and cannot manufacture `Covered` status, mastery, or an untargeted independent operation. Focused tests pass 32/32, the full suite passes 107 suites/1,653 tests, teacher review passes 14/14, and canonical lead round 2 passes after closing the preserved evidence-ordering revision. Exact-head hosted CI, readiness, owner authorization, governed integration, and post-merge CI remain required. Book 1 and all lesson output stay unchanged; Issue #223 remains planning-only until this prerequisite is integrated. |
| PART-A-TEXTBOOK-EXERCISE-STRUCTURE-1 | Book 2+ Part A Paper-Only Exercise Authoring Contract | yes | Exact-head review findings are closed. The contract aligns all five fading surfaces, retains target-supplied representations, rejects target-absent production and unconditional visual removal, covers nine Dutch printed device/digital phrases while allowing internal discussion, and uses a continuously numbered paragraph checklist. Contract/lane tests pass 64/64 and local platform tests pass 106 suites/1,621 tests. A new substantive teacher review passes 12/12 at `22898285...`; new substantive lead round 4 passes at evidence head `ab76cb70...` with no source change required. Final publication remains governed by live exact-head CI and readiness evidence on PR #219. The lesson checkout remains clean at `f09fd6e...`; no `4veco-lessen`, Book 1, Book 2 paragraph output, Part B redesign, protected reference mutation, schema-role migration, merge, or production authority. |
...
| TASK-FAMILY-CONSTRUCT-1 | Constrained Construction Task-Family Contract | yes | Closed no-implementation contract sprint. Produced `reports/sprints/TASK-FAMILY-CONSTRUCT-1-contract.md`, `reports/json/task-family-construction-contract.json`, and checker `build-scripts/sprints/check-task-family-construct1-contract.js`. It defines `cloze_tile_select`, `sentence_builder`, `formula_builder`, `source_value_selection`, `source_chain_builder`, and `label_placement` as operation-chain construction families with bank rules, distractor policy, ordering/placement semantics, accessibility expectations, and proof-use boundaries. No implementation or generated output. |
| TASK-FAMILY-CLOZE-TILE-1 | Cloze Tile-Select Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, and lead-review records. No generated lesson output or product-route adoption. Route-specific rendered proof required before product-route adoption. |
| TASK-FAMILY-SENTENCE-1 | Sentence Builder Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, and lead-review records. No generated lesson output or product-route adoption. Route-specific rendered proof required before product-route adoption. |
| TASK-FAMILY-FORMULA-1 | Formula Builder Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support, formula category validation, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, and lead-review records. Round 1 returned REVISE for extra response keys being accepted; corrections resolved this and round 2 passed with flags. No generated lesson output or product-route adoption. Route-specific rendered proof required before product-route adoption; formula equivalence beyond exact sequences and calculation execution remain separate follow-up work. |
| TASK-FAMILY-CLOZE-1 | Cloze Text Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support, accepted-value and bounded text-group validation, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, and lead-review records. No generated lesson output or product-route adoption. Flags: product-route screenshots are deferred to adoption; `requiredTextGroups` is bounded phrase matching only. |
| TASK-FAMILY-MULTI-1 | Multi-Select Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support, strict exact-set matching, practice-only partial feedback, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, and lead-review records. Round 1 returned REVISE for numeric/object response-id coercion; corrections resolved this and round 2 passed with flags. No generated lesson output or product-route adoption. Route-specific rendered proof required before product-route adoption; multi-select cannot replace richer target-operation proof. |
| TASK-FAMILY-ORDER-1 | Step-Ordering Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support, strict order-sensitive matching, practice-only order feedback, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, and lead-review records. Round 1 returned REVISE for array-with-`order` response-shape acceptance; corrections resolved this and round 2 passed with flags. No generated lesson output or product-route adoption. Route-specific rendered proof required before product-route adoption; `step_ordering` is procedure-control proof only. |
| TASK-FAMILY-SOURCE-1 | Source Value And Chain Builder Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support for `source_value_selection` and `source_chain_builder`, strict validation/matching, practice-only feedback, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, and lead-review records. Round 1 returned REVISE for result-report schema; corrections resolved this and round 2 passed with flags. No generated lesson output or product-route adoption. Route-specific rendered proof required before product-route adoption; source-chain construction is not target-equivalent proof without paired operation tasks and later review. |
| TASK-FAMILY-LABEL-1 | Label-Placement Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support for `label_placement`, strict validation/matching, practice-only feedback, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, and lead-review records. Round 1 returned REVISE for missing symmetric negative coverage; corrections resolved this and round 2 passed with flags. No generated lesson output or product-route adoption. Route-specific rendered proof required before product-route adoption; label placement is representation-placement support only. |
| TASK-FAMILY-MATCH-1 | Matching-Pairs Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support for `matching_pairs`, one-to-one-only validation, strict exact response matching, practice-only feedback, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, historical archive read-only evidence, and lead-review records. Round 1 and round 2 passed with flags. No generated lesson output or product-route adoption. Route-specific rendered proof required before product-route adoption; Many-to-one matching unsupported; conditional capability note only; matching pairs cannot replace richer target-operation proof. |
| TASK-FAMILY-TWO-TIER-1 | Two-Tier Choice Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support for `two_tier_choice`, strict answer-plus-reason validation, practice-only feedback, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, historical archive read-only evidence, and lead-review records. Round 1 and round 2 passed with flags. No generated lesson output or product-route adoption. Route-specific rendered proof required before product-route adoption; feedback must not become diagnostic or misconception-profile output; two-tier choice cannot replace richer target-operation proof. |
| TASK-FAMILY-ASSERTION-1 | Assertion-Reason Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support for `assertion_reason`, strict relation-option validation, exact `{ value }` response matching, practice-only feedback, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, historical archive read-only evidence, and lead-review records. Round 1 and round 2 passed with flags. No generated lesson output or product-route adoption. Route-specific rendered proof required before product-route adoption; feedback must not become diagnostic or misconception-profile output; assertion-reason cannot replace constructed response, target-equivalent proof, or richer reasoning tasks. |
| GATE-TASK-FAMILY-1 | Structured Choice And Construction Task-Family Review | yes | Closed PASS WITH FLAGS at reviewed remote commit `e35b7c58eded4d4d4544fbd39f8c5365a58785c9`. Direct human packet comments accepted the playable lab, schema/validation, feedback boundary, keyboard/focus evidence, and target-proof boundary as planning input only. Authorized next work is named downstream planning/adoption-preparation only; no product-route adoption, generated output, source-data mutation, target-equivalent claim, diagnostics, adaptive routing, mastery/sequencing, PV, Scale Gate 1, or student/product use. |
| ROADMAP-FLAG-CLEANUP-1 | Roadmap Flag Semantics Cleanup | yes | Closed bounded roadmap cleanup. Produced `reports/sprints/ROADMAP-FLAG-CLEANUP-1-plan.md`, `reports/sprints/ROADMAP-FLAG-CLEANUP-1-flag-disposition.md`, `reports/sprints/ROADMAP-FLAG-CLEANUP-1-result.md`, `reports/json/roadmap-flag-cleanup1.json`, and checker `build-scripts/sprints/check-roadmap-flag-cleanup1.js`. Active roadmap flags are now typed as adoption blockers, target-proof boundaries, conditional capability notes, read-only invariants, or regression guards. No generated output or product authority. |
...
| L1.7B-Q2 | Exit Ticket Target-Equivalent Implementation | yes | Closed PASS WITH FLAGS as the first target-equivalent exit-ticket implementation candidate. Implemented `1.1.2 Percentages en indexcijfers` because it has no existing advisory short-check source, the target chain is compact, and the shared task shell supports calculation/work, final-answer, notation, and short-response families. Added source-controlled `source-data/book-1/exit-ticket/1.1.2.json` as the historical pre-split source path; current operational evidence now uses the split-surface manifest governed by `EXERCISE-EVIDENCE-CURRENTNESS-HARDENING-1`. Generated Book 1 output through the platform deploy route only, updated target-equivalent landing/page copy to `Exit ticket`, kept `1.1.1` advisory-only, and added deterministic proof handling for reviewed calculation work plus D31 text criteria. Lead review round 1 returned REVISE for bogus-work and contradictory-D31 matcher weaknesses; corrections added required work text, reject text, adversarial tests, and refreshed evidence; round 2 closed PASS WITH FLAGS. Carried flag: deterministic text-group matching is not symbolic math parsing or semantic language understanding, so `GATE-L1.7B-Q2` must explicitly review criterion sufficiency before local completion language. No protected reference mutation, target-exercise field writes, candidate storage, paragraph-completion language, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV, Scale Gate 1, or product use was authorized. |
| MATH-UX-2 | Math Game + Checkpoint UI Integration | yes | Completed as a live math/calculation task-shell integration sprint. The generated Book 1 `1.1.2` math route now loads and renders the GAME-UX-3A shared task shell in the skilltree exercise flow. `A38` and `A39` cover numeric input, calculation/work capture, final-answer entry, percentage/index notation, and unit/notation field behavior through validated task-shell families, with labelled retry/self-check feedback and desktop/mobile light/dark screenshot proof. Checkpoint-style calculation tasks are proven as a non-published fixture through `ExitTicketEngine`/`ExitTicketUI` with `targetReadinessEvidence: false`; no `1.1.2` exit-ticket source or page was created. Generated Book 1 output was refreshed through platform build/deploy commands only. REASON-UX-2, GAME-ARCH-1, GAME-ARCH-2, and GATE-ENGINE-1 have since closed. No protected reference mutation, target-exercise field writes, candidate storage, unit minting, target-equivalent completion claims, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV, Scale Gate 1, or student/product use was authorized. Top operational next action is planning/preparation for the GATE-ENGINE-1 authorized refine lanes. |
| LESSON-SCALE-1 | Lesson Companion Pre-Scale Gates Tracking | no | **TRACKING DEPENDENCY, NOT A REFERENCE EXECUTION SPRINT.** Lesson L1.7A closed PASS WITH FLAGS and rejected broad companion scaling. Closed lesson prerequisites now include `L1.7B-C`, `L1.7B-R`, `GATE-L1.7B`, `L1.7C-0`, `L1.7C`, `L1.7D`, `L2.0`, `L1.7C-MATH`, `L1.7B-MAP`, `L1.7B-P23`, `L1.7B-Q2`, `SPEC-ET-1`, `EX-LESSON-1`, and platform `ENGINE-OP-1`, `SKILLMAP-OP-1`, `GRAPH-UX-2`, `MATH-UX-2`, `REASON-UX-2`, `GAME-ARCH-1`, `GAME-ARCH-2`, and `GATE-ENGINE-1`. Platform `GAME-UX-1` supplied shared skill-map runtime support; platform `GAME-UX-2` supplied source-controlled `1.1.1` checkpoint support; platform `GAME-UX-3A` supplied the shared task-shell runtime foundation; platform `ENGINE-OP-1` audited live student routes and found route panels empty/mis-scoped, task-shell use absent from generated output, and no target-equivalent checkpoints for `1.1.2`/`1.1.3`; platform `SKILLMAP-OP-1` made the route layer visible and scoped in live Book 1 output without target-equivalent, diagnostic, mastery, sequencing, summative, PV, or product-use authority; platform `GRAPH-UX-2` integrated the shared task shell into the live `1.1.3` graph/table route; platform `MATH-UX-2` integrated the shared task shell into the live `1.1.2` calculation/index route; platform `REASON-UX-2` integrated the shared task shell into the live reasoning route with a structured self-check mode and richer repair feedback; platform `GAME-ARCH-1` kept the shared route, shared task shell, graph direction, and advisory short check; platform `GAME-ARCH-2` produced the canonical architecture plan, route API, task-shell API, file-level keep/wrap/deprecate/rebuild inventory, state/feedback ownership rules, target-operation coverage model, and GATE-ENGINE-1 checklist; platform `GATE-ENGINE-1` closed PASS WITH FLAGS after live-output inspection, keeping route/shell/graph direction, requiring math/reasoning/checkpoint refactor planning, and authorizing only named planning or implementation-preparation sprints. `L1.7C-MATH` restored scoped skill-tree math as primary `Rekenen`; `L1.7B-MAP` fixed checkpoint metadata and kept `targetReadinessEvidence: false`; `L1.7B-P23` accepted the stop/handoff because choice-only checks cannot honestly cover `1.1.2` calculation/index or `1.1.3` graph/table operation chains; `L1.7B-Q2` implemented the first `1.1.2` target-equivalent exit-ticket candidate and kept completion language held for human review; `SPEC-ET-1` corrected the stable specs so exit tickets are target-equivalent proof tasks, not readiness-to-try checks; `EX-LESSON-1` made exam ingestion operational as a paragraph-plan, shared-task-shell, route, exit-ticket, and answer-model trace. SYNC-4 makes the shared task-type UI part of the product end-state and adds the operational engine proof track. MTU-H4C executed the bounded answer-form unit additions and kept generator-blocked/non-interactive exposure guardrails. Reference/product planning must not treat the lesson companion pipeline as scale-approved until lesson `GATE-L1.7B-Q2`, `REV-STD-1`, minimal curriculum-versioning readiness, and Scale Gate 1 resolve or are explicitly waived while preserving blocks on diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, and PV machine promotion. |
| REASON-UX-2 | Reasoning Game Variant And Feedback Upgrade | yes | Completed as live reasoning task-shell integration proof. The generated Book 1 reasoning routes now load the GAME-UX-3A shared task shell, expose six modes dynamically, add `Redeneerantwoord opbouwen` with `structured_reasoning` self-check, keep self-check completion out of scored/persistent `goed` progress, and improve feedback in existing modes with example reasoning chains, selected-chain comparison, and repair cues. Generated Book 1 output was refreshed through platform deploy/build commands only and backed by desktop/mobile light/dark screenshots, route-output checks, student-experience review, accessibility review, and a real lead-review cycle that caught and repaired a UI scoping regression. GAME-ARCH-1, GAME-ARCH-2, and GATE-ENGINE-1 have since closed. No target-equivalent proof, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV, Scale Gate 1, or student/product use was authorized. Top operational next action is planning/preparation for the GATE-ENGINE-1 authorized refine lanes. |
| GAME-ARCH-1 | Practice Engine Build-vs-Rebuild Decision | yes | Completed as a no-generated-output architecture decision sprint after lead-review round 2 PASS. Decision: keep and harden the shared skill-map route, keep the shared task shell as core architecture, keep/refactor the graph UI direction as the reference pattern, refactor math around target-exercise operation chains, refactor reasoning around answer-form and constructed-response standards, keep the short check as an advisory local checkpoint, and keep the target-equivalent exit ticket separate as a later proof task. Any duplicate engine-specific UI/state/feedback path that cannot consume the shared route and task shell cleanly should be rebuilt or removed through a later plan. GAME-ARCH-2 and GATE-ENGINE-1 have since closed. No generated lesson output, protected reference mutation, target-exercise field writes, candidate storage, source-data writes, target-equivalent completion claims, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV, Scale Gate 1, or student/product use was authorized. Top operational next action is planning/preparation for the GATE-ENGINE-1 authorized refine lanes. |
| GAME-ARCH-2 | Integrated Practice Engine Architecture Plan | yes | Completed as a no-implementation architecture-planning sprint after lead-review round 2 PASS WITH FLAGS. Produced the canonical architecture map, route-layer API, task-shell API, module-boundary plan, file-level keep/wrap/deprecate/rebuild inventory, state ownership rules, feedback ownership rules, target-operation coverage model for `1.1.1`/`1.1.2`/`1.1.3`, and `GATE-ENGINE-1` live-output checklist. Corrected lead-review blocker by adding `engines/skill-map-engine.js` as the shared route request/view-model owner. Preserved the short check as advisory and kept the target-equivalent exit ticket separate for `L1.7B-Q2`/`GATE-L1.7B-Q2`. No generated output, engine implementation, protected reference mutation, target-exercise field writes, source exit-ticket writes, candidate storage, target-equivalent claims, diagnostics, adaptive routing, mastery, sequencing, student-facing AI, summative use, PV, Scale Gate 1, or product use was authorized. |
| GATE-ENGINE-1 | Four-Engine Operational Integration Review | yes | Closed PASS WITH FLAGS after pre-gate lead review, human review, and fresh live-output inspection at remote commit `1ac319c84643f5ee3f05f8556e012a39235c745a`. Decision: keep and harden the shared route layer, keep the shared task shell as default interaction layer, keep/refactor graph as reference pattern, refactor math around the `1.1.2` target-operation chain, refactor reasoning around answer-form and constructed-response standards, keep/relabel the advisory short check if needed, and keep target-equivalent exit tickets separate and held for `L1.7B-Q2`/`GATE-L1.7B-Q2`. Authorized only named downstream planning or implementation-preparation sprints. No implementation, generated lesson output, target-equivalent completion language, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV, Scale Gate 1, or product use was authorized. |
| GRAPH-REFINE-1 | Graph Route Operation-Chain Hardening Plan | yes | Closed PASS WITH FLAGS as planning/preparation only after planning review and lead-review round 2. Kept GRAPH-UX-2 as useful local graph/table practice and the strongest current reference pattern, but found that target-equivalent graph reliance is blocked: the `1.1.3` target exercise requires price on the vertical axis and quantity on the horizontal axis, while current graph-route data contains contradictory price-as-horizontal/x wording. Produced operation-chain plan, task-coverage matrix, implementation-prep, gate handoff, evidence checker, and sprint result. `GRAPH-REFINE-2` is recommended only if explicitly authorized; it is not started or authorized by this sprint. No implementation, generated lesson output, target-equivalent claims, diagnostics, mastery/sequencing, Scale Gate 1, or product use was authorized. |
| MATH-REFINE-1 | Math Target-Operation-Chain Hardening Plan | yes | Closed PASS WITH FLAGS as planning/preparation only after planning review and lead-review round 2. Kept MATH-UX-2 as useful local A38/A39 math/calculation practice and confirmed the route should be refactored rather than rebuilt, but found that target-equivalent `1.1.2` reliance is blocked until D31 is explicitly routed and checked: the target exercise requires old/new percentage change, price-index calculation, index-to-index percentage change, and a short explanation that 108 to 112 is 4 index points, not 4 percent. Produced operation-chain plan, task-coverage matrix, implementation-prep, gate handoff, evidence checker, and sprint result. `MATH-REFINE-2` is recommended only if explicitly authorized; it is not started or authorized by this sprint. No implementation, generated lesson output, target-equivalent claims, diagnostics, mastery/sequencing, Scale Gate 1, or product use was authorized. |
| REASON-REFINE-1 | Reasoning Answer-Form Integration Plan | yes | Closed PASS WITH FLAGS as planning/preparation only after planning review and lead-review round 2. Kept the reasoning route and shared `structured_reasoning` task family as useful local practice, but found that target-equivalent reasoning reliance is blocked until answer-form-specific scaffolds are added and reviewed: generic self-check is not answer-form proof, `1.1.1` needs an explicit A98 versus held-evaluation decision, `1.1.2` D31 explanation must coordinate with math/D31 coverage, and `1.1.3` source/table reasoning needs A81 source-use scaffolding plus graph-axis repair. Produced answer-form integration plan, task-coverage matrix, implementation-prep, gate handoff, evidence checker, and sprint result. No implementation, reasoning CSV edits, generated lesson output, target-equivalent claims, diagnostics, mastery/sequencing, Scale Gate 1, or product use was authorized. |
| CHECK-Q2-PLAN | Target-Equivalent Exit-Ticket Implementation Plan | yes | Closed PASS WITH FLAGS as planning/preparation only after planning review and lead-review round 2 PASS. Produced the advisory short-check boundary, operation-chain coverage model, target-equivalent design plan, implementation-prep, gate handoff, evidence checker, and result metadata. Confirmed that the current `1.1.1` `Korte check` remains advisory only with `targetReadinessEvidence: false`, and no current `1.1.1`, `1.1.2`, or `1.1.3` output is target-equivalent proof. Future `L1.7B-Q2` work must select one paragraph and resolve or explicitly scope its blockers before implementation: `1.1.1` needs full A43 coverage plus an A98 versus held-evaluation decision; `1.1.2` needs explicit D31 index-point versus percentage-change coverage; `1.1.3` needs graph-axis repair and A81 source-use plus underlying answer-form coverage. No implementation, source exit-ticket writes, generated output, target-equivalent completion language, diagnostics, mastery/sequencing, Scale Gate 1, or product use was authorized. |
...
| Product Gate | Re-Evaluate R10-R13 Product Surfaces | no | Blocked. Diagnostics, adaptive routing, student-facing AI, teacher cockpit deployment, automatic sequencing, mastery, and summative uses remain out of scope until data-quality gates justify them. Lesson L1.7A explicitly rejected broad companion scaling; `L1.7B-R` and `GATE-L1.7B` accepted only the non-summative `1.1.1` checkpoint boundary; `L1.7C-MATH` restored the old skill-tree math route; `L1.7B-MAP` fixed checkpoint metadata alignment but kept `targetReadinessEvidence: false`; `L1.7B-P23` accepted a stop/handoff rather than generating weak choice-only checks for calculation and graph/table paragraphs; `L1.7B-Q2` implemented the first `1.1.2` target-equivalent exit-ticket candidate while keeping completion language behind human review; `SPEC-ET-1` corrected exit-ticket semantics to target-equivalent proof without authorizing product use; and `EX-LESSON-1` made official-exam route traces operational without generating lesson output. GATE-EX5 closed PASS WITH CONDITIONS as design-contract review only; EX-6 completed validator/CLI planning without candidate writes; GATE-EX6 closed PASS WITH CONDITIONS for validator/dry-run CLI implementation only; EX-7 implemented validators and dry-run-only CLIs without candidate storage or writes; MTU-H4C executed the bounded answer-form MTU additions through CLI only and preserved no-exposure/product boundaries; GAME-UX-3A added the shared task-shell runtime foundation without generated lesson output or exposure; ENGINE-OP-1 audited live output; SKILLMAP-OP-1 made the shared route visible and scoped in live Book 1 output without granting product-use authority; GRAPH-UX-2 integrated the shared task shell into the live `1.1.3` graph/table route with checkpoint-style graph UI proof but no target-equivalent checkpoint publication; MATH-UX-2 integrated the shared task shell into the live `1.1.2` calculation/index route with no target-equivalent checkpoint publication; REASON-UX-2 integrated the shared task shell into the live reasoning route with structured self-check and richer feedback but no target-equivalent checkpoint publication; GAME-ARCH-1 kept the short check as advisory; GAME-ARCH-2 produced the integrated architecture plan before engine gate reliance; and GATE-ENGINE-1 closed PASS WITH FLAGS while authorizing only named downstream planning/preparation sprints. Broad lesson-companion scaling remains blocked until lesson `GATE-L1.7B-Q2`, `REV-STD-1`, and Scale Gate 1 establish the remaining target-equivalent proof, review-standard, curriculum-versioning, and game-row operational quality. |

## Closed Sprints

| Sprint | Name | Completed | Current State |
|--------|------|-----------|---------------|
| GRAPH-UX-2 | Graph Game + Checkpoint UI Integration | yes | Completed as a live graph/table task-shell integration sprint. The generated Book 1 `1.1.3` graph route now loads and renders the GAME-UX-3A shared task shell, covers table-value selection, graph reading, economic axis convention, interpolation, point placement, graph-construction substitute, calculation/work capture, and a less-labelled graph variant, and keeps the shared route panel visible before task controls on mobile. Checkpoint-style graph tasks are proven as a non-published fixture through `ExitTicketEngine`/`ExitTicketUI` with `targetReadinessEvidence: false`; no `1.1.3` exit-ticket source or page was created. Generated Book 1 output was refreshed through platform build/deploy commands only, with desktop/mobile light/dark screenshot proof and lead review. No protected reference mutation, target-exercise field writes, candidate storage, unit minting, target-equivalent completion claims, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV, Scale Gate 1, or student/product use was authorized. MATH-UX-2, REASON-UX-2, GAME-ARCH-1, and GAME-ARCH-2 have since closed. Top operational next action is `GATE-ENGINE-1`. |
| LEAD-REVIEW-2 | Lead-Review Strict Validation | yes | Closed PASS WITH FLAGS. Hardened sprint-bundle validation so future non-grandfathered sprint IDs cannot bypass lead review by backdating `created`, human-review gates cannot use lead-review exemptions, lead-review reports must contain real review structure/evidence/verdicts, and PASS WITH FLAGS requires structured carried-flag disposition. Added strict fixtures proving four rejection paths and one positive path. Carried flags: `S7` and `PV-G4` are legacy compatibility entries with plan metadata but no result JSON, and `knowledge/exit-ticket-game-1.1.1.zip` remains unrelated/untracked and excluded from the sprint commit. No generated lesson output, protected reference mutation, target-exercise mutation, candidate storage, diagnostics, adaptive routing, mastery/sequencing, summative use, PV, Scale Gate 1, or student/product use was authorized. GRAPH-UX-2 and MATH-UX-2 have since closed; Top operational next action is `GAME-ARCH-1`. |
| LEAD-REVIEW-1 | Lead-Review Protocol Repair | yes | Closed PASS WITH FLAGS. Repaired sprint-bundle enforcement so new non-trivial roadmap sprints cannot silently opt out of lead review, and future human-review gates require lead review before the human interview starts. Ran actual lead-reviewer-agent audits for `SPEC-ET-1`, `EX-LESSON-1`, `GAME-UX-3A`, `ENGINE-OP-1`, and `SKILLMAP-OP-1`; all five close lead review as PASS WITH FLAGS after corrections, with SKILLMAP specialist flags carried forward. MTU-H4A/H4B/H4C were excluded from retroactive re-review because their human gate artifacts already exist by explicit user direction. No generated lesson output, protected reference mutation, target-exercise mutation, candidate storage, diagnostics, adaptive routing, mastery/sequencing, summative use, PV, Scale Gate 1, or student/product use was authorized. GRAPH-UX-2 and MATH-UX-2 have since closed; Top operational next action is `GAME-ARCH-1`. |
| SKILLMAP-OP-1 | Student-Visible Skill-Map Route | yes | Completed as a live route-visibility sprint. Added a route-display catalog so conceptual MTUs can appear in student routes without becoming runnable skill-tree exercises; added per-surface `skillMapRoutes` for Book 1 `1.1.1`, `1.1.2`, and `1.1.3`; rendered shared route panels in reasoning, graph/table, procedure support, and math/calculation surfaces; regenerated controlled Book 1 automated output through platform deploy only; and captured desktop/mobile screenshot proof. The route panels now show paragraph target, recommended focus, local progress, and practice action without visible MTU codes. GRAPH-UX-2, MATH-UX-2, REASON-UX-2, GAME-ARCH-1, and GAME-ARCH-2 have since closed. No target-exercise fields, candidate storage, protected references, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV, Scale Gate 1, or student/product use was authorized. Top operational next action is `GATE-ENGINE-1`. |
| ENGINE-OP-1 | Four-Engine Operational Proof Audit | yes | Completed as a screenshot-backed operational audit of the live generated routes for `1.1.1`, `1.1.2`, and `1.1.3`. Produced student-path traces, screenshots, screenshot manifest, and operational findings without generated lesson output, protected reference mutation, target-exercise field writes, candidate storage, projection refresh, Scale Gate 1, or student/product use. Audit findings: `1.1.3` graph practice is the strongest current operational route and gives neutral source/value/calculation feedback; `1.1.2` math practice is restored and scoped; `1.1.1` check remains a local short check only; generated output did not yet use the GAME-UX-3A task shell; `1.1.2` and `1.1.3` had no target-equivalent checkpoint route; and shared skill-map route panels were empty or mis-scoped before SKILLMAP-OP-1. SKILLMAP-OP-1, GRAPH-UX-2, and MATH-UX-2 have since closed route-visibility and task-shell proof; Top operational next action is `GAME-ARCH-1`. |
| GAME-UX-3A | Shared Task-Type UX Foundation | yes | Completed as a runtime-foundation sprint with no generated lesson output, protected reference mutation, target-exercise writes, candidate storage, projection refresh, Scale Gate 1, or student/product use. Added `task-shell-engine`, `task-shell-ui`, and `task-shell.css`; wired exit-ticket shells and deploy copy support; added focused tests for the shared task families and exit-ticket shell inclusion. Supported task families now include numeric input, calculation/work capture, final-answer entry, unit/notation field, short constructed response, table-value selection, graph reading, point placement, graph-construction substitute, and structured reasoning. The shell carries neutral feedback and retry/self-check states while preserving no mastery, diagnostic, sequencing, summative, AI, PV, or product-use claims. ENGINE-OP-1 proved generated output did not yet use the shell; SKILLMAP-OP-1, GRAPH-UX-2, and MATH-UX-2 have since closed route visibility and task-shell proof; Top operational next action is `GAME-ARCH-1`. |
| EX-LESSON-1 | Exam-Ingestion End-State Integration | yes | Completed as a route-trace handoff sprint with no generated lesson output or protected reference mutation. Added an exam-target route checklist, updated `BUILD-PARAGRAPH.md`, the paragraph-plan template, companion/textbook authoring guidance, and teacher/student review prompts so official CvTE and CvTE-derived target exercises trace prompt, source annexes, figures/tables/graphs, correction model, point allocation, answer-construction requirements, concepts, calculations, graph/table/source operations, reasoning operations, and answer-writing requirements into explanation, practice, skill-map route, shared task shell, target-equivalent exit ticket, and answer model. Updated lesson/platform roadmaps so `GAME-UX-3A` was the next operational dependency; GAME-UX-3A has since closed as a runtime foundation. No target-exercise field writes, candidate storage, candidate writes, lesson output, diagnostics, mastery/sequencing, summative use, PV projection, Scale Gate 1, or student/product use was authorized. |
| MTU-H4C | Answer-Form Bounded CLI Execution | yes | Completed as the bounded execution sprint authorized by GATE-MTU-H4B. Added `A96`, `A97`, `A98`, `A99`, `A80`, and `A81` through `unit-add.js` only; rebuilt generator readiness; kept missing generators generator-blocked/non-interactive; left `A71` held and `A100` invalid; kept graph/draw/shade, Type 4 motiveer/classificatie, and analysis/evaluation held; kept q3/q15 EX overlays visible with no candidate storage or writes; wrote no target-exercise `question_type` or `answer_form` fields; produced no lesson output and authorized no diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, Scale Gate 1, or student/product use. EX-LESSON-1, GAME-UX-3A, ENGINE-OP-1, SKILLMAP-OP-1, GRAPH-UX-2, and MATH-UX-2 have since closed; Top operational next action is `GAME-ARCH-1`. |
| GATE-MTU-H4B | Answer-Form CLI Execution Human Review | yes | Closed PASS WITH CONDITIONS for authorizing a later bounded H4B execution sprint after the H4B packet and cited evidence were pushed to remote commit `f59c83a7067678aa3ff2c4bab4455ab9d90d72af`. Accepted later execution of the exact reviewed `unit-add` commands for `A96` bereken, `A97` uitleg_dat, `A98` uitleg_of, `A99` leg uit met voorbeeld, `A80` noem/geef-aan with split-if-needed condition, and `A81` bron gebruiken only as source-use modifier plus underlying answer form. Preserved `A100` rejection, `A71` hold, future A-domain ID-policy/namespace requirement, generator-blocked/non-interactive exposure guardrails, held graph/Type 4/analysis lanes, q3/q15 EX overlays with no candidate storage or writes, no target-exercise field writes, and no lesson/product use. Authorized only `MTU-H4C` bounded execution; this gate itself executed no mutation. |
| MTU-H4B | Answer-Form Bounded CLI Execution Packet | yes | Completed as a non-mutating answer-form CLI execution packet after GATE-MTU-H4A. Added `reports/mtu-hardening/mtu-h4b-answer-form-cli-execution-packet.*`, `reports/review-gates/GATE-MTU-H4B-answer-form-cli-execution/review-packet.*`, `build-scripts/references/build-mtu-h4b-answer-form-cli-execution-packet.js`, `build-scripts/references/check-mtu-h4b-answer-form-cli-execution-packet.js`, and sprint logs. The packet turns the accepted H4A lanes into exact `unit-add` commands for `A80`, `A81`, and `A96`-`A99`, proves simulated catalog and exam-code validation, preserves `A100` rejection and `A71` hold, records generator/exposure blocks, keeps graph/draw/shade, Type 4 motiveer/classificatie, and analysis/evaluation held, keeps q3/q15 EX overlays visible, and blocks candidate storage, target-exercise field writes, generated projection refresh, lesson output, and product use. GATE-MTU-H4B has since closed PASS WITH CONDITIONS; Top operational next action is `MTU-H4C`. No execution or mutation was authorized by MTU-H4B itself. |
| GATE-MTU-H4A | Answer-Form CLI-Mutation Plan Human Review | yes | Closed PASS WITH CONDITIONS for later bounded execution-packet preparation after the H4A packet and cited evidence were pushed to remote commit `a91e5da2082ef8aacc040e55b3fae905d6f0799a`. Accepted `A96` bereken, `A97` uitleg_dat, `A98` uitleg_of, `A99` leg uit met voorbeeld, `A80` noem/geef-aan with split-if-needed condition, and `A81` bron gebruiken only as source-use modifier plus underlying answer form. Accepted `A80`, `A81`, and `A96`-`A99` for this bounded packet only, rejected invalid `A100`, kept `A71` held, and required future A-domain growth to route through ID-policy or namespace review. Kept graph/draw/shade, Type 4 motiveer/classificatie, and analysis/evaluation held; kept q3/q15 EX overlays visible; blocked candidate storage, candidate writes, target-exercise field writes, generated projection refresh, lesson output, and product use. Authorized only `MTU-H4B` execution-packet preparation; no execution or mutation was authorized. |
| SPEC-ET-1 | Exit Ticket Target-Equivalent Specification Correction | yes | Completed as a cross-repo specification and roadmap correction sprint. Updated `../4veco-lessen/specifications/product-end-state.md` and `../4veco-lessen/specifications/companion-core-specifications.md` so the exit ticket is target-equivalent proof, not merely readiness-to-try. Added local non-summative completion-language hierarchy, strengthened exam-ingestion end-product integration, updated lesson and platform roadmap rows for `EX-LESSON-1`, `GAME-UX-3A`, `L1.7B-Q2`, `GATE-L1.7B-Q2`, and Scale Gate 1, and preserved all blocks on generated lesson output, engine code, protected reference mutation, candidate storage, candidate writes, target-exercise mutation, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, Scale Gate 1, and student/product use. GATE-MTU-H4A has since closed; later task-shell and exit-ticket implementation must use the target-equivalent proof standard. |
| MTU-H4A | Answer-Form CLI-Mutation Planning Packet | yes | Completed as a non-mutating answer-form CLI-mutation planning packet after GATE-MTU-H4. Added `reports/mtu-hardening/mtu-h4a-answer-form-cli-mutation-plan.*`, `reports/review-gates/GATE-MTU-H4A-answer-form-cli-mutation-plan/review-packet.*`, `reports/review-gates/GATE-MTU-H4A-answer-form-cli-mutation-plan/bundle-urls.md`, `build-scripts/references/check-mtu-h4a-answer-form-cli-mutation-plan.js`, and sprint logs. The packet proposes exact later-planning unit-add specs for `A96` bereken, `A97` uitleg_dat, `A98` uitleg_of, `A99` leg uit met voorbeeld, `A80` noem/geef-aan, and `A81` bron gebruiken as source-use modifier plus underlying answer form. It records that `A100` is invalid under the current ID regex, keeps `A71` unused, keeps graph/draw/shade, Type 4 motiveer/classificatie, and analysis/evaluation held with no commands, keeps q3/q15 EX overlays visible, and blocks candidate storage, candidate writes, target-exercise field writes, generated projection refresh, lesson output, and product use. GATE-MTU-H4A has since closed PASS WITH CONDITIONS; Top operational next action is `MTU-H4B`. |
| GATE-MTU-H4 | Answer-Form And Question-Type Routing Human Review | yes | Closed PASS WITH CONDITIONS for answer-form/question-type routing only after the H4 packet and cited evidence were pushed to remote commit `38a032346db9a6a1dcb247d52afce745c48863f7`. Accepted the hybrid boundary between reusable answer-form MTUs, EX answer-skill overlays, and later authored-reference `question_type`/`answer_form` fields. Approved planning lanes `ANS_BEREKEN`, `ANS_LEG_UIT_DAT`, `ANS_LEG_UIT_OF`, `ANS_LEG_UIT_MET_VOORBEELD`, `ANS_NOEM_GEEF_AAN`, `ANS_BRON_GEBRUIKEN`, and graph/draw/shade as a planning candidate needing stronger mapping evidence. Conditions add a held Type 4 `ANS_MOTIVEER_CLASSIFICATIE` lane, require `bron` to be source-use plus underlying answer form, keep analysis/evaluation held, keep q3/q15 EX overlays visible, block candidate storage, block target-exercise field writes, and authorize only a later bounded `MTU-H4A` planning packet. No protected reference mutation, unit minting, candidate storage creation, candidate writes, target-exercise mutation, generated projection refresh, lesson output, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, Scale Gate 1, or student/product use was authorized. MTU-H4A and GATE-MTU-H4A have since closed; Top operational next action is `MTU-H4B`. |
| SYNC-4 | Engine Operationalization Roadmap Sync | yes | Completed as a roadmap/specification synchronization sprint. Updated `../4veco-lessen/specifications/product-end-state.md` and `../4veco-lessen/specifications/companion-core-specifications.md` so the shared task-type UI is part of the end-state product, not exit-ticket-only implementation detail. Updated the lesson roadmap and this platform roadmap with `GAME-UX-3A`, `ENGINE-OP-1`, `SKILLMAP-OP-1`, `GRAPH-UX-2`, `MATH-UX-2`, `REASON-UX-2`, `GAME-ARCH-1`, and `GATE-ENGINE-1`. Archived roadmap v3.10 and updated version indexes. No engine code, generated lesson output, protected reference mutation, external-source mutation, machine-reference mutation, unit minting, candidate storage, candidate writes, target-exercise mutation, generated projection refresh, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, Scale Gate 1, or student/product use was authorized. GATE-MTU-H4 and GATE-MTU-H4A have since closed; Top operational next action is `MTU-H4B`. |
| MTU-H4 | Answer-Form MTUs And Question-Type Mapping | yes | Completed as a non-mutating routing-packet sprint after MTU-H3C. Added `reports/mtu-hardening/mtu-h4-answer-form-question-type-routing.*`, `reports/review-gates/GATE-MTU-H4-answer-form-question-type-routing/review-packet.*`, `reports/review-gates/GATE-MTU-H4-answer-form-question-type-routing/bundle-urls.md`, `build-scripts/references/check-mtu-h4-answer-form-question-type-routing.js`, and sprint logs. The packet records that target exercises currently have no `question_type` or `answer_form` fields, extracted exam evidence has `uitleg_dat`, `uitleg_of`, `bron`, `berekenen`, and `noem` values, H2 deferred q1/q2 answer forms remain visible, and EX answer-skill candidate storage remains absent/dry-run-only. It proposes a hybrid boundary: reusable answer-form MTU planning lanes for broad procedures and EX answer-skill overlays for correction-model-specific answer construction. No protected reference mutation, external-source mutation, machine-reference mutation, unit minting, candidate storage creation, candidate writes, target-exercise mutation, generated projection refresh, lesson-output mutation, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, or student/product use was authorized. GATE-MTU-H4 and GATE-MTU-H4A have since closed; Top operational next action is `MTU-H4B`. |
| MTU-H3C | Incidence Pass-Through Bounded CLI Execution | yes | Completed the GATE-MTU-H3B authorized bounded execution sprint. Added `D41`, `D42`, `D43`, `D45`, and `D46` through `unit-add.js`; updated `D07` through `unit-update.js` after dry-run; applied exact authored target-exercise mapping patches for `3.1.1`, `3.1.2`, and `3.1.3`; kept `D44` held and unmapped; refreshed owned-content graph, RAG chunks, procedure/PV reports, roadmap indexes, and source registries only after source mutations. `D42` executed as `true_zero` with no `D41` dependency; `D45` keeps supply elasticity qualitative; `A93` remains unchanged and bounded to price percentage change. No `references/external/` mutation, target-exercise promotion, candidate storage, candidate writes, lesson-output mutation, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, or student/product use was authorized. Top operational next action is `MTU-H4`. |
| GATE-MTU-H3B | Incidence Pass-Through CLI Execution Human Review | yes | Closed as `pass_with_conditions` after the H3B packet and cited evidence were pushed to remote commit `ad7d69c3836176a10111384aeb640d49e93b705d`. Authorized a later bounded execution sprint for `D41`, `D42`, `D43`, `D45`, `D46`, narrowed `D07`, exact authored mapping patches for `3.1.1`, `3.1.2`, and `3.1.3`, and generated projection refresh only after authorized source mutations. `D44` remains held and unmapped. Conditions require final preflight, extracted-spec logging, `D07` dry-run proving `A15` and hidden elasticity are removed, `D42` no `D41` dependency plus zero-needs status fix or justification, `D45` qualitative supply-elasticity treatment, unchanged `A93`, no target-exercise status/source/promotion metadata changes, full validation, and no product-use authority. Top operational next action is `MTU-H4`. |
| MTU-H3B | Incidence Pass-Through CLI Execution Packet | yes | Completed as a non-mutating execution-packet sprint after GATE-MTU-H3A. Added `reports/mtu-hardening/mtu-h3b-incidence-cli-execution-packet.*`, `reports/review-gates/GATE-MTU-H3B-incidence-cli-execution/review-packet.*`, `reports/review-gates/GATE-MTU-H3B-incidence-cli-execution/bundle-urls.md`, `build-scripts/references/check-mtu-h3b-incidence-cli-execution-packet.js`, and sprint logs. The packet resolves H3A's conditions by revising `D42` to a zero-needs euro-burden unit instead of depending on graphical `D41`, keeping `D45` qualitative/internal for supply-elasticity reasoning, holding `D44` out of the command set, and keeping `A93` unchanged. It prepares exact later command strings and mapping patches for `D07`, `D41`, `D42`, `D43`, `D45`, `D46`, `3.1.1`, `3.1.2`, and `3.1.3`. No protected reference mutation, external-source mutation, machine-reference mutation, `D07` update, unit minting, target-exercise mutation, candidate writes, generated projection refresh, lesson-output mutation, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, or student/product use was authorized. GATE-MTU-H3B has since closed; Top operational next action is `MTU-H4`. |
| GATE-MTU-H3A | Incidence Pass-Through CLI-Mutation Plan Human Review | yes | Closed as `pass_with_conditions` for CLI-mutation planning only after the H3A packet and cited evidence were pushed to remote commit `a5f481a8c4a0b5817d5583ddc5303ccba5240458`. Accepted later execution-packet preparation for narrowed `D07`, `D41` tax wedge/Pc/Pp labeling, `D42` euro burden amounts, `D43` subsidy effective prices, held/conditional `D44` subsidy benefit-sharing, `D45` relative elasticity explanation, and `D46` cost-shock pass-through share while keeping `A93` unchanged and bounded. Conditions require reviewing `D42`'s dependency on `D41`, resolving `D45`'s supply-elasticity status, keeping `D07` free of `A15` and hidden elasticity, printing exact specs and mapping diffs before execution, running `D07` dry-run and validators, and refreshing projections only after authorized source mutation. Authorized only `MTU-H3B` execution-packet preparation. No `D07` mutation, `D41`-`D46` minting, target-exercise writes, generated projection refresh, PV projection, PV machine promotion, lesson output, candidate writes, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, or student/product use was authorized. MTU-H3B and GATE-MTU-H3B have since closed; Top operational next action is `MTU-H4`. |
| MTU-H3A | Incidence Pass-Through CLI-Mutation Planning Packet | yes | Completed as a non-mutating planning-packet sprint after GATE-MTU-H3. Added `reports/mtu-hardening/mtu-h3a-incidence-cli-mutation-plan.*`, `reports/review-gates/GATE-MTU-H3A-incidence-cli-mutation-plan/review-packet.*`, `build-scripts/references/check-mtu-h3a-incidence-cli-mutation-plan.js`, and sprint logs. The packet proposes exact later specs for narrowing `D07` to tax afwentelingspercentage/percentage burden, adding planning-only `D41` tax wedge/Pc/Pp labeling, `D42` euro tax burden amounts, `D43` subsidy effective prices, `D44` subsidy benefit-sharing, `D45` relative elasticity explanation, and `D46` cost-shock pass-through share while keeping `A93` bounded to percentage price change. It records exact authored mapping before/after proposals for `3.1.1`, `3.1.2`, and `3.1.3`, keeps `D44` unmapped unless a target explicitly requires benefit-sharing, and states rollback, validation, source/projection, and unit-add dry-run limitations. No protected reference mutation, external-source mutation, machine-reference mutation, `D07` update, `D41`-`D46` minting, target-exercise mutation, candidate writes, generated projection refresh, lesson-output mutation, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, or student/product use was authorized. GATE-MTU-H3A, MTU-H3B, and GATE-MTU-H3B have since closed; Top operational next action is `MTU-H4`. |
| GATE-MTU-H3 | Incidence Pass-Through Human Review | yes | Closed as `pass_with_conditions` for incidence/pass-through family routing only after the H3 packet and cited evidence were pushed to remote commit `316c299db215898760e3c6da430b70b055b0b5e2`. Accepted routing: narrow `D07` to tax afwentelingspercentage/percentage burden; plan `D41` for tax wedge and Pc/Pp graphical labeling; plan `D42` for euro burden amounts; plan `D43`/`D44` for subsidy effective prices and benefit-sharing; keep `A93` bounded to percentage price change while planning `D46` only for true cost-shock pass-through share; move relative elasticity explanation to `D45`; treat target mappings as authored-reference mutations; and refresh projections only after authorized source mutation. Authorized only `MTU-H3A` CLI-mutation planning. No `D07` mutation, `D41`-`D46` minting, target-exercise writes, generated projection refresh, PV projection, PV machine promotion, lesson output, candidate writes, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, or student/product use was authorized. MTU-H3A, GATE-MTU-H3A, MTU-H3B, and GATE-MTU-H3B have since closed; Top operational next action is `MTU-H4`. |
| MTU-H3 | Incidence Pass-Through Skill Family Review | yes | Completed as a non-mutating family-review packet sprint after MTU-H2J. Added `reports/mtu-hardening/mtu-h3-incidence-pass-through-family-review.*`, `reports/review-gates/GATE-MTU-H3-incidence-pass-through/review-packet.*`, `reports/review-gates/GATE-MTU-H3-incidence-pass-through/bundle-urls.md`, `build-scripts/references/check-mtu-h3-incidence-pass-through-review.js`, and sprint logs. The packet records that live `D07` currently calculates tax afwentelingspercentage but is over-used by `3.1.1` for tax-wedge/Pc/Pp work; `3.1.2` still needs a D07-style tax burden/percentage route; `3.1.3` lacks dedicated subsidy incidence/benefit-sharing units; and `A93` remains price-change, not incidence/pass-through share. Candidate labels `D41` through `D46` are planning-only absent IDs. No protected reference mutation, external-source mutation, machine-reference mutation, D07 update, successor-unit minting, unit split/deprecation, target-exercise mutation, candidate writes, generated projection refresh, lesson-output mutation, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, or student/product use was authorized. GATE-MTU-H3, MTU-H3A, GATE-MTU-H3A, MTU-H3B, and GATE-MTU-H3B have since closed; Top operational next action is `MTU-H4`. |
| MTU-H2J | A20/A94/A95 Bounded CLI Execution | yes | Completed the GATE-MTU-H2I authorized bounded execution sprint. Updated `A20` through `unit-update.js` while retaining `A2.11`; added `A94` and `A95` through `unit-add.js`; applied the exact authored target-exercise mapping patches for `3.2.2` and `4.1.2` while verifying `3.3.3` unchanged; moved current `GEN.A20` behavior to `GEN.A95`; left narrowed `A20` and `A94` generator-blocked/not-yet-interactive; refreshed generator-readiness, owned-content graph, RAG chunks, procedure/PV reports, roadmap indexes, and source registries only after authorized source mutations. No `references/external/` mutation, target-exercise promotion, candidate storage, candidate writes, lesson-output mutation, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, or student/product use was authorized. MTU-H3 has since prepared the non-mutating incidence/pass-through review packet; Top operational next action is `GATE-MTU-H3`. |
| GATE-MTU-H2I | A20/A94/A95 CLI Execution Human Review | yes | Closed as `pass_with_conditions` after the H2I packet and cited evidence were pushed to remote commit `1fb0b95fc6b031f37ff780fb3db063dd9deb7d25`. Authorized a later bounded execution sprint for `A20`, `A94`, `A95`, exact authored mapping patches for `3.2.2`/`3.3.3`/`4.1.2`, the generator route that moves current `GEN.A20` behavior to `GEN.A95` and blocks `GEN.A20` until a narrowed derive-both generator exists, and generated projection refresh after source mutations. Conditions require final preflight, extracted-spec logging, `A20` dry-run with `A2.11` retained, exact target-exercise before/after arrays, exact generator patch/diff before mutation, generator-readiness/no-exposure proof, full validation, and no product-use authority. MTU-H2J has since executed; Top operational next action is `MTU-H3`. |
| MTU-H2I | A20/A94/A95 CLI Execution Packet | yes | Completed as a non-mutating execution-packet sprint after GATE-MTU-H2H. Added `reports/mtu-hardening/solo-q1-q3-a20-cli-execution-packet.*`, `reports/review-gates/GATE-MTU-H2I-a20-cli-execution/review-packet.*`, `build-scripts/references/build-mtu-h2i-a20-cli-execution-packet.js`, `build-scripts/references/check-mtu-h2i-a20-cli-execution-packet.js`, and sprint result logs. The packet prepares exact later execution review for the `A20` unit-update, `A94`/`A95` unit-add specs, authored target-exercise mapping patch for `3.2.2`/`3.3.3`/`4.1.2`, and the generator route that moves current `GEN.A20` behavior to `GEN.A95` while blocking `GEN.A20` until a narrowed derive-both generator exists. No protected reference mutation, `A20` mutation, `A94`/`A95` minting, target-exercise mapping write, generator change, generated projection refresh, PV projection, lesson output, candidate writes, target-exercise promotion, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV machine promotion, or student/product use was authorized. GATE-MTU-H2I has since closed; Top operational next action is `MTU-H2J`. |
| GATE-MTU-H2H | A20/A94/A95 CLI-Mutation Plan Human Review | yes | Closed as `pass_with_conditions` for CLI-mutation planning only after the H2H packet and evidence were pushed to remote commit `d806903cb0072c38c265974642c1bc38fd1c0c69`. Accepted the corrected `A20` spec with `A2.11`, `A94` as the price-taker `MO = P` plus derived-MK route, `A95` as the given MK-function route, target mapping direction for `3.2.2`, `3.3.3`, and `4.1.2`, and the preferred generator route of moving current `GEN.A20` behavior to A95/equivalent while rewriting or blocking `GEN.A20` for narrowed A20. Authorized only MTU-H2I execution-packet preparation. No protected reference mutation, `A20` mutation, `A94`/`A95` minting, target-exercise mapping write, generator change, projection refresh, PV projection, lesson output, candidate writes, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV machine promotion, or student/product use was authorized. Top operational next action is `GATE-MTU-H2I`. |
| MTU-H2H | A20/A94/A95 CLI-Mutation Planning Packet | yes | Completed as a non-mutating planning-packet sprint after GATE-MTU-H2G. Added `reports/mtu-hardening/solo-q1-q3-a20-cli-mutation-plan.*`, `reports/review-gates/GATE-MTU-H2H-a20-cli-mutation-plan/review-packet.*`, `reports/review-gates/GATE-MTU-H2H-a20-cli-mutation-plan/bundle-urls.md`, `build-scripts/references/check-mtu-h2h-a20-cli-mutation-plan.js`, and sprint result logs. The packet corrects the `A20` update spec to retain `A2.11` and use a clearer derived-MO plus derived-MK route, proposes `A94` for price-taker `MO = P` plus derived MK, proposes `A95` for given MK-function cases, records exact authored mapping before/after arrays for `3.2.2`, `3.3.3`, and `4.1.2`, and names the preferred `GEN.A20` route as moving current behavior to A95/equivalent while creating, rewriting, or blocking GEN.A20 for narrowed A20. No protected reference mutation, `A20` mutation, `A94`/`A95` minting, target-exercise mapping write, generator change, generated projection refresh, PV projection, lesson output, candidate writes, target-exercise promotion, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV machine promotion, or student/product use was authorized. GATE-MTU-H2H has since closed; Top operational next action is `GATE-MTU-H2I`. |
| GATE-MTU-H2G | A20 Split And Affected-Mapping Human Review | yes | Closed as `pass_with_conditions` for A20 split/replacement planning only after H2G evidence was pushed to remote commit `f925da5ed7521c3052c60668599c5a97d99aaf7a`. Accepted the usage audit: `3.2.2` is price-taker/given-MO plus derived-MK, `3.3.3` is derived-MO plus derived-MK, `4.1.2` is given constant MK, and `GEN.A20` currently practises given MO and given MK-function solving. Authorized only MTU-H2H planning: corrected A20 spec with `A2.11`, clearer A20 name, explicit A94 price-taker `MO = P` step, A95/generator route, exact authored mapping diffs, and generated-projection guardrails. No mutation, unit minting, target-exercise write, generator change, PV projection, lesson output, or student/product use was authorized. Top operational next action is `GATE-MTU-H2H`. |
| MTU-H2G | A20 Split And Affected-Mapping Packet | yes | Completed as a non-mutating packet sprint. Added `reports/mtu-hardening/solo-q1-q3-a20-split-replacement-packet.*`, `reports/review-gates/GATE-MTU-H2G-a20-split-replacement/review-packet.*`, `reports/review-gates/GATE-MTU-H2G-a20-split-replacement/bundle-urls.md`, `build-scripts/references/check-mtu-h2g-a20-split-packet.js`, and sprint result logs. The packet audits active `A20` uses: `3.2.2` as given-MO/price-taker plus derived-MK, `3.3.3` as derived-MO and derived-MK, `4.1.2` as given constant MK now better routed to live `A91`, and `GEN.A20` as given MO-function plus given MK-function that would mismatch a narrowed derived-route `A20`. It proposes later review lanes for updating/narrowing `A20`, adding `A94`/`A95` or equivalents, affected mapping updates, and generator handling. No protected reference mutation, `A20` mutation, `A94`/`A95` minting, target-exercise mapping write, generator change, PV projection, lesson output, candidate writes, target-exercise promotion, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV machine promotion, or student/product use was authorized. Top operational next action is `GATE-MTU-H2G`. |
| MTU-H2F | Conditional Solo q1-q3 CLI Execution | yes | Completed the GATE-MTU-H2E authorized conditional CLI execution. Updated `A12` through `unit-update.js` while retaining `A2.11`; added `A88`, `A89`, `A90`, `A92`, and `A93` through `unit-add.js`; printed every extracted JSON spec before execution; kept `A20` out of the command set; refreshed generator-readiness records; and updated H2 lifecycle checkers so they validate both pre-H2F and post-H2F states without accepting partial execution. The new generator-backed A-domain units remain generator-blocked/not-yet-interactive until generator implementation and separate student-facing exposure review. No `references/external/` mutation, candidate storage, candidate writes, lesson-output mutation, target-exercise promotion, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, or student/product use was authorized. Top operational next action is `MTU-H2G`. |
| GATE-MTU-H2E | Conditional Lane Execution Human Review | yes | Closed as `pass_with_conditions` after the H2E packet and cited evidence were pushed to remote commit `52ffc484b270182964283e20cd696aca6ce5f9e6`. Authorized a later bounded CLI execution sprint for `A12`, `A88`, `A89`, `A90`, `A92`, and `A93` only; `A20` remains held for a separate split/deprecate/replacement and affected-mapping/generator packet. Conditions require final preflight, extracted-spec logging and comparison, `A12` dry-run with `A2.11` retained, no `A20` command, generator-blocked/not-yet-interactive or implemented status for missing `GEN_A88`, `GEN_A89`, `GEN_A90`, `GEN_A92`, and `GEN_A93`, no broken student-facing skill-tree/PV exposure, and full validation. The packet itself authorized no mutation or product use. MTU-H2F has since executed; Top operational next action is `MTU-H2G`. |
| MTU-H2E | Solo q1-q3 Conditional Lane Execution Packet | yes | Completed as a non-mutating execution-packet sprint. Added `reports/mtu-hardening/solo-q1-q3-conditional-lane-execution-packet.*`, `reports/review-gates/GATE-MTU-H2E-conditional-lane-execution/review-packet.*`, `build-scripts/references/build-mtu-h2e-conditional-lane-execution-packet.js`, `build-scripts/references/check-mtu-h2e-conditional-lane-execution-packet.js`, and sprint result logs. The packet prepared exact later CLI lanes for `A12`, `A88`, `A89`, `A90`, `A92`, and `A93`; kept `A20` held; retained `A2.11` on `A12`; recorded zero-needs rationale for `A88` and `A89`; narrowed `A90` to the linear GO-rule route; kept `A92` dependent on `A89`; kept `A93` on `A38`/`A92` without `A66`; and made generator-blocked/not-yet-interactive handling explicit for `GEN_A88`, `GEN_A89`, `GEN_A90`, `GEN_A92`, and `GEN_A93`. No protected reference mutation, unit minting, unit updates, unit splits, candidate writes, lesson output, target-exercise promotion, CP-6/Year-1 closure, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, or student/product use was authorized. GATE-MTU-H2E closed and MTU-H2F executed; Top operational next action is `MTU-H2G`. |
| GATE-MTU-H2D | Solo q1-q3 Held/Conditional Lane Human Review | yes | Closed as `pass_with_conditions` for held/conditional lane routing only after H2D evidence was pushed to remote commit `63c2e53731af3941d49183628f4ba5927f8ac551`. Accepted that `A12` may proceed only if `A2.11` is retained; `A20` remains held for a separate split/deprecate/replacement and affected-mapping packet; `A88` and `A89` should be zero-needs units with explicit rationale; `A90` should narrow to the linear GO-rule route; `A92` remains dependent on accepted/executed `A89`; and `A93` should depend on `A38`/`A92` while keeping broader incidence/pass-through in MTU-H3. Corrected generator inventory: `GEN_A12` and `GEN_A20` exist as `GEN.A12` and `GEN.A20`; proposed `GEN_A88`, `GEN_A89`, `GEN_A90`, `GEN_A92`, and `GEN_A93` are not implemented in the current baseline and require implementation, explicit generator-blocked/not-yet-interactive status, or proof of non-exposure before student-facing use. No mutation or product authority was authorized. MTU-H2E, GATE-MTU-H2E, and MTU-H2F have since closed; Top operational next action is `MTU-H2G`. |
| MTU-H2D | Solo q1-q3 Held And Conditional Lane Resolution | yes | Completed as a non-mutating resolution sprint. Added `reports/mtu-hardening/solo-q1-q3-held-conditional-resolution.*`, `reports/review-gates/GATE-MTU-H2D-held-conditional-lanes/review-packet.*`, `build-scripts/references/check-mtu-h2d-held-conditional-resolution.js`, and sprint result logs. The packet revised `A12` to retain `A2.11`, kept `A20` held for a separate split/deprecate/replacement and affected-mapping packet, revised `A88` and `A89` to zero-needs routes, narrowed `A90` to the linear GO-rule route, kept `A92` dependent on accepted/executed `A89`, and revised `A93` to depend on `A38`/`A92` while routing broader incidence to MTU-H3. Corrected generator inventory records that `GEN_A12` and `GEN_A20` exist as `GEN.A12` and `GEN.A20`, while proposed `GEN_A88`, `GEN_A89`, `GEN_A90`, `GEN_A92`, and `GEN_A93` need implementation, explicit generator-blocked/not-yet-interactive status, or proof of non-exposure before student-facing use. No protected reference mutation, unit minting, unit updates, unit splits, candidate writes, lesson output, target-exercise promotion, CP-6/Year-1 closure, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, or student/product use was authorized. GATE-MTU-H2D, MTU-H2E, GATE-MTU-H2E, and MTU-H2F have since closed; Top operational next action is `MTU-H2G`. |
| MTU-H2C | Reduced-Scope Solo q1-q3 CLI Execution | yes | Completed the reduced clean-lane CLI execution authorized by GATE-MTU-H2B. Through `unit-add.js`, minted exactly `F19`, `F20`, `A85`, `A86`, `A87`, and `A91`, with extracted JSON specs echoed before execution and post-execution validation. `A12`, `A20`, `A88`, `A89`, `A90`, `A92`, and `A93` were not executed. `A12` remains held until its update spec retains `A2.11` or a later gate authorizes removal; `A20` remains held because target exercise `4.1.2` uses current `A20` in a given-MK context; `A92` remains held until the `A89` dependency route is resolved. H2A/H2B checkers now validate the post-H2C lifecycle state while still blocking conditional/held IDs from silently appearing. No candidate storage, candidate writes, `references/external/` mutation, lesson-output mutation, CP-6/Year-1 closure, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, or student/product use was authorized. `MTU-H2D` and `GATE-MTU-H2D` have since closed; Top operational next action is `MTU-H2E`. |
| GATE-MTU-H2B | Solo q1-q3 CLI Execution Authorization Human Review | yes | Closed as `partial_pass_with_conditions` for reduced-scope execution only. The full H2B execution-ready set is not authorized as written. Clean lanes after final preflight are `F19`, `F20`, `A85`, `A86`, `A87`, and `A91`; `A92` requires dependency resolution because it depends on conditional `A89`; `A88`, `A89`, `A90`, and `A93` are conditional or revise-first lanes; `A12` is held until its update spec retains `A2.11` or explicitly justifies removal; and `A20` is held because active target exercise `4.1.2` uses `A20` in a given-MK context. The gate required final preflight, extracted-spec logging, unchanged/revalidated plan proof, rollback/validation/no-unintended-diff proof, and no product-use authority. MTU-H2C, MTU-H2D, and GATE-MTU-H2D have since closed; Top operational next action is `MTU-H2E`. |
| MTU-H2B | Solo q1-q3 CLI Execution Gate Packet | yes | Completed as a non-mutating execution-gate packet sprint. Added `reports/mtu-hardening/solo-q1-q3-cli-execution-gate-packet.*`, `reports/review-gates/GATE-MTU-H2B-cli-execution/review-packet.*`, sprint logs, and `build-scripts/references/check-mtu-h2b-cli-execution-gate-packet.js`. The packet proves ID availability for `F19`, `F20`, and `A85-A93`; validates A-unit generator fields and term links; simulates the unblocked post-execution catalog; carries exact command strings for the unblocked lanes; and records expected diff, rollback, audit, validation, and no-unintended-diff requirements. The `A20` usage audit blocks direct `A20` narrowing because target exercise `4.1.2` uses `A20` in a given-MK context. MTU-H2B did not mutate `references/machine/` or `references/external/`, mint units, execute unit updates, execute unit splits, create candidate storage, write candidates, mutate lesson output, close CP-6/Year-1, or authorize diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, or student-facing output. GATE-MTU-H2B closed, MTU-H2C executed the reduced clean lanes, and MTU-H2D/GATE-MTU-H2D have since closed; Top operational next action is `MTU-H2E`. |
| GATE-MTU-H2A | Solo q1-q3 CLI-Mutation Plan Human Review | yes | Closed as `pass_with_conditions_execution_gate_planning_only`. Accepted the proposed `F19`, `F20`, `A85-A93`, `A12` update, and conditional `A20` update/split route for a later bounded execution-gate packet only. Conditions require ID-collision proof, schema-valid specs, A-unit generator-field proof or validator proof, term-link validation, `A20` usage impact audit, OR-prerequisite guardrail for `A90`/`A12`/`A91`, exact command log, rollback, audit, validation, reference-health/Jest proof, and no unintended external/candidate/lesson-output diff. GATE-MTU-H2A authorized no CLI execution, protected/external/machine reference mutation, unit minting, unit update execution, unit split execution, candidate writes, lesson-output mutation, CP-6/Year-1 closure, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, or student/product use. `MTU-H2B`, `GATE-MTU-H2B`, `MTU-H2C`, `MTU-H2D`, and `GATE-MTU-H2D` have since closed; Top operational next action is now `MTU-H2E`. |
| MTU-H2A | Solo q1-q3 CLI-Mutation Planning | yes | Completed as a planning-only sprint. Added `reports/mtu-hardening/solo-q1-q3-cli-mutation-plan.*`, `reports/review-gates/GATE-MTU-H2A-cli-mutation-plan/review-packet.*`, sprint logs, and `build-scripts/references/check-mtu-h2a-cli-mutation-plan.js`. The packet proposes exact new IDs `F19`, `F20`, and `A85` through `A93`, plus live updates to `A12` and `A20`, with CLI specs, command order, rollback/audit expectations, validation proof, and guardrails. It keeps q1/q2 answer-form needs routed to MTU-H4 and D07 incidence/pass-through routed to MTU-H3. MTU-H2A did not mutate `references/machine/` or `references/external/`, mint units, execute unit updates, create candidate storage, write candidates, mutate lesson output, close CP-6/Year-1, or authorize diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, or student-facing output. GATE-MTU-H2A, MTU-H2B, GATE-MTU-H2B, MTU-H2C, MTU-H2D, and GATE-MTU-H2D have since closed; Top operational next action is now `MTU-H2E`. |
...
| RX.6 | Skill-Tree And Generator Integration | yes | Completed. Source and deployed skill-tree bundles now expose 47 generator-backed A-domain units as interactive and 51 missing-generator units as explicit generator-blocked/non-interactive rows after MTU-H4C; no student-facing skill-tree or PV exposure is authorized for blocked units. |
...
target-equivalent proof evidence, does not authorize scale reliance, and does
...
these checkpoints can become target-equivalent proof evidence.
...
target-equivalent exit-ticket specification. `Check` remains hidden for both
...
require student-visible route proof, screenshots, task feedback evidence, and a
live-output human integration review before engine scale or Scale Gate 1
reliance. SYNC-4 authorizes no engine code, generated lesson output, protected
mutation, target-exercise writes, generated projection refresh, diagnostics,
adaptive routing, mastery/sequencing, student-facing AI, summative use, PV
projection, PV machine promotion, Scale Gate 1, or student/product use. Top
operational next action at SYNC-4 close remained `GATE-MTU-H4`.

Update 2026-05-29: GATE-MTU-H4 closed PASS WITH CONDITIONS for
answer-form/question-type routing only after remote evidence review at commit
`38a032346db9a6a1dcb247d52afce745c48863f7`. The gate accepted the hybrid
architecture of reusable answer-form MTUs, EX answer-skill overlays, and later
authored-reference mapping fields. Conditions require a held Type 4
`ANS_MOTIVEER_CLASSIFICATIE` lane, `bron` as source-use modifier plus an
underlying answer form, graph/draw/shade planning-only until stronger mapping
evidence, held analysis/evaluation, visible q3/q15 EX overlays, no candidate
storage, and no target-exercise field writes. Authorized next is only
...
Update 2026-05-29: `GATE-MTU-H4A Answer-Form CLI-Mutation Plan Human Review`
closed PASS WITH CONDITIONS for later bounded execution-packet preparation.
The gate accepted `A80`, `A81`, and `A96`-`A99` for this bounded packet only,
rejected invalid `A100`, kept `A71` held, and made future A-domain growth
depend on an ID-policy or namespace decision. It approved `A96` bereken,
`A97` uitleg_dat, `A98` uitleg_of, `A99` leg uit met voorbeeld, `A80`
noem/geef-aan with split-if-needed condition, and `A81` bron gebruiken only as
source-use modifier plus underlying answer form. Graph/draw/shade, Type 4
motiveer/classificatie, and analysis/evaluation remain held; q3/q15 EX
overlays remain visible with no candidate writes. Authorized next is only
`MTU-H4B` non-mutating execution-packet preparation. No unit minting,
...
requirements, and keeps Scale Gate 1 blocked unless target-equivalent status is
proven or explicitly waived with checkpoint-only consequences. This authorizes
no engine code, generated lesson output, protected reference mutation,
candidate storage, candidate writes, target-exercise mutation, diagnostics,
adaptive routing, mastery/sequencing, student-facing AI, summative use, PV
...
Gate 1, or student/product use. GAME-UX-3A, ENGINE-OP-1, SKILLMAP-OP-1,
...
reasoning without changing completion authority. No generated lesson output,
protected reference mutation, target-exercise field writes, candidate storage,
projection refresh, diagnostics, adaptive routing, mastery/sequencing,
student-facing AI, summative use, PV projection, PV machine promotion, Scale
Gate 1, or student/product use is authorized. ENGINE-OP-1 showed the runtime
was not yet visible in generated Book output; SKILLMAP-OP-1 has since made the
route layer visible and scoped, GRAPH-UX-2 has since integrated the shell into
the live graph/table route, and MATH-UX-2 has since integrated the shell into
...
was `SKILLMAP-OP-1`; SKILLMAP-OP-1 has since closed as route-visibility proof,
GRAPH-UX-2 has since closed as graph/task-shell proof, and MATH-UX-2 has since
closed as math/task-shell proof, and REASON-UX-2 has closed as
reasoning/task-shell proof. Top operational next action is `GAME-ARCH-1`;
no Scale Gate 1,
target-equivalent completion claim, diagnostics, adaptive routing,
mastery/sequencing, student-facing AI, summative use, PV projection, PV machine
promotion, or student/product use is authorized.
...
- `EX-7` completed: validators and dry-run-only CLIs implemented with no
  ...
  mutation, lesson-output mutation, or student/product use.
- `GAME-UX-2` completed the source-controlled non-summative checkpoint engine
  for `1.1.1` only; it is not target-exercise-readiness evidence.
- `LESSON-SCALE-1` tracks the lesson-side pre-scale dependency: L1.7A rejected
  ...
  lesson L2.0 closed PASS WITH FLAGS with the house-style baseline; and
  L1.7C-MATH, L1.7B-MAP, and L1.7B-P23 have closed with carried flags. MTU-H4C
  has executed the bounded answer-form unit lane through CLI-only mutation, and
  EX-LESSON-1 has supplied the exam-target route-trace handoff, GAME-UX-3A
  has supplied the shared task-shell runtime foundation, and ENGINE-OP-1 has
  supplied live-route audit evidence. SKILLMAP-OP-1 has since supplied
  visible-route proof for Book 1 `1.1.1`, `1.1.2`, and `1.1.3`. GRAPH-UX-2
  and MATH-UX-2 have since supplied live graph/table and math/calculation
  task-shell integration proof. Broad companion/product scaling must still
  wait for REASON-UX-2, GAME-ARCH-1, GATE-ENGINE-1, L1.7B-Q2, GATE-L1.7B-Q2,
  REV-STD-1, minimal curriculum-versioning readiness, and Scale Gate 1.
...
| GATE-MTU-H2D-held-conditional-lanes | before held/conditional Solo q1-q3 lanes advance to an execution-packet sprint | yes | yes | routing only for `A12`, `A88`, `A89`, `A90`, `A92`, and `A93`, with `A20` held for a separate split/replacement packet |
| GATE-MTU-H2E-conditional-lane-execution | before conditional Solo q1-q3 CLI lanes are authorized for execution | yes | yes | execution review for `A12`, `A88`, `A89`, `A90`, `A92`, and `A93`, with `A20` held and remote-before-review evidence required |
| GATE-MTU-H3-incidence-pass-through | before incidence/pass-through family lanes advance to CLI-mutation planning | yes | yes | routing only for `D07` and planning-only `D41`-`D46`/equivalent lane decisions; no mutation or execution |
| GATE-MTU-H3A-incidence-cli-mutation-plan | before incidence/pass-through lanes advance to an execution-packet sprint | yes | yes | closed pass with conditions for execution-packet preparation only; requires D42 dependency review, D45 supply-elasticity resolution, A93 boundary, exact specs/mapping diffs, rollback, validation, and no mutation or execution from the gate |
| GATE-MTU-H3B-incidence-cli-execution | before incidence/pass-through CLI execution is authorized | yes | yes | closed `pass_with_conditions`; authorized `MTU-H3C` bounded execution for `D07`, `D41`, `D42`, `D43`, `D45`, `D46`, exact mappings, and downstream projection refresh after source mutation, with `D44` held and no product-use authority |
| GATE-MTU-H4-answer-form-question-type-routing | before answer-form/question-type lanes advance to CLI-mutation planning | yes | yes | closed `pass_with_conditions` for routing only; authorized only `MTU-H4A` bounded planning, with held Type 4 lane, `bron` as modifier, graph planning-only evidence condition, EX overlay visibility, no candidate storage, no target-exercise field writes, and no mutation or product-use authority |
| GATE-MTU-H4A-answer-form-cli-mutation-plan | before answer-form MTU lanes advance to an execution-packet sprint | yes | yes | closed `pass_with_conditions` for later bounded execution-packet preparation only; accepted `A80`, `A81`, and `A96`-`A99` for this bounded packet, rejected `A100`, kept `A71` held, required future ID-policy or namespace review, held graph/Type 4/analysis lanes, preserved `bron` modifier and EX overlay boundaries, required generator/exposure proof, and authorized no mutation or product use |
| GATE-MTU-H4B-answer-form-cli-execution | before answer-form `unit-add` execution is authorized | yes | yes | closed `pass_with_conditions`; authorized only `MTU-H4C` bounded execution for `A80`, `A81`, and `A96`-`A99`, with final preflight, exact spec/hash logging, generator-readiness rebuild/check, no exposure, held graph/Type 4/analysis lanes, visible q3/q15 EX overlays, no target-exercise field writes, no candidate storage or writes, no projection refresh as source-mutation side effect, and no product-use authority |
| GATE-ENGINE-1 | after `GAME-UX-3A`, `ENGINE-OP-1`, `SKILLMAP-OP-1`, graph/math/reasoning integration, and `GAME-ARCH-1` | yes | yes | live-output review before engine scale, Scale Gate 1 reliance, or target-equivalent checkpoint reliance on the shared route/task-shell system |
...
SYNC-4 engine operationalization roadmap/specification sync completed
...
GATE-MTU-H2D Solo q1-q3 held/conditional lane human review closed as pass_with_conditions after evidence was pushed to remote
MTU-H2E Solo q1-q3 conditional lane execution packet completed without mutation
GATE-MTU-H2E Conditional lane execution human review closed as pass_with_conditions
MTU-H2F Conditional Solo q1-q3 CLI execution
MTU-H2G A20 split/replacement packet
GATE-MTU-H2G A20 split/replacement human review
MTU-H2H A20/A94/A95 CLI-mutation planning
GATE-MTU-H2H A20/A94/A95 CLI-mutation plan human review
MTU-H2I A20/A94/A95 CLI execution packet
GATE-MTU-H2I A20/A94/A95 CLI execution human review
MTU-H2J A20/A94/A95 bounded CLI execution
MTU-H3 incidence/pass-through family review
GATE-MTU-H3 incidence/pass-through human review
MTU-H3A incidence/pass-through CLI-mutation planning
GATE-MTU-H3A incidence/pass-through CLI-mutation plan human review
MTU-H3B incidence/pass-through CLI execution packet
GATE-MTU-H3B incidence/pass-through CLI execution human review
MTU-H3C incidence/pass-through bounded CLI execution
MTU-H4 answer-form MTUs and question-type mapping
GATE-MTU-H4 answer-form/question-type routing human review closed as pass_with_conditions
MTU-H4A answer-form CLI-mutation planning packet
GATE-MTU-H4A answer-form CLI-mutation plan human review closed as pass_with_conditions
MTU-H4B answer-form bounded CLI execution packet
GATE-MTU-H4B answer-form CLI execution human review closed as pass_with_conditions
MTU-H4C answer-form bounded CLI execution completed
EX-LESSON-1 exam-ingestion end-state integration completed
GAME-UX-3A shared task-type UX foundation completed
ENGINE-OP-1 four-engine operational proof audit
SKILLMAP-OP-1 student-visible skill-map route
GRAPH-UX-2 graph game + checkpoint UI integration
MATH-UX-2 math game + checkpoint UI integration
REASON-UX-2 reasoning game variant and feedback upgrade
GAME-ARCH-1 practice engine build-vs-rebuild decision
GATE-ENGINE-1 four-engine operational integration review
...
Update 2026-05-31: `GRAPH-REFINE-1 Graph Route Operation-Chain Hardening Plan` closed PASS WITH FLAGS as planning/preparation only. It kept graph/table as the current reference pattern for local practice but found a target-chain blocker for proof use: the `1.1.3` target exercise requires price on the vertical axis and quantity on the horizontal axis, while current graph-route data still contains contradictory price-as-horizontal/x wording. The sprint produced the operation-chain plan, task-coverage matrix, implementation-prep, gate handoff, evidence checker, planning review, and lead-review cycle. `GRAPH-REFINE-2` is recommended only after explicit authorization. No implementation, generated output, target-equivalent claims, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use was authorized.

Update 2026-05-31: `REASON-REFINE-1 Reasoning Answer-Form Integration Plan` closed PASS WITH FLAGS as planning/preparation only. It kept the reasoning route and shared `structured_reasoning` task family as the correct foundation, but found that generic self-check is not answer-form proof. Future reasoning hardening must add A97/A98/A99/A81-specific criteria and feedback; `1.1.1` still needs an A98 versus held-evaluation decision before proof use; `1.1.2` D31 explanation remains blocked until coordinated with math/D31 coverage; and `1.1.3` source reasoning remains blocked until A81 scaffolding and graph-axis repair are handled. The sprint produced the answer-form integration plan, task-coverage matrix, implementation-prep, gate handoff, evidence checker, planning review, and lead-review cycle. `REASON-REFINE-2` or equivalent implementation work is recommended only after explicit authorization. `CHECK-Q2-PLAN` has since closed as planning/preparation only. No implementation, reasoning CSV edits, generated output, target-equivalent claims, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use was authorized.

Update 2026-05-31: `CHECK-Q2-PLAN Target-Equivalent Exit-Ticket Implementation Plan` closed PASS WITH FLAGS as planning/preparation only after planning review and a real lead-review cycle. It preserved the advisory short check as a separate local advice surface and defined the later target-equivalent exit-ticket design, operation-chain coverage, implementation-prep, and `GATE-L1.7B-Q2` handoff. Current state remains no target-equivalent proof for `1.1.1`, `1.1.2`, or `1.1.3`: `1.1.1` needs full A43 coverage plus A98 versus held-evaluation decision, `1.1.2` needs explicit D31 index-point versus percentage-change coverage, and `1.1.3` needs graph-axis repair plus A81 source-use with an underlying answer form. The sprint added a strict evidence checker using `git status --porcelain` guards for protected/source/generated-output surfaces. No implementation, source exit-ticket writes, generated output, target-equivalent completion language, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use was authorized.

Update 2026-06-01: `L1.7B-Q2 Exit Ticket Target-Equivalent Implementation` closed PASS WITH FLAGS as the first implementation candidate. It selected and implemented `1.1.2 Percentages en indexcijfers`, created source-controlled exit-ticket data in the historical pre-split model, generated Book 1 output through the platform deploy route, repaired landing/page copy from advisory `Korte check` language to `Exit ticket` for this candidate, kept `1.1.1` advisory-only, and added deterministic calculation-work plus D31 text-criteria checks. Current operational evidence now uses the split-surface manifest governed by `EXERCISE-EVIDENCE-CURRENTNESS-HARDENING-1`. Lead review round 1 returned REVISE for bogus calculation work and contradictory D31 matching; round 2 passed after required work-text groups, reject-text criteria, adversarial tests, and refreshed screenshots/evidence were added. The carried flag is that deterministic text-group matching is not symbolic math parsing or semantic language understanding, so `GATE-L1.7B-Q2` must explicitly review criterion sufficiency before local completion language. No paragraph-completion language, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV, Scale Gate 1, or product use was authorized.

Update 2026-06-01: `GATE-L1.7B-Q2 Exit Ticket Target-Equivalent Proof Review` packet preparation reached pre-human-review seal state after an actual lead-review cycle. The packet is ready after lead review PASS WITH FLAGS and keeps the human gate open: remote publication must still happen before interview, the reviewed commit/hash must be recorded in closure, and the human reviewer must explicitly decide whether deterministic calculation-work and D31 text criteria are sufficient for local, non-summative `1.1.2` completion language. No completion-language implementation, source-data mutation, generated-output mutation, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV, Scale Gate 1, or product use is authorized by packet preparation.

Update 2026-06-01: `GATE-L1.7B-Q2 Exit Ticket Target-Equivalent Proof Review` closed PASS WITH FLAGS at remote commit `ca2b10333d2006ebe6351b5cf649539f6f12a369`. The reviewer accepted the exact `1.1.2` target-equivalent proof candidate and approved local non-summative copy for a later exact implementation packet only: `Je hebt laten zien dat je de eindopgave van deze paragraaf aankunt.` Deterministic text-group matching remains a carried flag for broader use, but is sufficient for this reviewed local candidate. `L1.7B-Q2-COPY` is now the next active sprint. It may prepare exact copy enablement for reviewed `1.1.2` only; it may not generalize to `1.1.1`, `1.1.3`, broad exit-ticket scaling, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV, Scale Gate 1, CP-6/Year-1 reliance, or product-wide use.

Update 2026-06-01: `L1.7B-Q2-COPY Exact 1.1.2 Target-Equivalent Completion Copy Enablement` closed PASS WITH FLAGS after actual lead review. It enabled only the reviewed `1.1.2` local non-summative copy `Je hebt laten zien dat je de eindopgave van deze paragraaf aankunt.`, kept `1.1.1` advisory, kept `1.1.3` unapproved/absent, and tightened exit-ticket progress so student-level completion eligibility appears only after full reviewed proof completion. Generated Book 1 output changed through platform deploy only. No broad exit-ticket scaling, target-exercise registry promotion, CP-6/Year-1 reliance, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV, Scale Gate 1, or product-wide use is authorized.

Update 2026-06-01: `STANDARD-EXERCISES-1 Unified Standard Exercise Coverage Audit` closed PASS WITH FLAGS after planning review and lead-review cycle. It produced the exercise-family audit, coverage matrix, and checker. Math/calculation, graph/table, and reviewed `1.1.2` exit-ticket actions are covered by existing shared task-shell families, with `structured_short_response` recorded as runtime-supported but needing standard documentation/UX hardening. Reasoning remains the main expansion lane: `step_ordering`, `cause_effect_chain`, `claim_reason_evidence`, `flow_diagram_build`, `classification_with_explanation`, and `source_based_explanation` require standard-family work before reasoning can be called unified. Guided practice and procedure support remain learning/support surfaces, not target-equivalent proof. No implementation, generated output, source-data writes, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV, Scale Gate 1, or product-wide use was authorized.
...
Update 2026-06-01: added the constrained construction task-family expansion lane after the construction-task report. The roadmap now adds `TASK-FAMILY-CONSTRUCT-1`, `TASK-FAMILY-CLOZE-TILE-1`, `TASK-FAMILY-SENTENCE-1`, `TASK-FAMILY-FORMULA-1`, `TASK-FAMILY-SOURCE-1`, and `TASK-FAMILY-LABEL-1`, and broadens `GATE-TASK-FAMILY-1` to review both structured choice and construction families. The new lane adds `cloze_tile_select`, `sentence_builder`, `formula_builder`, `source_value_selection`, `source_chain_builder`, and `label_placement` so students build reasoning sentences, formulas, source chains, and graph/formula labels from constrained parts. These are operation-chain construction tasks, not decorative quiz formats; they may not be used as target-equivalent proof unless the constructed action matches the reviewed target operation.

Update 2026-06-01: `TASK-FAMILY-CHOICE-1` and `TASK-FAMILY-CONSTRUCT-1` closed as no-implementation contract sprints after planning review and lead-review cycle. They produced markdown contracts, JSON contracts, deterministic checkers, sprint metadata, and roadmap handoff for structured choice and constrained construction families. No engine implementation, generated lesson output, source-data write, protected-reference mutation, target-exercise write, target-equivalent reliance, diagnostics, adaptive routing, mastery/sequencing, summative use, PV, Scale Gate 1, or product-wide use was authorized. The next implementation lane is `TASK-FAMILY-CLOZE-TILE-1`, with `TASK-FAMILY-SENTENCE-1` and `TASK-FAMILY-FORMULA-1` next in priority after that.

Update 2026-06-01: `TASK-FAMILY-CLOZE-TILE-1` closed PASS WITH FLAGS after planning review and lead-review cycle. It implemented `cloze_tile_select` as the first construction shared task-shell family: inline blanks, selectable tile bank, distractor validation, default no-reuse behavior, exact `{ blanks: { blankId: tileId } }` matching, shared UI helpers, exit-ticket/skilltree/graph wrapper collection, focused tests, rendered report fixture, proof JSON, and deterministic checker. Round 1 caught and corrected permissive raw-map matching; round 2 passed with flags. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, adaptive routing, mastery/sequencing, summative use, PV, Scale Gate 1, or product-wide use was authorized. Carried flag: require product-route screenshots before adoption.

Update 2026-06-01: `TASK-FAMILY-SENTENCE-1` closed PASS WITH FLAGS after planning review and lead-review cycle. It implemented `sentence_builder` as the second construction shared task-shell family: fragment bank, ordered construction zone, clear/remove/reorder controls, distractor validation, default no-reuse behavior, exact `{ tokens: ["tokenId"] }` matching, accepted sequence validation, shared UI helpers, exit-ticket/skilltree/graph wrapper collection, focused tests, rendered report fixture, proof JSON, and deterministic checker. Round 1 and round 2 passed with carried flags. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, adaptive routing, mastery/sequencing, summative use, PV, Scale Gate 1, or product-wide use was authorized. Carried flags: product-route screenshots and rendered after-click interaction proof remain required before adoption.

Update 2026-06-01: `TASK-FAMILY-FORMULA-1` closed PASS WITH FLAGS after planning review and lead-review cycle. It implemented `formula_builder` as the third construction shared task-shell family: formula-block bank, ordered construction zone, formula category metadata, clear/remove/reorder controls, distractor validation, default no-reuse behavior, exact `{ tokens: ["tokenId"] }` matching including extra-key rejection, accepted sequence validation, shared UI helpers, exit-ticket/skilltree/graph wrapper collection, focused tests, rendered report fixture, proof JSON, and deterministic checker. Round 1 returned REVISE for exact response-shape weakness; corrections rejected extra response keys and round 2 passed with flags. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, adaptive routing, mastery/sequencing, summative use, PV, Scale Gate 1, or product-wide use was authorized. Carried flags: route-specific rendered proof required before product-route adoption; formula equivalence beyond exact sequences needs domain-reviewed evaluator work; calculation execution remains a separate calculation-work task.

Update 2026-06-01: `TASK-FAMILY-CLOZE-1` closed PASS WITH FLAGS after planning review and lead-review cycle. It implemented `cloze_text` as the first typed structured-choice shared task-shell family: inline typed blanks, accepted-value matching, bounded `requiredTextGroups`, per-blank `rejectText`, exact `{ blanks: { blankId: text } }` matching including raw-map and extra-key rejection, shared UI helper, exit-ticket/skilltree/graph wrapper collection, focused tests, rendered report fixture, proof JSON, and deterministic checker. Round 1 and round 2 passed with carried flags. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, adaptive routing, mastery/sequencing, summative use, PV, Scale Gate 1, or product-wide use was authorized. Carried flags: route-specific rendered proof required before product-route adoption; `requiredTextGroups` is bounded phrase matching, not broad semantic answer evaluation.

Update 2026-06-01: `TASK-FAMILY-MULTI-1` closed PASS WITH FLAGS after planning review and lead-review cycle. It implemented `multi_select` as the next structured-choice shared task-shell family: exact-set order-insensitive matching, strict string-only `{ values: ["optionId"] }` response shape, duplicate/unknown/extra-key/raw-array rejection, required non-empty group label, required distractor option, practice-only partial feedback with missing required options, selected distractors, and already-correct selections, distinct `.ts-multi-option` / `data-multi-option-id` UI, shared helper delegation for exit-ticket/skilltree/graph wrappers, focused tests, rendered report fixture, proof JSON, and deterministic checker. Round 1 returned REVISE for numeric/object response-id coercion; corrections rejected non-string response ids and round 2 passed with flags. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, adaptive routing, mastery/sequencing, summative use, PV, Scale Gate 1, or product-wide use was authorized. Carried flags: route-specific rendered proof required before product-route adoption; multi-select is only for reviewed complete-set actions and cannot replace richer target-operation proof.

Update 2026-06-01: `TASK-FAMILY-ORDER-1` closed PASS WITH FLAGS after planning review and lead-review cycle. It implemented `step_ordering` as the next structured-choice shared task-shell family: answer/distractor step-bank schema, required at least two answer steps and one distractor, no neutral-step or no-distractor exemption, `expected.order` coverage of every answer step exactly, exact `{ order: ["stepId"] }` response matching with raw-array, array-with-`order`, non-string id, duplicate id, unknown id, missing-key, and extra-key rejection, order-sensitive deterministic matching, practice-only order feedback, distinct `.ts-step-*` selectors, shared helper delegation for exit-ticket/skilltree/graph wrappers, focused tests, rendered report fixture, proof JSON, and deterministic checker. Planning review round 1 returned REVISE for ambiguous neutral/no-distractor semantics; code lead-review round 1 returned REVISE for the array-with-`order` loophole; corrections resolved both and round 2 passed with flags. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, adaptive routing, mastery/sequencing, summative use, PV, Scale Gate 1, or product-wide use was authorized. Carried flags: route-specific rendered proof required before product-route adoption; `step_ordering` proves procedure control only and cannot replace final calculation, graph/table, source-chain, or constructed-response proof.

Update 2026-06-01: `TASK-FAMILY-SOURCE-1` closed PASS WITH FLAGS after planning review and lead-review cycle. It implemented `source_value_selection` and `source_chain_builder` as deterministic shared task-shell families: source value banks with role selectors, ordered source -> value -> operation -> answer -> conclusion construction, required distractors, required chain node roles, exact `{ selections: [{ valueId, role }] }` and `{ chain: ["nodeId"] }` response-shape matching, raw-array and array-with-key rejection, omitted answer value/node rejection, practice-only source feedback, distinct `.ts-source-*` selectors, shared helper delegation for exit-ticket/skilltree/graph wrappers, focused tests, rendered report fixture, proof JSON, and deterministic checker. Lead review round 1 returned REVISE for result-report schema; corrections resolved this and round 2 passed with flags. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, adaptive routing, mastery/sequencing, summative use, PV, Scale Gate 1, or product-wide use was authorized. Carried flags: route-specific rendered proof required before product-route adoption; `source_chain_builder` proves source/control construction only and is not target-equivalent proof without paired operation tasks and later review.

Update 2026-06-01: `TASK-FAMILY-LABEL-1` closed PASS WITH FLAGS after planning review and lead-review cycle. It implemented `label_placement` as a deterministic shared task-shell family: label bank, visual target region, target buttons, placement summary, exact `{ placements: [{ labelId, targetId }] }` response-shape matching, raw-array and array-with-`placements` rejection, non-string/unknown/duplicate label and target rejection, strict label/target description and `distractorFor` validation, target-role enum and coordinate bounds, all answer-label/target coverage, practice-only label feedback, distinct `.ts-label-*` selectors, shared helper delegation for exit-ticket/skilltree/graph wrappers, focused tests, rendered report fixture, proof JSON, and deterministic checker. Lead review round 1 returned REVISE for missing symmetric negative coverage; corrections resolved this and round 2 passed with flags. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, adaptive routing, mastery/sequencing, summative use, PV, Scale Gate 1, or product-wide use was authorized. Carried flags: route-specific rendered proof required before product-route adoption; `label_placement` is representation-placement support only and is not complete graph/table target-equivalent proof without paired operation tasks and later review.

Update 2026-06-02: `TASK-FAMILY-MATCH-1` closed PASS WITH FLAGS after planning review and lead-review cycle. It implemented `matching_pairs` as a deterministic shared task-shell family: left/right item banks, required descriptions, same-bank distractors, one-to-one answer coverage, exact `{ pairs: [[leftId, rightId]] }` response-shape matching, raw-array and array-with-`pairs` rejection, object-pair and wrong-length pair rejection, non-string/unknown/duplicate/omitted/distractor/extra-key rejection, order-insensitive exact pair-set matching, practice-only feedback, distinct `.ts-match-*` selectors, shared helper delegation for exit-ticket/skilltree/graph wrappers, focused tests, rendered report fixture, proof JSON, deterministic checker, and historical read-only invariant for `knowledge/exit-ticket-game-1.1.1.zip`. Lead review round 1 and round 2 passed with flags. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, adaptive routing, mastery/sequencing, summative use, PV, Scale Gate 1, or product-wide use was authorized. Carried flags: route-specific rendered proof required before product-route adoption; Many-to-one matching unsupported; conditional capability note only; `matching_pairs` is practice/advisory support and cannot replace richer target-operation proof without later review.

Update 2026-06-02: `TASK-FAMILY-TWO-TIER-1` closed PASS WITH FLAGS after planning review and lead-review cycle. It implemented `two_tier_choice` as a deterministic shared task-shell family: separate answer and reason option banks, required descriptions, minimum two options per tier, duplicate-id rejection within each tier and across tiers, exact `{ answer: answerOptionId, reason: reasonOptionId }` response-shape matching, answer-only and reason-only rejection, wrong-answer/correct-reason and correct-answer/wrong-reason rejection, raw-string/raw-array/nested-object/non-string/unknown/cross-tier/extra-key rejection, neutral practice-only answer/reason/combination feedback, distinct `.ts-two-tier-*` selectors, shared helper delegation for exit-ticket/skilltree/graph wrappers, focused tests, rendered report fixture, proof JSON, deterministic checker, and historical read-only invariant for `knowledge/exit-ticket-game-1.1.1.zip`. Lead review round 1 and round 2 passed with flags. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, adaptive routing, mastery/sequencing, summative use, PV, Scale Gate 1, or product-wide use was authorized. Carried flags: route-specific rendered proof required before product-route adoption; `two_tier_choice` feedback must not become diagnostic or misconception-profile output; it is practice/advisory support and cannot replace constructed-response or target-equivalent proof without later review.

Update 2026-06-02: `TASK-FAMILY-ASSERTION-1` closed PASS WITH FLAGS after planning review and lead-review cycle. It implemented `assertion_reason` as a deterministic shared task-shell family for sparse reviewed assertion/reason relation judgement: required assertion and reason text, labelled relation option bank, minimum four described relation options, duplicate-id rejection, exact `{ value: optionId }` response-shape matching, missing/empty/wrong/raw-string/raw-array/array-with-value/nested-object/non-string/unknown/alternate-key/extra-key rejection, neutral practice-only selected/expected relation feedback, distinct `.ts-assertion-*` selectors, shared helper delegation for exit-ticket/skilltree/graph wrappers, focused tests, rendered report fixture, proof JSON, deterministic checker, and historical read-only invariant for `knowledge/exit-ticket-game-1.1.1.zip`. Lead review round 1 and round 2 passed with flags. No generated lesson output, source-data writes, product-route adoption, target-equivalent reliance, diagnostics, adaptive routing, mastery/sequencing, summative use, PV, Scale Gate 1, or product-wide use was authorized. Carried flags: route-specific rendered proof required before product-route adoption; `assertion_reason` feedback must not become diagnostic or misconception-profile output; it may not become generic quiz variety, default reasoning-game format, constructed-response replacement, or target-equivalent proof.

Update 2026-06-02: `GATE-TASK-FAMILY-1 Structured Choice And Construction Task-Family Review` closed PASS WITH FLAGS at reviewed remote commit `e35b7c58eded4d4d4544fbd39f8c5365a58785c9` after direct packet comments. The reviewer accepted all twelve structured choice and constrained construction families only as planning input for later bounded adoption-preparation sprints. Closure recorded no core-specification failure and no product authority. Carried flags: compact repair controls remain an adoption/accessibility polish issue; product-route adoption still needs route-specific rendered proof; target-equivalence remains separate from task-family readiness; human-precheck corrections for Tasks 3, 10, 11, and 12 must remain guarded; family-specific limits around exact formula sequences, many-to-one matching, source-chain/label-placement proof, and non-diagnostic feedback must carry forward. Authorized next: named downstream planning/adoption-preparation only, especially route-specific planning for `GAME-ROUTE-AFFORDANCE-1`, `REASON-STD-1`, and later check/scale proof lanes. Not authorized: generated lesson output, source-data mutation, engine implementation from this gate, product-route adoption, target-equivalent completion language, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV, Scale Gate 1, or student/product use.
...
-> CI-GATE-PROOF-1
-> CI-GOVERNANCE-1
-> AGENT-BRANCH-SAFETY-1
-> AGENT-WORKTREE-SAFETY-1
-> GATE-SHARED-TASK-INGEST-REPAIR-1
-> SHARED-TASK-INGEST-PLAYABLE-REPAIR-1
