...
Roadmap version: `v3.40-check-short-exit1-inventory`
...
Next action: proceed to `STANDARD-EXERCISES-1` as the next audit/contract
sprint under the Product Proof Track.
