...
| Sprint | Name | Completed | Current State |
|--------|------|-----------|---------------|
| PART-A-TEXTBOOK-EXERCISE-STRUCTURE-1 | Book 2+ Part A Paper-Only Exercise Authoring Contract | yes | Implementation complete with renewed teacher-learning-quality `PASS` (12/12) after TLQ-R1/R2 closure. The platform-only contract requires the exact seven printed `##` headings, a maximum-five-point non-heading summary before Startopgaven, the short paper route plus always-printed guided support, target-aligned fading, an actual 55-minute whole-lesson proof, and no website/device/internal-term dependency. All 13 required mutations plus two contradiction probes pass; focused tests pass 49/49, local platform tests pass 106 suites/1,606 tests, exact-head CI run `33369460856` passed, and the lesson checkout remains clean at `f09fd6e...`. Renewed lead `REVISE` accepted the implementation and limited LREV-R4/LREV-R5 to stale closure evidence/readiness metadata; the evidence correction is recorded for bounded recheck. No `4veco-lessen`, Book 1, Book 2 paragraph output, Part B redesign, protected reference mutation, schema-role migration, merge, or production authority. |
