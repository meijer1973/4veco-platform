...
| TASK-FAMILY-CLOZE-TILE-1 | Cloze Tile-Select Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, and lead-review records. No generated lesson output or product-route adoption. Flags: product-route screenshots are deferred to adoption. |
| TASK-FAMILY-SENTENCE-1 | Sentence Builder Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, and lead-review records. No generated lesson output or product-route adoption. Flags: product-route screenshots and dynamic rendered interaction proof are deferred to adoption. |
| TASK-FAMILY-FORMULA-1 | Formula Builder Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support, formula category validation, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, and lead-review records. Round 1 returned REVISE for extra response keys being accepted; corrections resolved this and round 2 passed with flags. No generated lesson output or product-route adoption. Flags: product-route screenshots and dynamic rendered interaction proof are deferred to adoption; formula equivalence beyond exact sequences and calculation execution remain separate follow-up work. |
...
| TASK-FAMILY-MULTI-1 | Multi-Select Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support, strict exact-set matching, practice-only partial feedback, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, and lead-review records. Round 1 returned REVISE for numeric/object response-id coercion; corrections resolved this and round 2 passed with flags. No generated lesson output or product-route adoption. Flags: product-route screenshots and after-click rendered proof are deferred to adoption; multi-select cannot replace richer target-operation proof. |
| TASK-FAMILY-ORDER-1 | Step-Ordering Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support, strict order-sensitive matching, practice-only order feedback, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, and lead-review records. Round 1 returned REVISE for array-with-`order` response-shape acceptance; corrections resolved this and round 2 passed with flags. No generated lesson output or product-route adoption. Flags: product-route screenshots and after-click rendered proof are deferred to adoption; `step_ordering` is procedure-control proof only. |
| TASK-FAMILY-SOURCE-1 | Source Value And Chain Builder Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support for `source_value_selection` and `source_chain_builder`, strict validation/matching, practice-only feedback, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, and lead-review records. Round 1 returned REVISE for result-report schema; corrections resolved this and round 2 passed with flags. No generated lesson output or product-route adoption. Flags: generated-route screenshots remain required before adoption; source-chain construction is not target-equivalent proof without paired operation tasks and later review. |
| TASK-FAMILY-LABEL-1 | Label-Placement Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support for `label_placement`, strict validation/matching, practice-only feedback, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, and lead-review records. Round 1 returned REVISE for missing symmetric negative coverage; corrections resolved this and round 2 passed with flags. No generated lesson output or product-route adoption. Flags: generated-route screenshots remain required before adoption; label placement is representation-placement support only. |
| TASK-FAMILY-MATCH-1 | Matching-Pairs Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support for `matching_pairs`, one-to-one-only validation, strict exact response matching, practice-only feedback, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, old exit-ticket archive no-change evidence, and lead-review records. Round 1 and round 2 passed with flags. No generated lesson output or product-route adoption. Flags: generated-route screenshots remain required before adoption; many-to-one matching is deferred; matching pairs cannot replace richer target-operation proof. |
| TASK-FAMILY-TWO-TIER-1 | Two-Tier Choice Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support for `two_tier_choice`, strict answer-plus-reason validation, practice-only feedback, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, old exit-ticket archive no-change evidence, and lead-review records. Round 1 and round 2 passed with flags. No generated lesson output or product-route adoption. Flags: generated-route screenshots remain required before adoption; feedback must not become diagnostic or misconception-profile output; two-tier choice cannot replace richer target-operation proof. |
| TASK-FAMILY-ASSERTION-1 | Assertion-Reason Task-Family Implementation | yes | Closed PASS WITH FLAGS runtime implementation sprint. Produced shared task-shell engine/UI/CSS support for `assertion_reason`, strict relation-option validation, exact `{ value }` response matching, practice-only feedback, wrapper collection support, focused tests, rendered fixture, proof JSON, checker, old exit-ticket archive no-change evidence, and lead-review records. Round 1 and round 2 passed with flags. No generated lesson output or product-route adoption. Flags: generated-route screenshots remain required before adoption; feedback must not become diagnostic or misconception-profile output; assertion-reason cannot replace constructed response, target-equivalent proof, or richer reasoning tasks. |
