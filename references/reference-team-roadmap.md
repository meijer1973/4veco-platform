...
| Sprint | Name | Completed | Current State |
|--------|------|-----------|---------------|
| BLUEPRINT-BOOK1-EDITION-BOUNDARY-1 | Book 1 Edition Boundary and Part A Compatibility Repair | yes | Local implementation/evidence complete on PR #222 at substantive head `bb21d53e...`: the owned preview policy now inherits the Book 2+ Part A target-operation, seven-section, paper-route, and 55-minute contract; it cannot manufacture `Covered` status, mastery, or an untargeted independent operation. The focused checker passes 32 mutations, the full suite passes 107 suites/1,653 tests, teacher review passes 14/14, and lead round 1 passes. Exact-head hosted CI, readiness, owner authorization, governed integration, and post-merge CI remain required. Book 1 and all lesson output stay unchanged; Issue #223 remains planning-only until this prerequisite is integrated. |
