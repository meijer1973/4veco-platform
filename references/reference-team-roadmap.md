...
Next action: proceed to `TASK-FAMILY-ASSERTION-1` as the next structured-choice
implementation sprint, or to `GAME-ROUTE-AFFORDANCE-1` if
route affordance is the priority. The closed `TASK-FAMILY-CLOZE-TILE-1`,
...
`TASK-FAMILY-LABEL-1`, `TASK-FAMILY-MATCH-1`, and
`TASK-FAMILY-TWO-TIER-1`
