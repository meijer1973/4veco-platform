...
| Sprint | Name | Completed | Current State |
|--------|------|-----------|---------------|
| PART-A-TEXTBOOK-EXERCISE-STRUCTURE-1 | Book 2 Part A Exercise Authoring Contract | no | Active platform-only authoring-contract sprint for issue 218. Align the seven-section printed Part A sequence, route-aware 55-minute lesson guidance, backward target-operation alignment, differentiation, bonus/review distinction, and Book 1 non-retroactivity across active guidance; add a focused CI guardrail. No `4veco-lessen`, Book 1, Book 2 paragraph output, Part B redesign, protected reference mutation, schema-role migration, merge, or production authority. |
