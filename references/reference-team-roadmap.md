...
| Sprint | Name | Completed | Current State |
|--------|------|-----------|---------------|
| PART-A-TEXTBOOK-EXERCISE-STRUCTURE-1 | Book 2+ Part A Paper-Only Exercise Authoring Contract | no | Reopened after exact-head review at `15106b64...` found two inherited target-alignment contradictions and incomplete Dutch no-device mutations. The source/checker repair now aligns all five fading surfaces, retains target-supplied representations, rejects target-absent production and unconditional visual removal, covers nine Dutch printed device/digital phrases, and renumbers the paragraph checklist. Contract/lane tests pass 64/64 and local platform tests pass 106 suites/1,621 tests; prior teacher/lead outcomes are preserved but cannot close the new substantive payload. New substantive teacher and lead reviews, synchronized final evidence, exact-final-head CI, and readiness routing are required. The lesson checkout remains clean at `f09fd6e...`; no `4veco-lessen`, Book 1, Book 2 paragraph output, Part B redesign, protected reference mutation, schema-role migration, merge, or production authority. |
