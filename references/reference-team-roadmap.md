...
the active playable-repair sequence, currently
`SHARED-TASK-INGEST-PLAYABLE-REPAIR-3`, or a human waiver explicitly records
consequences. `REV-STD-1` remains required before Scale Gate 1. The approved
