...
Next action after `CHECK-SURFACE-PREGATE-1`: prepare
`GATE-CHECK-SHORT-EXIT-2-RETRY` as a direct human review packet unless the
roadmap owner explicitly reorders. Do not start
