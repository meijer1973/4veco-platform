...
Roadmap version: `v2.86-mtu-h2-solo-micro-case-review`
...
|--------|------|-----------|---------------|
| GATE-MTU-H2 | Solo q1-q3 Micro-Case Human Review | no | **ACTIVE OPERATIONAL NEXT ACTION.** Run the formal human review for the MTU-H2 Solo q1-q3 canonical micro-case package before any mutation planning or CLI execution. Evidence: `reports/mtu-hardening/solo-q1-q3-canonical-cases.*` and `reports/review-gates/GATE-MTU-H2-solo-q1-q3-micro-cases/review-packet.*`. The gate may decide which q1/q2/q3 candidate lanes move to later bounded CLI-mutation planning, but it does not itself authorize hand edits to `references/machine/` or `references/external/`, unit minting, candidate writes, lesson-output mutation, CP-6/Year-1 closure, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV projection, PV machine promotion, or student-facing output. |
