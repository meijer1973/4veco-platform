...
| `H-234-PLACEHOLDER` | open | `paragraph:2.3.4` | `approved_goal_use`, `paragraph_production`, `lesson_authoring`, `merge` | `goal_design`, `target_design`, `specialist_review`, `target_authority_repair`, `target_authority_integration` | `target_authority_integration` | blocked_baseline_sha256=601f73e3ed958b4b6257e3ccad0a08c44138b2a2fa310bbcee8beedc120e856f; candidate_replacement_sha256=2ac151882b64b0d990ce5627ae35388d72eefde74c4e24562ef9a49a9355672c; candidate_package_sha256=32f5325a542445eb093b0e645304afae7542b2c92e491c8bd09ace9fefa71441; candidate_evidence_ref=references/data/sprints/BOOK2-TARGET-AUTHORITY-REMEDIATION-1.candidates.json; candidate_status=specialist_reviewed_candidate; approved_replacement_sha256=pending; approval_ref=pending; approved_by=pending; approved_on=pending | The owner approves this exact candidate record as part of the exact twelve-record package; the approved binding is recorded, the target is integrated, post-integration checks pass, and the integration commit is recorded. | — |
...
| `H-229-EI-SUPERSESSION` | open | `paragraph:2.2.3` | `approved_goal_use`, `target_authority_integration`, `paragraph_production`, `lesson_authoring`, `merge` | `outline_owner_decision`, `goal_design`, `target_design`, `specialist_review`, `target_authority_repair` | `outline_owner_decision` | — | The owner decides an exact semantic outline supersession or rejects it, and the target package is aligned to that exact decision without rewriting historical approval evidence. | — |
