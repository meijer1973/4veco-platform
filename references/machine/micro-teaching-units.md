...
<!-- STATS LINE -->
*143 live units as of 2026-04-20 — A=37, D=29, E=6, F=15, G=11, H=26, I=19.*
...
- prior_learning: new_this_year
- aspects: [verbaal]
- terms: [GA-curve, MB-curve, arbeidsaanbod (= beroepsbevolking), rente]
- procedure:
...
- prior_learning: new_this_year
- aspects: [verbaal]
- terms: [monetair beleid (rentebeleid), wisselkoers]
...
- prior_learning: new_this_year
- aspects: [verbaal]
- terms: [investeringen, monetair beleid (rentebeleid)]
