...
<!-- STATS LINE -->
*254 live units as of 2026-09-21 — A=98, B=2, D=44, E=7, F=20, G=12, H=30, I=20, L=21.*
<!-- STATS END -->
...
### A12 MO bepalen met afgeleide
- layer: 2
- duration_min: 5
- kern: "Bepaal marginale opbrengst door eerst TO op te stellen en daarvan de afgeleide naar Q te nemen."
- needs: [A11, A07]
- exam_codes: [A2.11, A2.10, A2.12]
- mastery_target: apply
- prior_learning: new_this_year
- aspects: [grafisch, rekenen]
- terms: []
- procedure:
  1. Stel de TO-functie op via TO = P x Q.
  2. Bepaal MO als afgeleide van TO naar Q.
  3. Controleer het type: bij volkomen concurrentie is MO = P; bij een lineaire monopolieprijsfunctie P = a - bQ is MO = a - 2bQ.
  4. Gebruik deze MO-functie later in de passende MO = MK-route.
- pitfalls:
...
- procedure:
  1. Noteer de oude en nieuwe waarden van P en Q uit dezelfde respectievelijke situaties.
  2. Bereken %ΔQv = (ΔQv / Qv_oud) × 100% en %ΔP = (ΔP / P_oud) × 100% met correct teken.
  3. Bereken Ev = %ΔQv / %ΔP met teken; bij %ΔP = 0 is dit gemeten quotiënt niet gedefinieerd.
  4. Interpreteer het teken en vergelijk Ev rechtstreeks met −1 en 0: Ev < −1 is elastisch, −1 < Ev < 0 is inelastisch, Ev = −1 is unitair elastisch en Ev = 0 is volkomen inelastisch (geen hoeveelheidsreactie).
  5. Gebruik deze indeling alleen bij de gewone eigen-prijsvraag met overige factoren gelijk; een positieve verhouding bij meerdere veranderende factoren bewijst geen eigen-prijseffect. Behoud de ongeronde Ev bij de indeling.
- pitfalls:
  - Het minteken vergeten of negatief verwarren met inelastisch.
  - Een extra absolute-waardestap verplicht stellen; beoordeel berekening, indeling en economische betekenis.
- generator: GEN_A15
...
- procedure:
  ...
  2. Bereken Ei = %ΔQ / %ΔY.
  3. Interpreteer met de drie canonieke categorieën: Ei < 0 = inferieur goed, 0 < Ei < 1 = normaal goed, Ei > 1 = luxegoed. Ei = 0 en Ei = 1 zijn grenswaarden; ken zonder aanvullende autoriteit geen categorie toe.
...
### A20 Winstmaximum oplossen met afgeleide MO en MK
- layer: 3
- duration_min: 5
...
- terms: [marginale-kosten]
- procedure:
  1. Bepaal MO via de afgeleide route uit TO.
  2. Bepaal MK via de afgeleide route uit TK.
  3. Stel MO = MK.
  4. Los op naar Q*.
  5. Gebruik Q* daarna in de passende prijs-, opbrengst- of winstroute.
- pitfalls:
...
- terms: []
- procedure:
  1. Lees de titel en bepaal dat de grafiek totale opbrengsten en totale kosten van een producent toont.
  2. Controleer de horizontale as, verticale as, eenheden en schaal.
  3. Identificeer welke lijn of kromme TO is en welke lijn of kromme TK is, via labels of legenda.
  4. Zoek het snijpunt of de snijpunten waar TO en TK gelijk zijn.
  5. Lees de bijbehorende hoeveelheid Q op de horizontale as af.
  6. Interpreteer dit punt als break-even: de totale winst is nul.
- pitfalls:
  - De grootste verticale afstand tussen TO en TK markeren als break-even.
  - Een winstgebied of verliesgebied verwarren met het snijpunt.
  - Niet controleren of er een of twee break-evenpunten zijn.
- generator: GEN_A77
...
- procedure:
  ...
  2. Controleer de horizontale as, verticale as, eenheden en schaal.
  3. Identificeer welke lijn of kromme TO is en welke lijn of kromme TK is, via labels of legenda.
  4. Kies de gevraagde hoeveelheid Q en lees TO en TK bij diezelfde hoeveelheid af.
  5. Bepaal de verticale afstand: TO min TK.
  6. Interpreteer de uitkomst: TO boven TK betekent winst, TO onder TK betekent verlies, en TO gelijk aan TK betekent break-even.
- pitfalls:
  - Horizontale afstand lezen in plaats van verticale afstand.
  - TO en TK bij verschillende hoeveelheden vergelijken.
  - Alleen kijken welke lijn hoger ligt zonder de schaal of eenheden te controleren.
- generator: GEN_A78
...
- zero_needs_review: {"reviewed_on":"2026-05-29","reviewer":"GATE-MTU-H4A planning review","rationale":"Answer-form wrapper for concise identification; it combines with whichever content/source unit supplies the item.","recommended_needs":[],"severity":"low"}
- procedure:
  1. Onderstreep wat precies genoemd of aangewezen moet worden.
  2. Bepaal hoeveel items of welk soort kenmerk de vraag vraagt.
  3. Geef alleen de gevraagde items, termen, actoren, brongegevens of richtingen.
  4. Gebruik dezelfde taal of labels als de vraag of bron wanneer dat controleerbaar is.
  5. Voeg geen extra redenering toe tenzij de vraag daar apart om vraagt.
- pitfalls:
...
- needs: []
- exam_codes: [A1.1, A1.5]
- mastery_target: apply
- prior_learning: new_this_year
- aspects: [verbaal, grafisch]
- terms: []
- zero_needs_status: true_zero
- zero_needs_review: {"reviewed_on":"2026-05-29","reviewer":"GATE-MTU-H4A planning review","rationale":"Answer-form modifier for source use, not a standalone complete answer form; underlying answer-form and content units remain mapped separately.","recommended_needs":[],"severity":"low"}
- procedure:
  1. Lees welke bron, tabel, figuur of tekstregel de vraag aanwijst.
  2. Noteer de relevante bronobservatie met label, periode, eenheid of richting.
  3. Zeg wat die observatie economisch betekent.
  4. Verbind de bronobservatie met de onderliggende antwoordvorm, zoals uitleg, berekening, classificatie of grafiek.
  5. Controleer dat het antwoord niet stopt bij alleen citeren of aflezen.
- pitfalls:
...
- terms: []
- procedure:
  1. Lees de vraag en bepaal welke prijs- en hoeveelheidsvariabelen bij de elasticiteit horen.
  2. Selecteer in de tabel de oude prijs, oude hoeveelheid, nieuwe prijs en nieuwe hoeveelheid en controleer rij, kolom, periode en eenheid.
  3. Controleer dat oude prijs en oude hoeveelheid bij dezelfde situatie horen en dat nieuwe prijs en nieuwe hoeveelheid bij dezelfde situatie horen.
  4. Label per variabele de basiswaarde en vergelijkingswaarde.
  5. Bereken de procentuele verandering van Q en van P met telkens de oude waarde als noemer en behoud het teken.
  6. Bereken Ev = procentuele verandering Q gedeeld door procentuele verandering P; bij een prijsverandering van 0% is het quotiënt niet gedefinieerd.
  7. Interpreteer het teken en vergelijk Ev rechtstreeks met −1 en 0: Ev < −1 is elastisch, −1 < Ev < 0 is inelastisch, Ev = −1 is unitair elastisch en Ev = 0 is volkomen inelastisch (geen hoeveelheidsreactie). Leg de economische betekenis uit.
  8. Gebruik deze indeling alleen bij de gewone eigen-prijsvraag met overige factoren gelijk; een positieve verhouding bij meerdere veranderende factoren bewijst geen eigen-prijseffect. Behoud de ongeronde Ev bij de indeling.
- pitfalls:
  ...
  - Het teken negeren of een negatieve Ev zonder vergelijking met −1 en 0 als inelastisch indelen.
- generator: GEN_A82
...
- terms: []
- procedure:
  1. Lees de titel en bepaal dat de grafiek een vraagrelatie tussen prijs en gevraagde hoeveelheid toont.
  2. Controleer horizontale as, verticale as, eenheden, schaal en directe labels of legenda.
  3. Kies twee punten of twee situaties die bij de vraag horen en bepaal of de waarden exact of geschat moeten worden afgelezen.
  4. Lees bij elk punt de prijs en hoeveelheid af en noteer beide P,Q-paren.
  5. Bepaal voor prijs en hoeveelheid welke waarde oud of basis is en welke waarde nieuw of vergelijking is.
  6. Bereken de procentuele verandering van Q en van P met telkens de oude waarde als noemer en behoud het teken.
  7. Bereken Ev = procentuele verandering Q gedeeld door procentuele verandering P; bij een prijsverandering van 0% is het quotiënt niet gedefinieerd.
  8. Interpreteer het teken en vergelijk Ev rechtstreeks met −1 en 0: Ev < −1 is elastisch, −1 < Ev < 0 is inelastisch, Ev = −1 is unitair elastisch en Ev = 0 is volkomen inelastisch (geen hoeveelheidsreactie). Controleer of de uitkomst past bij de grafiek.
  9. Gebruik deze indeling alleen bij de gewone eigen-prijsvraag met overige factoren gelijk; een positieve verhouding bij meerdere veranderende factoren bewijst geen eigen-prijseffect. Behoud de ongeronde Ev bij de indeling.
- pitfalls:
...
- kern: "Beoordeel omzet met brongegevens: pas de elasticiteitsregel lokaal bij kleine eigen-prijsveranderingen toe en bereken bij eindige veranderingen TO = P × Q vóór en na; onderscheid omzet van winst."
- needs: [A15, A67]
- mastery_target: apply
- prior_learning: new_this_year
- aspects: [rekenen, verbaal]
- terms: []
- procedure:
  1. Lees uit de bron welke prijsverandering, hoeveelheidsverandering of elasticiteitswaarde gegeven is.
  2. Interpreteer het teken en vergelijk Ev rechtstreeks met −1 en 0: Ev < −1 is elastisch, −1 < Ev < 0 is inelastisch, Ev = −1 is unitair elastisch en Ev = 0 is volkomen inelastisch (geen hoeveelheidsreactie).
  3. Bij kleine veranderingen rond de huidige situatie geldt lokaal: bij elastische vraag beweegt omzet tegengesteld aan de prijs; prijs omhoog betekent omzet omlaag en omgekeerd.
  4. Lokaal bij −1 < Ev ≤ 0: bij inelastische vraag beweegt omzet mee met de prijs; prijs omhoog betekent omzet omhoog en omgekeerd. Ev = 0 betekent geen hoeveelheidsreactie.
  5. Lokaal bij Ev = −1: bij unitair elastische vraag blijft omzet ongeveer gelijk omdat de procentuele effecten elkaar ongeveer compenseren.
  6. Bij gegeven oude en nieuwe P en Q: gebruik TO = P maal Q vóór en na, met correct gepaarde waarden. Een eindige omzetverandering is niet exact de som van de procentuele prijs- en hoeveelheidsverandering.
  7. Controleer teken, ongeronde indeling, context en economische betekenis; onderbouw met de bron. Omzet is geen winst zonder kosten.
  8. Gebruik deze indeling alleen bij de gewone eigen-prijsvraag met overige factoren gelijk; een positieve verhouding bij meerdere veranderende factoren bewijst geen eigen-prijseffect. Behoud de ongeronde Ev bij de indeling.
- pitfalls:
  ...
  - Een lokale omzetregel zonder narekenen toepassen op een eindige verandering; P 10→12 en Q 100→82 geven Ev = −0,9 maar TO 1000→984.
- generator: GEN_A84

### A85 Totale opbrengst puntberekening: TO = P x Q
- kern: "Bereken totale opbrengst uit een enkele prijs en hoeveelheid zonder eerst een volledige TO-functie op te stellen."
- needs: [A04]
- exam_codes: [A2.1]
- mastery_target: apply
- prior_learning: new_this_year
...
- terms: []
- procedure:
  1. Bepaal de prijs P en hoeveelheid Q die bij dezelfde situatie horen.
  2. Noteer TO = P x Q.
  3. Vul P en Q in en bereken de totale opbrengst.
  4. Controleer of aantallen, geldbedragen en schaalfactoren bij elkaar passen.
- pitfalls:
  - Een volledige TO-functie opstellen terwijl alleen een puntberekening nodig is.
  - P en Q uit verschillende situaties combineren.
- generator: GEN_A85

### A86 TVK berekenen uit constante variabele kosten
- kern: "Bereken totale variabele kosten door constante variabele kosten per stuk met de hoeveelheid te vermenigvuldigen."
- needs: [A04]
- exam_codes: [A2.1, A2.11]
- mastery_target: apply
- prior_learning: new_this_year
...
- terms: [variabele-kosten]
- procedure:
  1. Bepaal de variabele kosten per stuk of constante MK uit de opgave.
  2. Bepaal de hoeveelheid Q.
  3. Noteer TVK = variabele kosten per stuk x Q.
  4. Bereken TVK en controleer schaal en eenheid.
- pitfalls:
  - Variabele kosten per stuk behandelen als totale variabele kosten.
  - Constante kosten optellen voordat de vraag daarom vraagt.
- generator: GEN_A86

### A87 Onbekende vaste kosten berekenen uit winstvergelijking
- kern: "Los W = TO - (TVK + TCK) op naar de onbekende vaste kosten wanneer winst, opbrengst en variabele kosten bekend zijn."
- needs: [A02, A85, A86]
- exam_codes: [A2.1, A2.11]
- mastery_target: apply
- prior_learning: new_this_year
...
- terms: [winst]
- procedure:
  1. Noteer de winstvergelijking W = TO - (TVK + TCK).
  2. Vul W, TO en TVK in met dezelfde schaal en periode.
  3. Herschrijf de vergelijking zodat TCK alleen staat.
  4. Bereken TCK en geef de uitkomst met geldbedrag en schaalfactor.
- pitfalls:
  - A21 als volledige route behandelen zonder de onbekende TCK te isoleren.
  - TVK en TCK verwisselen.
  - De schaalfactor pas na de laatste stap vergeten.
- generator: GEN_A87
...
- needs: []
- exam_codes: [A2.1, A2.4]
- mastery_target: apply
- prior_learning: new_this_year
- aspects: [rekenen, verbaal, grafisch]
- terms: []
- zero_needs_status: true_zero
- zero_needs_review: {"reviewed_on":"2026-05-28","reviewer":"MTU-H2D resolution packet","rationale":"Scale labels can appear in formulas, tables, graphs, and final answer units; requiring A61 would over-trigger table-value selection.","recommended_needs":[],"severity":"medium"}
- procedure:
  1. Zoek of waarden een schaalvermelding hebben, zoals x 1.000 of mln.
  2. Noteer of je rekent in weergegeven eenheden of werkelijke eenheden.
  3. Pas de schaalfactor consequent toe in formules en tussenstappen.
  4. Geef het eindantwoord met de juiste eenheid en eventuele vermenigvuldigingsfactor.
- pitfalls:
...
- terms: []
- zero_needs_status: true_zero
- zero_needs_review: {"reviewed_on":"2026-05-28","reviewer":"MTU-H2D resolution packet","rationale":"Recognition that GO is the monopoly price relation should not force substitution; substitution is handled by A92.","recommended_needs":[],"severity":"medium"}
- procedure:
  1. Zoek in de opgave de GO-, vraag-, of prijsfunctie.
  2. Benoem dat deze functie de prijs P bij hoeveelheid Q geeft.
  3. Houd MO apart: MO bepaalt de winstmaximaliserende hoeveelheid, niet de verkoopprijs.
- pitfalls:
  - MO gebruiken als prijsfunctie.
  - Een herkenningsstap behandelen alsof al een berekening met Q* nodig is.
- generator: GEN_A89

### A90 MO bepalen uit lineaire GO-regel zonder afgeleiden
...
- terms: []
- procedure:
  1. Herken de lineaire prijsfunctie P = a - bQ.
  2. Gebruik de lineaire MO-regel: MO = a - 2bQ.
  3. Controleer dat deze MO-regel alleen de hoeveelheidstap ondersteunt.
  4. Gebruik later de GO- of prijsfunctie om de verkoopprijs te bepalen.
- pitfalls:
...
- kern: "Los MO = MK op wanneer de marginale kosten als constante of gegeven waarde in de opgave staan."
- needs: [A02]
- exam_codes: [A2.10, A2.12]
- mastery_target: apply
- prior_learning: new_this_year
...
- terms: [marginale-kosten]
- procedure:
  1. Neem de MO-functie uit de voorafgaande stap.
  2. Neem de gegeven MK-waarde uit de opgave.
  3. Stel MO = gegeven MK.
  4. Los de vergelijking op naar Q*.
  5. Controleer dat je geen MK-functie afleidt als MK al gegeven is.
- pitfalls:
  - Een MK-functie afleiden terwijl MK direct gegeven is.
  - De gegeven kostenstijging verwarren met de nieuwe MK.
  - MO = MK oplossen zonder daarna de prijs uit GO/P(Q) te halen.
- generator: GEN_A91

### A92 Nieuwe prijs bepalen na winstmaximaliserende Q
...
- terms: []
- procedure:
  1. Neem de gevonden winstmaximaliserende hoeveelheid Q*.
  2. Zoek de GO- of prijsfunctie P(Q), niet de MO-functie.
  3. Vul Q* in de prijsfunctie in.
  4. Bereken de prijs en controleer de eenheid.
- pitfalls:
  - Q* in MO invullen en die uitkomst als prijs gebruiken.
  - De oude prijs gebruiken nadat de kosten of MK zijn veranderd.
- generator: GEN_A92

### A93 Procentuele prijsverandering na kostenverandering
...
- needs: [A38, A92]
- exam_codes: [A2.4, A2.10, A2.12]
- mastery_target: apply
- prior_learning: new_this_year
- aspects: [rekenen, verbaal]
- terms: []
- procedure:
  1. Bepaal de oude prijs en nieuwe prijs.
  2. Bereken de prijsverandering: nieuwe prijs min oude prijs.
  3. Deel door de oude prijs en vermenigvuldig met 100 procent.
  4. Controleer dat je de prijsverandering berekent, niet het doorberekende deel van de kostenstijging.
- pitfalls:
...
### A94 MO = P en afgeleide MK oplossen
...
- terms: [marginale-kosten]
- procedure:
  1. Herken dat de aanbieder een prijsnemer is bij volkomen concurrentie.
  2. Gebruik de regel: bij een prijsnemer geldt MO = marktprijs P.
  3. Bepaal MK als afgeleide van TK.
  4. Stel P = MK.
  5. Los op naar Q*.
- pitfalls:
...
### A95 MO = gegeven MK-functie oplossen
...
- terms: [marginale-kosten]
- procedure:
  1. Neem de beschikbare MO-functie uit de voorafgaande stap of uit de opgave.
  2. Neem de gegeven MK-functie uit de opgave.
  3. Stel MO = MK.
  4. Los de vergelijking op naar Q*.
  5. Controleer dat je geen MK-functie afleidt als MK al gegeven is.
- pitfalls:
...
- needs: []
- exam_codes: [A2.1, A1.7]
- mastery_target: apply
- prior_learning: new_this_year
- aspects: [rekenen, verbaal]
- terms: []
- zero_needs_status: true_zero
- zero_needs_review: {"reviewed_on":"2026-05-29","reviewer":"GATE-MTU-H4A planning review","rationale":"Answer-form wrapper combines with underlying calculation/content units in target mappings; no stable content prerequisite is encoded as needs.","recommended_needs":[],"severity":"low"}
- procedure:
  1. Lees welke grootheid, periode en eenheid de vraag vraagt.
  2. Noteer de formule of rekenregel die past bij de onderliggende vaardigheid.
  3. Vul de gegevens zichtbaar in met labels.
  4. Werk de tussenstappen uit en rond pas af aan het einde of zoals de vraag vraagt.
  5. Geef het eindantwoord met eenheid of notatie en sluit af met een korte conclusie in de context.
- pitfalls:
...
- needs: []
- exam_codes: [A1.7, A4.2]
- mastery_target: apply
- prior_learning: new_this_year
- aspects: [verbaal]
- terms: []
- zero_needs_status: true_zero
- zero_needs_review: {"reviewed_on":"2026-05-29","reviewer":"GATE-MTU-H4A planning review","rationale":"Answer-form wrapper; content prerequisites remain in the underlying target mapping rather than in the answer-form needs list.","recommended_needs":[],"severity":"low"}
- procedure:
  1. Neem de conclusie uit de vraag over als eindpunt van je antwoord.
  2. Bepaal welke economische oorzaak of gegeven in de context het startpunt is.
  3. Schrijf de eerste causale schakel met het juiste begrip of mechanisme.
  4. Schrijf de tweede schakel of het verdere effect dat naar de gegeven conclusie leidt.
  5. Sluit af door de gegeven conclusie expliciet te koppelen aan je redenering.
- pitfalls:
...
- terms: []
- zero_needs_status: true_zero
- zero_needs_review: {"reviewed_on":"2026-05-29","reviewer":"GATE-MTU-H4A planning review","rationale":"Answer-form wrapper; underlying content or graph units carry the substantive prerequisite route.","recommended_needs":[],"severity":"low"}
- procedure:
  1. Bepaal eerst de richting, keuze of ja/nee-uitkomst die de vraag open laat.
  2. Zet die richting expliciet in de eerste zin.
  3. Gebruik het relevante economische mechanisme uit de onderliggende vaardigheid.
  4. Werk de causale schakels uit die laten zien waarom deze richting volgt.
  5. Controleer dat je antwoord niet beide kanten open laat.
- pitfalls:
...
- needs: []
- exam_codes: [A1.3, A1.9]
- mastery_target: apply
- prior_learning: new_this_year
- aspects: [verbaal]
- terms: []
- zero_needs_status: true_zero
- zero_needs_review: {"reviewed_on":"2026-05-29","reviewer":"GATE-MTU-H4A planning review","rationale":"Answer-form wrapper for example-answer structure; domain concepts remain separate prerequisites in target mappings.","recommended_needs":[],"severity":"low"}
- procedure:
  1. Lees welk begrip, mechanisme of effect met een voorbeeld moet worden toegelicht.
  2. Kies een concreet voorbeeld dat binnen de context past.
  3. Benoem welk kenmerk van het voorbeeld relevant is.
  4. Leg uit waarom dat kenmerk bij het begrip of mechanisme hoort.
  5. Koppel het voorbeeld terug aan de vraag of context.
- pitfalls:
...
- terms: [inkomenselasticiteit]
- deprecated: true
- deprecated_in_favor_of: [A15, D06, A17, D11, A16, D12, D27]
...
- terms: [heffingen]
- procedure:
  1. Gebruik de belastingdruk in euros: consumentenbedrag = Pc - P0 en producentenbedrag = P0 - Pp.
  2. Deel het consumentenbedrag door de heffing t en vermenigvuldig met 100 procent.
  3. Deel het producentenbedrag door t en vermenigvuldig met 100 procent, of gebruik 100 procent minus consumentenpercentage.
  4. Controleer dat beide percentages samen 100 procent zijn.
  5. Rond af zoals de vraag vraagt en benoem wie welk percentage draagt.
- pitfalls:
...
- procedure:
  1. Bepaal of gebruik het nieuwe evenwicht na heffing: consumentenprijs Pc en hoeveelheid Qt.
  2. Bepaal de producentenprijs Pp als Pc - t.
  3. Teken of label bij Qt de verticale afstand tussen Pc en Pp als belastingwig t.
  4. Label Pc, Pp, Qt en de wig zonder welfare-gebieden te arceren.
  5. Controleer dat Pc - Pp gelijk is aan het heffingsbedrag.
- pitfalls:
...
- aspects: [rekenen, verbaal]
- terms: [heffingen, evenwichtsprijs]
- assumed_prior_knowledge: [P0, Pc, Pp en heffing t zijn gegeven, eerder berekend, of apart gemapt via D41/D05 wanneer de context dat vraagt.]
- zero_needs_status: true_zero
- zero_needs_review: {"reviewed_on":"2026-05-28","reviewer":"GATE-MTU-H3B","rationale":"D42 is an economics-specific root operation from available P0/Pc/Pp/t values. It must not force graphical D41; graph contexts map D41 separately and calculation contexts can supply prices directly.","recommended_needs":[],"severity":"medium","h3c_execution_decision":"fixed from underbouw_assumed to true_zero per GATE-MTU-H3B condition"}
- procedure:
  1. Neem de oude evenwichtsprijs P0, de consumentenprijs Pc en de producentenprijs Pp na heffing.
  2. Bereken consumentendruk = Pc - P0.
  3. Bereken producentendruk = P0 - Pp.
  4. Controleer dat consumentendruk + producentendruk gelijk is aan de heffing t.
  5. Benoem de bedragen per eenheid en rond af zoals de vraag vraagt.
- pitfalls:
...
- prior_learning: new_this_year
- aspects: [rekenen, verbaal]
- terms: [subsidies, evenwichtsprijs]
- procedure:
  1. Leid met A41 de aanbodfunctie na subsidie af of gebruik de gegeven na-subsidie aanbodlijn.
  2. Los het nieuwe evenwicht op en bepaal consumentenprijs Pc en hoeveelheid Qs.
  3. Bereken de producentenontvangst Pp als Pc + subsidie s.
  4. Controleer dat Pp - Pc gelijk is aan het subsidiebedrag.
  5. Benoem Pc, Pp en Qs expliciet.
- pitfalls:
...
- prior_learning: new_this_year
- aspects: [verbaal, grafisch]
- terms: [heffingen, subsidies, prijselasticiteit-van-de-vraag]
- assumed_prior_knowledge: [Aanbodelasticiteit wordt kwalitatief binnen deze unit behandeld via helling of context; er is geen aparte numerieke aanbodelasticiteitsberekening nodig.]
- procedure:
  1. Bepaal uit context of grafiek welke kant relatief minder elastisch reageert: vraag of aanbod.
  2. Gebruik A15 voor vraagelasticiteit en benoem aanbodelasticiteit kwalitatief via helling of context wanneer geen aanbodelasticiteitsunit beschikbaar is.
  3. Leg bij een heffing uit dat de relatief minder elastische kant meer belastingdruk draagt.
  4. Leg bij een subsidie uit dat de relatief minder elastische kant relatief meer voordeel ontvangt.
  5. Koppel de uitleg aan de berekende of getekende Pc/Pp-verdeling.
- pitfalls:
...
- terms: []
- procedure:
  1. Bepaal de oude prijs en nieuwe prijs zoals in A93.
  2. Bereken de prijsstijging in euro: nieuwe prijs - oude prijs.
  3. Bepaal de kostenstijging per eenheid die als schok wordt gegeven.
  4. Bereken pass-through share = prijsstijging / kostenstijging x 100 procent.
  5. Controleer dat de noemer de kostenstijging is, niet de oude prijs.
- pitfalls:
...
- kern: "Analyseer bij gelijktijdige verschuivingen van vraag en aanbod welke richting van het marktevenwicht bepaald is en welke zonder relatieve grootte ambigu blijft."
- needs: [A06, A42, A49, D13, D32, D33]
- exam_codes: [D1.4b, D1.24]
- mastery_target: analyze
- prior_learning: new_this_year
- aspects: [verbaal, grafisch]
- terms: [collectieve-vraaglijn, collectieve-aanbodlijn, evenwichtsprijs, evenwichtshoeveelheid]
- procedure:
  1. Analyseer de vraagverschuiving eerst apart en benoem de richting van P* en Q*.
  2. Analyseer de aanbodverschuiving daarna apart en benoem de richting van P* en Q*.
  3. Zet de twee richtingsdrukken naast elkaar: gelijke richting is bepaald, tegengestelde druk is ambigu zonder relatieve grootte.
  4. Bij vraag rechts en aanbod rechts: Q* stijgt, terwijl P* kan stijgen, dalen of gelijk blijven afhankelijk van welke verschuiving sterker is.
  5. Gebruik een berekend nieuw evenwicht alleen als bevestiging wanneer functies of getallen gegeven zijn.
- pitfalls:
  - Alleen de vraagverschuiving volgen en daardoor automatisch een hogere prijs voorspellen.
  - Alleen het eind-evenwicht berekenen zonder uit te leggen wat zonder berekening voorspelbaar was.
  - Twee verschuivingen combineren zonder ze eerst afzonderlijk te analyseren.
...
- kern: "Herken dat een keuze, productie of consumptie kosten veroorzaakt die niet door de directe gebruiker of producent worden gedragen."
- needs: []
- exam_codes: [F2.4]
- mastery_target: understand
- prior_learning: new_this_year
...
- terms: []
- zero_needs_status: true_zero
- zero_needs_review: {"reviewed_on":"2026-05-27","reviewer":"GATE-MTU-H2 routing review","rationale":"This is the first verbal external-cost recognition unit and must not depend on full MPC/MSC machinery.","recommended_needs":[],"severity":"medium"}

### F20 Maatschappelijke kosten uitleggen met voorbeeld
- kern: "Geef een contextspecifiek voorbeeld van maatschappelijke of externe kosten en leg uit waarom die kosten bij anderen of de samenleving terechtkomen."
- needs: [F19]
- exam_codes: [F2.4]
- mastery_target: apply
- prior_learning: new_this_year
...
- terms: []
- procedure:
  1. Noem het concrete nadeel of de concrete schade uit de context.
  2. Benoem wie de schade of kosten draagt.
  3. Leg uit dat de directe gebruiker of producent deze kosten niet volledig betaalt.
  4. Sluit af waarom dit maatschappelijke of externe kosten zijn.
- pitfalls:
  - Alleen een voorbeeld noemen zonder uit te leggen waarom het extern is.
  - De schade behandelen als gewone private kosten voor de gebruiker.
